...
class DeliveryComplementoController extends Controller
{
    ...
    public function new(){
        $categorias = CategoriaProdutoDelivery::where('empresa_id', $this->empresa_id)
        ->get();
    ...
    public function edit($id){
        ...
        $resp = ComplementoDelivery::findOrFail($id);
        ...
        if(valida_objeto($resp)){   
            ...
            ->with('categorias', $categorias)
            ->with('categoria_edit', $resp->categoria ? json_decode($resp->categoria) : [])
    ...
    public function update(Request $request){
        ...
        $resp->tipo = $request->tipo;
        $resp->categoria = $request->categoria;
