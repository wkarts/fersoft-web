...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120020_create_portaria_respostas_temp_table';
    private const TABLE_NAME = 'portaria_respostas_temp';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('portaria_respostas_temp', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_respostas_temp', 'funcionario_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_respostas_temp', 'visitante_nome', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('portaria_respostas_temp', 'status', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => 'pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('portaria_respostas_temp', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_respostas_temp', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_respostas_temp', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_respostas_temp', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_respostas_temp', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('portaria_respostas_temp', 'PRIMARY', ['id'], true);
            $this->preflightIndex('portaria_respostas_temp', 'funcionario_id', ['funcionario_id'], false);
            $this->preflightIndex('portaria_respostas_temp', 'idx_portaria_respostas_temp_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('portaria_respostas_temp', 'idx_portaria_respostas_temp_filial_id', ['filial_id'], false);
            $this->preflightIndex('portaria_respostas_temp', 'idx_portaria_respostas_temp_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('portaria_respostas_temp', 'portaria_respostas_temp_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('portaria_respostas_temp', 'portaria_respostas_temp_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('portaria_respostas_temp', 'portaria_respostas_temp_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('portaria_respostas_temp')) {
                if (!$this->beginChange('table', 'portaria_respostas_temp', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('portaria_respostas_temp', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->string('visitante_nome', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('status', 50)->nullable()->default('pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('funcionario_id', 'funcionario_id');
                    $table->index('empresa_id', 'idx_portaria_respostas_temp_empresa_id');
                    $table->index('filial_id', 'idx_portaria_respostas_temp_filial_id');
                    $table->index('usuario_id', 'idx_portaria_respostas_temp_usuario_id');
                });
                $this->markCreated('table', 'portaria_respostas_temp');
            }

            $this->ensureBaseTenantColumns('portaria_respostas_temp');
            $this->ensureColumn('portaria_respostas_temp', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_respostas_temp', 'funcionario_id', function (Blueprint $table) {
                return $table->integer('funcionario_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('portaria_respostas_temp', 'visitante_nome', function (Blueprint $table) {
                return $table->string('visitante_nome', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('portaria_respostas_temp', 'status', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_respostas_temp', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_respostas_temp', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('portaria_respostas_temp', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('portaria_respostas_temp', 'funcionario_id', ['funcionario_id'], false);
            $this->addIndexIfMissing('portaria_respostas_temp', 'idx_portaria_respostas_temp_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('portaria_respostas_temp', 'idx_portaria_respostas_temp_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('portaria_respostas_temp', 'idx_portaria_respostas_temp_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('portaria_respostas_temp', 'portaria_respostas_temp_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_respostas_temp', 'portaria_respostas_temp_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_respostas_temp', 'portaria_respostas_temp_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('portaria_respostas_temp', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('portaria_respostas_temp', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('portaria_respostas_temp', 'usuario_id', function (Blueprint $table) {
