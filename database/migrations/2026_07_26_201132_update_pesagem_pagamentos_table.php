...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureNullableAndComment('pesagem_pagamentos', 'forma_pagamento', true, 'PIX, Dinheiro, Transferência, etc.');
        $this->ensureNullableAndComment('pesagem_pagamentos', 'observacao', true, null);
    }
