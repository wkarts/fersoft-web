                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group validated col-sm-4 col-lg-2">
                                                ...
                                                <div class="">
                                                    <input id="latitude" type="text" class="form-control" name="latitude" value="{{{ isset($forn) ? $forn->latitude : old('latitude') }}}">
                                                </div>
                                            </div>
                                            <div class="form-group validated col-sm-4 col-lg-2">
                                                <label class="col-form-label">Longitude</label>
                                                <div class="">
                                                    <input id="longitude" type="text" class="form-control" name="longitude" value="{{{ isset($forn) ? $forn->longitude : old('longitude') }}}">
                                                </div>
                                            </div>
