            ...
            <tr>
                ...
                <div class="fatura row">
                    ...
                    <div class="fatura-valor">
                        ...
                        <div class="valor-fatura">
                            <p style="margin-left: 3px; margin-top: 20px;">R$ {{number_format($venda->valor_total, 2, ',', '.')}}</p>
                        </div>
                    </div>
                ...
                <div class="duplicata">
                    ...
                    <div class="numero-fatura-duplicata">
                        ...
                        <p style="margin-left: 25px; margin-top: 23px;">{{$key+1}} / {{count($venda->fatura)}}</p>
                    </div>
                </div>
                {{-- vencimento --}}
