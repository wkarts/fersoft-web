...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120023_create_security_authorizer_resources_table';
    private const TABLE_NAME = 'security_authorizer_resources';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('security_authorizer_resources', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'security_authorizer_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'security_crud_resource_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'can_view', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'can_create', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'can_edit', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'can_delete', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'can_restore', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'can_export', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'can_print', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_resources', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('security_authorizer_resources', 'PRIMARY', ['id'], true);
            $this->preflightIndex('security_authorizer_resources', 'sec_authorizer_resource_unique', ['security_authorizer_id', 'security_crud_resource_id'], true);
            $this->preflightIndex('security_authorizer_resources', 'security_authorizer_resources_security_authorizer_id_index', ['security_authorizer_id'], false);
            $this->preflightIndex('security_authorizer_resources', 'security_authorizer_resources_security_crud_resource_id_index', ['security_crud_resource_id'], false);
            $this->preflightIndex('security_authorizer_resources', 'idx_security_authorizer_resources_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('security_authorizer_resources', 'idx_security_authorizer_resources_filial_id', ['filial_id'], false);
            $this->preflightIndex('security_authorizer_resources', 'idx_security_authorizer_resources_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('security_authorizer_resources', 'security_authorizer_resources_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('security_authorizer_resources', 'security_authorizer_resources_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('security_authorizer_resources', 'security_authorizer_resources_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('security_authorizer_resources')) {
                if (!$this->beginChange('table', 'security_authorizer_resources', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('security_authorizer_resources', function (Blueprint $table) {
                    ...
                    $table->unsignedBigInteger('security_authorizer_id');
                    ...
                    $table->index('security_authorizer_id', 'security_authorizer_resources_security_authorizer_id_index');
                    $table->index('security_crud_resource_id', 'security_authorizer_resources_security_crud_resource_id_index');
                    $table->index('empresa_id', 'idx_security_authorizer_resources_empresa_id');
                    $table->index('filial_id', 'idx_security_authorizer_resources_filial_id');
                    $table->index('usuario_id', 'idx_security_authorizer_resources_usuario_id');
                });
                $this->markCreated('table', 'security_authorizer_resources');
            }

            $this->ensureBaseTenantColumns('security_authorizer_resources');
            $this->ensureColumn('security_authorizer_resources', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_authorizer_resources', 'security_authorizer_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('security_authorizer_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('security_authorizer_resources', 'security_crud_resource_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('security_crud_resource_id')->nullable(false)->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_resources', 'can_view', function (Blueprint $table) {
                return $table->tinyInteger('can_view')->nullable(false)->default('0');
            ...
            $this->ensureColumn('security_authorizer_resources', 'can_create', function (Blueprint $table) {
                return $table->tinyInteger('can_create')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_resources', 'can_edit', function (Blueprint $table) {
                return $table->tinyInteger('can_edit')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_resources', 'can_delete', function (Blueprint $table) {
                return $table->tinyInteger('can_delete')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_resources', 'can_restore', function (Blueprint $table) {
                return $table->tinyInteger('can_restore')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_resources', 'can_export', function (Blueprint $table) {
                return $table->tinyInteger('can_export')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_resources', 'can_print', function (Blueprint $table) {
                return $table->tinyInteger('can_print')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_resources', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_authorizer_resources', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_resources', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('security_authorizer_resources', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('security_authorizer_resources', 'sec_authorizer_resource_unique', ['security_authorizer_id', 'security_crud_resource_id'], true);
            $this->addIndexIfMissing('security_authorizer_resources', 'security_authorizer_resources_security_authorizer_id_index', ['security_authorizer_id'], false);
            $this->addIndexIfMissing('security_authorizer_resources', 'security_authorizer_resources_security_crud_resource_id_index', ['security_crud_resource_id'], false);
            $this->addIndexIfMissing('security_authorizer_resources', 'idx_security_authorizer_resources_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('security_authorizer_resources', 'idx_security_authorizer_resources_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('security_authorizer_resources', 'idx_security_authorizer_resources_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('security_authorizer_resources', 'security_authorizer_resources_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('security_authorizer_resources', 'security_authorizer_resources_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('security_authorizer_resources', 'security_authorizer_resources_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('security_authorizer_resources', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_authorizer_resources', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_authorizer_resources', 'usuario_id', function (Blueprint $table) {
