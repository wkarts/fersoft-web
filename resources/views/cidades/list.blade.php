...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/cidades/filtro">
			...
			<h4 class="@if(env('ANIMACAO')) animate__animated @endif animate__backInRight">Lista de Cidades</h4>

			<label class="@if(env('ANIMACAO')) animate__animated @endif animate__backInRight">Registros: exibindo <strong class="text-success">{{sizeof($cidades)}} de {{$count}}</strong></label>
