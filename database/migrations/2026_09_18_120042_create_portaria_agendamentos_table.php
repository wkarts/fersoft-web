...
{
    private const REFERENCE_COLUMNS = ['visitante_id' => ['visitantes', 'id', 'restrict', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120042_create_portaria_agendamentos_table';
    private const TABLE_NAME = 'portaria_agendamentos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('portaria_agendamentos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'visitante_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'funcionario_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'usuario_criador_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'data_hora_prevista', ['column_type' => 'datetime', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'placa_veiculo_prevista', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'status', ['column_type' => 'enum(\'pendente\',\'realizado\',\'cancelado\')', 'nullable' => true, 'column_default' => 'pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_agendamentos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('portaria_agendamentos', 'PRIMARY', ['id'], true);
            $this->preflightIndex('portaria_agendamentos', 'fk_agenda_visitante', ['visitante_id'], false);
            $this->preflightIndex('portaria_agendamentos', 'idx_portaria_agendamentos_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('portaria_agendamentos', 'idx_portaria_agendamentos_filial_id', ['filial_id'], false);
            $this->preflightIndex('portaria_agendamentos', 'idx_portaria_agendamentos_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('portaria_agendamentos', 'fk_agenda_visitante', 'visitante_id', 'visitantes', 'restrict', 'id', 'restrict');
            $this->preflightForeign('portaria_agendamentos', 'portaria_agendamentos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('portaria_agendamentos', 'portaria_agendamentos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('portaria_agendamentos', 'portaria_agendamentos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('portaria_agendamentos')) {
                if (!$this->beginChange('table', 'portaria_agendamentos', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('portaria_agendamentos', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->dateTime('data_hora_prevista');
                    $table->string('placa_veiculo_prevista', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('status', ['pendente', 'realizado', 'cancelado'])->nullable()->default('pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('visitante_id', 'fk_agenda_visitante');
                    $table->index('empresa_id', 'idx_portaria_agendamentos_empresa_id');
                    $table->index('filial_id', 'idx_portaria_agendamentos_filial_id');
                    $table->index('usuario_id', 'idx_portaria_agendamentos_usuario_id');
                });
                $this->markCreated('table', 'portaria_agendamentos');
            }

            $this->ensureBaseTenantColumns('portaria_agendamentos');
            $this->ensureColumn('portaria_agendamentos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_agendamentos', 'visitante_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_agendamentos', 'funcionario_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('funcionario_id')->nullable(false)->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('portaria_agendamentos', 'usuario_criador_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('usuario_criador_id')->nullable(false)->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('portaria_agendamentos', 'data_hora_prevista', function (Blueprint $table) {
                return $table->dateTime('data_hora_prevista')->nullable(false)->default(null);
            ...
            $this->ensureColumn('portaria_agendamentos', 'placa_veiculo_prevista', function (Blueprint $table) {
                return $table->string('placa_veiculo_prevista', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('portaria_agendamentos', 'status', function (Blueprint $table) {
                return $table->enum('status', ['pendente', 'realizado', 'cancelado'])->nullable()->default('pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'pendente\',\'realizado\',\'cancelado\')', 'nullable' => true, 'column_default' => 'pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('portaria_agendamentos', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_agendamentos', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('portaria_agendamentos', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('portaria_agendamentos', 'fk_agenda_visitante', ['visitante_id'], false);
            $this->addIndexIfMissing('portaria_agendamentos', 'idx_portaria_agendamentos_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('portaria_agendamentos', 'idx_portaria_agendamentos_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('portaria_agendamentos', 'idx_portaria_agendamentos_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('portaria_agendamentos', 'fk_agenda_visitante', 'visitante_id', 'visitantes', 'restrict', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_agendamentos', 'portaria_agendamentos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_agendamentos', 'portaria_agendamentos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_agendamentos', 'portaria_agendamentos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('portaria_agendamentos', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('portaria_agendamentos', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('portaria_agendamentos', 'usuario_id', function (Blueprint $table) {
