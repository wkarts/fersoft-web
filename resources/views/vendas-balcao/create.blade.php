																				...
																				<div class="row">
																					...
																					<div class="row">
																						...
																						<div class="form-group col-lg-4 col-md-4 col-sm-4 col-12">
																							<br>
																							<a data-toggle="modal" onclick="renderizarPagamento()" id="btn-modal-pagamentos" type="button" style="margin-top: 20px;" class="btn btn-light-info font-weight-bold disabled">
								...
								<div class="card-body">
									...
									<div class="row mt-4">
										<div class="col-sm-6 col-lg-6 col-md-6 col-xl-6 col-12">
											<button id="salvar-venda" style="width: 100%;" onclick="salvarVenda()" class="btn btn-success" disabled>Salvar Venda</button>
										</div>
									</div>
								</div>
							</div>
