...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureTableCollation('apuracao_difal_itens', 'utf8mb4_0900_ai_ci');

        $this->applyColumnDefinition('apuracao_difal_itens', 'nota_fiscal_id', 'INT UNSIGNED NOT NULL');
        $this->applyColumnDefinition('apuracao_difal_itens', 'numero_nota', 'VARCHAR(20) NOT NULL');
        $this->applyColumnDefinition('apuracao_difal_itens', 'emitente_nome', 'VARCHAR(150) NOT NULL');
        $this->applyColumnDefinition('apuracao_difal_itens', 'valor_operacao', 'DECIMAL(15, 4) NOT NULL');
        $this->applyColumnDefinition('apuracao_difal_itens', 'aliquota_origem', 'DECIMAL(5, 2) NOT NULL');
        $this->applyColumnDefinition('apuracao_difal_itens', 'aliquota_destino', 'DECIMAL(5, 2) NOT NULL');
        $this->applyColumnDefinition('apuracao_difal_itens', 'base_calculo_dupla', 'DECIMAL(15, 4) NOT NULL');
        $this->applyColumnDefinition('apuracao_difal_itens', 'valor_difal', 'DECIMAL(15, 4) NOT NULL');
    }
