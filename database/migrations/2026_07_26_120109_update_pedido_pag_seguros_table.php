...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('pedido_pag_seguros')) {
            return;
        }

        $this->addForeignIfMissing('pedido_pag_seguros', 'pedido_pag_seguros_filial_id_foreign', 'filial_id', 'filials', 'id', 'cascade', null);
    }
