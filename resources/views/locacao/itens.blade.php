						...
						<div class="col-xl-12">
							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									...
									<div class="row">
										<div class="form-group validated col-lg-4 col-md-8 col-sm-10">
										...
										<div class="form-group validated col-lg-6 col-md-9 col-sm-9">
														...
														<tr class="datatable-row">
															...
															<td class="datatable-cell">
																<span class="codigo" style="width: 100px;" id="id">
																	<a class="btn btn-danger btn-sm" href="/locacao/deleteItem/{{$i->id}}">
