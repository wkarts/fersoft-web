...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120005_create_documento_fiscal_logs_table';
    private const TABLE_NAME = 'documento_fiscal_logs';

    // Relações legadas documentadas nos dois SQLs fornecidos. A ausência de ON DELETE/ON UPDATE
    // corresponde a NO ACTION (RESTRICT no InnoDB). Não são equivalentes a CASCADE/SET NULL.
    // Somente estas três assinaturas preexistentes podem ser preservadas por esta migration.
    private const LEGACY_FOREIGNS = [
        'documento_fiscal_logs_empresa_id_foreign' => ['empresa_id', 'empresas', 'id', 'restrict', 'restrict'],
        'documento_fiscal_logs_filial_id_foreign' => ['filial_id', 'filials', 'id', 'restrict', 'restrict'],
        'documento_fiscal_logs_usuario_id_foreign' => ['usuario_id', 'usuarios', 'id', 'restrict', 'restrict'],
    ];
    ...
    public function up()
    {
        $this->runWithSchemaLock(function () {
            ...
            $this->preflightColumn('documento_fiscal_logs', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'tipo_documento', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'direcao', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'modelo', ['column_type' => 'varchar(3)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'serie', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'numero', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'chave', ['column_type' => 'varchar(60)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'ambiente', ['column_type' => 'varchar(2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'operacao', ['column_type' => 'varchar(40)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'status_interno', ['column_type' => 'varchar(40)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'cstat', ['column_type' => 'varchar(4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'xmotivo', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'origem', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'xml_envio', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'xml_retorno', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'request_raw', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'response_raw', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'payload', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('documento_fiscal_logs', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('documento_fiscal_logs', 'PRIMARY', ['id'], true);
            $this->preflightIndex('documento_fiscal_logs', 'documento_fiscal_logs_empresa_id_modelo_serie_numero_index', ['empresa_id', 'modelo', 'serie', 'numero'], false);
            $this->preflightIndex('documento_fiscal_logs', 'documento_fiscal_logs_chave_index', ['chave'], false);
            $this->preflightIndex('documento_fiscal_logs', 'documento_fiscal_logs_tipo_documento_direcao_index', ['tipo_documento', 'direcao'], false);
            $this->preflightIndex('documento_fiscal_logs', 'documento_fiscal_logs_operacao_index', ['operacao'], false);
            $this->preflightIndex('documento_fiscal_logs', 'documento_fiscal_logs_status_interno_index', ['status_interno'], false);
            $this->preflightIndex('documento_fiscal_logs', 'idx_documento_fiscal_logs_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('documento_fiscal_logs', 'idx_documento_fiscal_logs_filial_id', ['filial_id'], false);
            $this->preflightIndex('documento_fiscal_logs', 'idx_documento_fiscal_logs_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('documento_fiscal_logs', 'documento_fiscal_logs_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('documento_fiscal_logs', 'documento_fiscal_logs_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('documento_fiscal_logs', 'documento_fiscal_logs_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('documento_fiscal_logs')) {
                if (!$this->beginChange('table', 'documento_fiscal_logs', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('documento_fiscal_logs', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->string('tipo_documento', 30)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('direcao', 10)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('modelo', 3)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('serie', 10)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->unsignedBigInteger('numero')->nullable();
                    $table->string('chave', 60)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('ambiente', 2)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('operacao', 40)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('status_interno', 40)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cstat', 4)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('xmotivo', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('origem', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->longText('xml_envio')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->longText('xml_retorno')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->longText('request_raw')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->longText('response_raw')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->longText('payload')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamp('deleted_at')->nullable();
                    $table->timestamps();

                    $table->index(['empresa_id', 'modelo', 'serie', 'numero'], 'documento_fiscal_logs_empresa_id_modelo_serie_numero_index');
                    $table->index('chave', 'documento_fiscal_logs_chave_index');
                    $table->index(['tipo_documento', 'direcao'], 'documento_fiscal_logs_tipo_documento_direcao_index');
                    $table->index('operacao', 'documento_fiscal_logs_operacao_index');
                    $table->index('status_interno', 'documento_fiscal_logs_status_interno_index');
                    $table->index('empresa_id', 'idx_documento_fiscal_logs_empresa_id');
                    $table->index('filial_id', 'idx_documento_fiscal_logs_filial_id');
                    $table->index('usuario_id', 'idx_documento_fiscal_logs_usuario_id');
                });
                $this->markCreated('table', 'documento_fiscal_logs');
            }

            $this->ensureBaseTenantColumns('documento_fiscal_logs');
            $this->ensureColumn('documento_fiscal_logs', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('documento_fiscal_logs', 'tipo_documento', function (Blueprint $table) {
                return $table->string('tipo_documento', 30)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'direcao', function (Blueprint $table) {
                return $table->string('direcao', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'modelo', function (Blueprint $table) {
                return $table->string('modelo', 3)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(3)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'serie', function (Blueprint $table) {
                return $table->string('serie', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'numero', function (Blueprint $table) {
                return $table->unsignedBigInteger('numero')->nullable()->default(null);
            ...
            $this->ensureColumn('documento_fiscal_logs', 'chave', function (Blueprint $table) {
                return $table->string('chave', 60)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(60)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'ambiente', function (Blueprint $table) {
                return $table->string('ambiente', 2)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'operacao', function (Blueprint $table) {
                return $table->string('operacao', 40)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(40)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'status_interno', function (Blueprint $table) {
                return $table->string('status_interno', 40)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(40)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'cstat', function (Blueprint $table) {
                return $table->string('cstat', 4)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'xmotivo', function (Blueprint $table) {
                return $table->string('xmotivo', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('documento_fiscal_logs', 'origem', function (Blueprint $table) {
                return $table->string('origem', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'xml_envio', function (Blueprint $table) {
                return $table->longText('xml_envio')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'xml_retorno', function (Blueprint $table) {
                return $table->longText('xml_retorno')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'request_raw', function (Blueprint $table) {
                return $table->longText('request_raw')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'response_raw', function (Blueprint $table) {
                return $table->longText('response_raw')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'payload', function (Blueprint $table) {
                return $table->longText('payload')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('documento_fiscal_logs', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('documento_fiscal_logs', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('documento_fiscal_logs', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('documento_fiscal_logs', 'documento_fiscal_logs_empresa_id_modelo_serie_numero_index', ['empresa_id', 'modelo', 'serie', 'numero'], false);
            $this->addIndexIfMissing('documento_fiscal_logs', 'documento_fiscal_logs_chave_index', ['chave'], false);
            $this->addIndexIfMissing('documento_fiscal_logs', 'documento_fiscal_logs_tipo_documento_direcao_index', ['tipo_documento', 'direcao'], false);
            $this->addIndexIfMissing('documento_fiscal_logs', 'documento_fiscal_logs_operacao_index', ['operacao'], false);
            $this->addIndexIfMissing('documento_fiscal_logs', 'documento_fiscal_logs_status_interno_index', ['status_interno'], false);
            $this->addIndexIfMissing('documento_fiscal_logs', 'idx_documento_fiscal_logs_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('documento_fiscal_logs', 'idx_documento_fiscal_logs_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('documento_fiscal_logs', 'idx_documento_fiscal_logs_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('documento_fiscal_logs', 'documento_fiscal_logs_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('documento_fiscal_logs', 'documento_fiscal_logs_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('documento_fiscal_logs', 'documento_fiscal_logs_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('documento_fiscal_logs', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('documento_fiscal_logs', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('documento_fiscal_logs', 'usuario_id', function (Blueprint $table) {
    ...
    private function runWithSchemaLock(\Closure $operation): void
    {
        ...
        try {
            $checks = DB::selectOne('SELECT @@SESSION.foreign_key_checks AS enabled');
            if ((int) ($checks->enabled ?? 0) !== 1) {
                throw new \RuntimeException('Esta migration exige FOREIGN_KEY_CHECKS ativo na conexão. Nenhuma verificação será desativada.');
            }
    ...
    private function preflightColumn(string $tableName, string $columnName, array $expected, bool $allowRecordedChange = false): void
    {
        ...
        $this->assertNoForeignDependency($tableName, $columnName, $current, $expected);
    ...
    private function ensureColumn(string $tableName, string $columnName, \Closure $definition, array $expected, bool $allowRecordedChange = false): void
    {
        ...
        $foreignsBefore = $this->foreignDependencies($tableName, $columnName);
        ...
        if (!$this->sameSnapshot($foreignsBefore, $this->foreignDependencies($tableName, $columnName))) {
            throw new \RuntimeException('As FKs da coluna mudaram durante a alteração: ' . $key . '. Revise o schema e a auditoria.');
        }
    ...
    {
        unset($actual['name'], $expected['name']);
        // NO ACTION e RESTRICT são equivalentes no InnoDB; CASCADE e SET NULL não são.
        foreach (['on_delete', 'on_update'] as $rule) {
            if (!array_key_exists($rule, $actual) || !array_key_exists($rule, $expected)
                || !is_string($actual[$rule]) || !is_string($expected[$rule])) { return false; }
            $actual[$rule] = $this->normalizeRule($actual[$rule]);
            $expected[$rule] = $this->normalizeRule($expected[$rule]);
        }
        // A ordem das propriedades não altera a FK. A ordem das colunas continua significativa.
        return $this->sameSnapshot($actual, $expected);
    }

    private function legacyForeignDefinition(string $tableName, array $expected): ?array
    {
        if ($tableName !== self::TABLE_NAME) { return null; }
        $legacy = self::LEGACY_FOREIGNS[$expected['name']] ?? null;
        if ($legacy === null) { return null; }
        [$column, $parentTable, $parentColumn, $onDelete, $onUpdate] = $legacy;
        // A exceção não pode ser reaproveitada para outro relacionamento sob o mesmo nome.
        $reference = self::REFERENCE_COLUMNS[$column];
        $declared = $this->expectedForeign($expected['name'], $column, $parentTable, $parentColumn,
            $reference[2], $reference[3]);
        if (!$this->sameForeign($expected, $declared)) { return null; }
        return $this->expectedForeign($expected['name'], $column, $parentTable, $parentColumn, $onDelete, $onUpdate);
    }

    private function canPreserveLegacyForeign(string $tableName, array $actual, array $expected): bool
    {
        $legacy = $this->legacyForeignDefinition($tableName, $expected);
        if ($legacy === null || !$this->sameForeign($actual, $legacy)) { return false; }
        // Não classificar como legado um objeto criado por esta própria migration e depois alterado.
        // A decisão usa a auditoria persistente, não uma propriedade em memória da classe.
        if ($this->auditRow('table', $tableName) !== null
            || $this->auditRow('foreign', $tableName . '.' . $actual['name']) !== null
            || $this->auditRow('foreign', $tableName . '.' . $expected['name']) !== null) { return false; }
        return true;
    }

    private function throwForeignMismatch(string $tableName, array $actual, array $expected): never
    {
        $flags = JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_THROW_ON_ERROR;
        $legacy = $this->legacyForeignDefinition($tableName, $expected);
        throw new \RuntimeException('FK divergente: ' . $tableName . '.' . $actual['name']
            . '. Atual: ' . json_encode($actual, $flags)
            . '. Padrão para FK nova: ' . json_encode($expected, $flags)
            . ($legacy === null ? '' : '. Única alternativa legada prevista (somente objeto preexistente, sem autoria desta migration): '
                . json_encode($legacy, $flags))
            . '. Nenhuma constraint foi removida, ignorada ou substituída. Confira o diagnóstico somente leitura.');
    }

    private function matchingExistingForeign(string $tableName, array $expected): ?array
    {
        $match = null;
        foreach ($this->foreigns($tableName) as $actual) {
            $sameName = strcasecmp($actual['name'], $expected['name']) === 0;
            $sameColumns = $actual['columns'] === $expected['columns'];
            if (!$sameName && !$sameColumns) { continue; }
            if (!$this->sameForeign($actual, $expected)
                && !$this->canPreserveLegacyForeign($tableName, $actual, $expected)) {
                $this->throwForeignMismatch($tableName, $actual, $expected);
            }
            // Examina todas as candidatas: um nome diferente não encobre uma FK contraditória.
            // Uma definição válida com outro nome é preservada, sem criar uma cópia.
            if ($match === null || $sameName) { $match = $actual; }
        }
        return $match;
    }

    private function assertExistingForeignColumns(string $tableName, array $foreign): void
    {
        foreach ($foreign['columns'] as $position => $column) {
            $current = $this->columnInfo($tableName, $column);
            $parent = $this->columnInfo($foreign['ref_table'], $foreign['ref_columns'][$position]);
            if ($current === null || $parent === null) {
                throw new \RuntimeException('Coluna ausente na FK preexistente: ' . $foreign['name']);
            }
            if ($foreign['ref_schema'] !== DB::getDatabaseName()
                || $this->normalizeType($current['column_type']) !== $this->normalizeType($parent['column_type'])) {
                throw new \RuntimeException('Schema/tipos incompatíveis na FK preexistente: ' . $foreign['name']);
            }
            if (!$current['nullable'] && ($this->normalizeRule($foreign['on_delete']) === 'set null'
                    || $this->normalizeRule($foreign['on_update']) === 'set null')) {
                throw new \RuntimeException('SET NULL exige coluna nullable na FK preexistente: ' . $foreign['name']);
            }
        }
    }
                                      ...
                                      string $onDelete = 'cascade', string $referenceColumn = 'id', string $onUpdate = 'restrict'): void
    {
        ...
        $existing = $this->matchingExistingForeign($tableName, $expected);
        if ($existing !== null) { $this->assertExistingForeignColumns($tableName, $existing); }
                                         ...
                                         string $onDelete = 'cascade', string $referenceColumn = 'id', string $onUpdate = 'restrict'): void
    {
        ...
        $existing = $this->matchingExistingForeign($tableName, $expected);
        if ($existing !== null) {
            $this->assertExistingForeignColumns($tableName, $existing);
            if (!$this->sameForeign($existing, $expected) && PHP_SAPI === 'cli' && defined('STDERR')) {
                fwrite(STDERR, PHP_EOL . '  FK legada preservada conforme SQL: ' . $tableName . '.' . $existing['name']
                    . ' [ON DELETE ' . strtoupper($existing['on_delete']) . '; ON UPDATE '
                    . strtoupper($existing['on_update']) . ']. Sem alteração de constraint.' . PHP_EOL);
            }
            // Preflight já validou destino, tipos, ações e órfãos. Não houve DDL nem registro de
            // criação da FK; o down não poderá tratá-la como objeto introduzido por esta migration.
            return;
        }
    ...
    private function foreignDependencies(string $tableName, string $columnName): array
    {
        // Inclui relações de saída e de entrada, inclusive originadas em outro schema.
        $rows = DB::select(
            'SELECT k.CONSTRAINT_SCHEMA AS constraint_schema, k.CONSTRAINT_NAME AS name,
             k.TABLE_SCHEMA AS table_schema, k.TABLE_NAME AS table_name, k.COLUMN_NAME AS column_name,
             k.ORDINAL_POSITION AS ordinal_position, k.REFERENCED_TABLE_SCHEMA AS ref_schema,
             k.REFERENCED_TABLE_NAME AS ref_table, k.REFERENCED_COLUMN_NAME AS ref_column,
             r.DELETE_RULE AS delete_rule, r.UPDATE_RULE AS update_rule
             ...
             AND ((k.TABLE_SCHEMA = ? AND k.TABLE_NAME = ? AND k.COLUMN_NAME = ?)
               OR (k.REFERENCED_TABLE_SCHEMA = ? AND k.REFERENCED_TABLE_NAME = ? AND k.REFERENCED_COLUMN_NAME = ?))
             ORDER BY k.CONSTRAINT_SCHEMA, k.TABLE_NAME, k.CONSTRAINT_NAME, k.ORDINAL_POSITION',
            [DB::getDatabaseName(), $tableName, $columnName, DB::getDatabaseName(), $tableName, $columnName]
        );
        return array_map(static fn ($row) => (array) $row, $rows);
    }

    private function assertNoForeignDependency(string $tableName, string $columnName,
                                               ?array $current = null, ?array $expected = null): void
    {
        $dependencies = $this->foreignDependencies($tableName, $columnName);
        if ($dependencies === []) { return; }
        $names = implode(', ', array_unique(array_column($dependencies, 'name')));
        $object = $tableName . '.' . $columnName;

        // Sem definições completas, a chamada continua sendo uma proibição de remoção.
        // O down de uma coluna criada usa esta forma e não elimina dependências preexistentes.
        if ($current === null || $expected === null) {
            throw new \RuntimeException('Remoção bloqueada por FK ativa (' . $names . '): ' . $object
                . '. Reverta a dependência responsável antes de remover a coluna.');
        }
        if (!array_key_exists('column_type', $current) || !array_key_exists('column_type', $expected)
            || !array_key_exists('nullable', $current) || !array_key_exists('nullable', $expected)) {
            throw new \RuntimeException('Metadados insuficientes para verificar a alteração com FK ativa: ' . $object);
        }
        if (($current['generation_expression'] ?? '') !== '' || ($expected['generation_expression'] ?? '') !== '') {
            throw new \RuntimeException('Coluna gerada com FK ativa exige tratamento específico: ' . $object);
        }

        // FK ativa não impede, por si só, uma alteração de nulabilidade/default/comentário.
        // Compare os demais atributos efetivos: tipo, sinal, tamanho, charset, collation e extra.
        // expectedColumnForReferences já resolveu o tipo a partir da chave real do pai.
        $structuralExpected = $expected;
        foreach (['nullable', 'column_default', 'column_comment'] as $attribute) {
            $structuralExpected[$attribute] = $current[$attribute] ?? null;
        }
        if (!$this->sameColumn($current, $structuralExpected)) {
            throw new \RuntimeException('Alteração estrutural incompatível com FK ativa (' . $names . '): ' . $object
                . '. Tipo atual: ' . $current['column_type'] . '; esperado: ' . $expected['column_type']
                . '. Tipo/sinal/tamanho/charset/collation/atributos estruturais não serão modificados com a FK ativa.');
        }

        foreach ($dependencies as $foreign) {
            if ($foreign['delete_rule'] === null || $foreign['update_rule'] === null) {
                throw new \RuntimeException('Não foi possível verificar as ações da FK ' . $foreign['name'] . ': ' . $object);
            }
            $isChild = $foreign['table_schema'] === DB::getDatabaseName()
                && $foreign['table_name'] === $tableName
                && strcasecmp($foreign['column_name'], $columnName) === 0;
            if ($isChild && !$expected['nullable']
                && ($this->normalizeRule($foreign['delete_rule']) === 'set null'
                    || $this->normalizeRule($foreign['update_rule']) === 'set null')) {
                throw new \RuntimeException('NOT NULL incompatível com SET NULL na FK ' . $foreign['name'] . ': ' . $object
                    . '. A constraint será preservada, sem preencher ou excluir registros.');
            }
        }
        // Os dados são verificados por assertColumnDataFits antes do DDL, no up e no down.
        // O MySQL executa a alteração mantendo as FKs e o modo estrito de runWithSchemaLock.
    }
    ...
    private function rollbackRecordedChanges(): void
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($row->object_type === 'column' && $meta['before'] !== null) {
                $this->assertNoForeignDependency($table, $object, $actual, $meta['before']);
            ...
            $foreignsBefore = $row->object_type === 'column' && $meta['before'] !== null
                ? $this->foreignDependencies($table, $object) : null;
            ...
            if ($foreignsBefore !== null && !$this->sameSnapshot($foreignsBefore, $this->foreignDependencies($table, $object))) {
                throw new \RuntimeException('As FKs mudaram durante a restauração da coluna: ' . $row->object_name . '. Revise o schema e a auditoria.');
            }
            $this->forgetCreated($row->object_type, $row->object_name);
        }
    }
