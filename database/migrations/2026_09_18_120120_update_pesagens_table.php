...
{
    private const REFERENCE_COLUMNS = ['cliente_id' => ['clientes', 'id', 'set null', 'restrict'], 'compra_id' => ['compras', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'fornecedor_id' => ['fornecedors', 'id', 'set null', 'restrict'], 'motorista_id' => ['funcionarios', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'cascade', 'restrict'], 'veiculo_id' => ['veiculos', 'id', 'cascade', 'restrict'], 'venda_id' => ['vendas', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120120_update_pesagens_table';
    private const TABLE_NAME = 'pesagens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('pesagens');
            $this->preflightColumn('pesagens', 'camera_snapshots', ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pesagens', 'camera_snapshot_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('pesagens', 'camera_snapshots', function (Blueprint $table) {
                return $table->json('camera_snapshots')->nullable()->default(null);
            }, ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('pesagens', 'camera_snapshot_at', function (Blueprint $table) {
                return $table->timestamp('camera_snapshot_at')->nullable()->default(null);
