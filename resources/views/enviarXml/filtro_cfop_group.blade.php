...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		...
		<div class="@if(env('ANIMACAO')) animate__animated @endif animate__backInRight" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			<form class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/enviarXml/filtroCfopGet">
			...
			<h3>Valor total de Emissão: <strong class="text-danger">
			{{ number_format($somaTotalVendas, 2, ',', '.')}}</strong></h3>
			<br>
			@isset($itens)
			...
			<div class="row">
					...
					<div class="row">
						<div class="col-xl-12">
							...
							<div id="kt_datatable" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
								<h3><strong>CFOP: </strong>{{$t['cfop']}}</h3>
							...
							<form method="post" action="/enviarXml/filtroCfopImprimir">
								@csrf
				...
				<form method="post" action="/enviarXml/filtroCfopImprimirGroup">
					@csrf
