...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('manifesta_dves')) {
            return;
        }

        $this->ensureColumn('manifesta_dves', 'situacao_sefaz', static function (Blueprint $table): void {
            $table->string('situacao_sefaz', 30)->default('AUTORIZADA');
        });

        $this->addForeignIfMissing('manifesta_dves', 'manifesta_dves_filial_id_foreign', 'filial_id', 'filials', 'id', 'cascade', null);
    }
