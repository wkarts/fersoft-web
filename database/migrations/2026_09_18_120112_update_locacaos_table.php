...
{
    private const REFERENCE_COLUMNS = ['cliente_id' => ['clientes', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'cidade_id_entrega' => ['cidades', 'id', 'set null', 'restrict'], 'contrato_id' => ['contratos', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120112_update_locacaos_table';
    private const TABLE_NAME = 'locacaos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('locacaos');
            $this->preflightColumn('locacaos', 'tipo', ['column_type' => 'enum(\'cacamba\',\'equipamento\')', 'nullable' => false, 'column_default' => 'cacamba', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'finalidade', ['column_type' => 'enum(\'locacao_cliente\',\'coleta_fornecedor\')', 'nullable' => true, 'column_default' => 'locacao_cliente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'fornecedor_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'material_previsto', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'contrato_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'data_entrega', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'data_solicitacao_retirada', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'data_retirada', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'rua_entrega', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'numero_entrega', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'bairro_entrega', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'cep_entrega', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'referencia_entrega', ['column_type' => 'varchar(250)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'cidade_id_entrega', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'faturado', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'tipo_calculo', ['column_type' => 'enum(\'fechado\',\'dia\',\'mes\')', 'nullable' => true, 'column_default' => 'fechado', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'valor_unitario_calculo', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'valor_frete', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'quantidade_parcelas', ['column_type' => 'int', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'primeiro_vencimento', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'forma_pagamento', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('locacaos', 'observacao', ['column_type' => 'text', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightIndex('locacaos', 'locacaos_contrato_id_foreign', ['contrato_id'], false);
            $this->preflightIndex('locacaos', 'locacaos_cidade_id_entrega_foreign', ['cidade_id_entrega'], false);
            $this->preflightForeign('locacaos', 'locacaos_cidade_id_entrega_foreign', 'cidade_id_entrega', 'cidades', 'set null', 'id', 'restrict');
            $this->preflightForeign('locacaos', 'locacaos_contrato_id_foreign', 'contrato_id', 'contratos', 'set null', 'id', 'restrict');

            $this->ensureColumn('locacaos', 'tipo', function (Blueprint $table) {
                return $table->enum('tipo', ['cacamba', 'equipamento'])->nullable(false)->default('cacamba')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'cacamba\',\'equipamento\')', 'nullable' => false, 'column_default' => 'cacamba', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'finalidade', function (Blueprint $table) {
                return $table->enum('finalidade', ['locacao_cliente', 'coleta_fornecedor'])->nullable()->default('locacao_cliente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'locacao_cliente\',\'coleta_fornecedor\')', 'nullable' => true, 'column_default' => 'locacao_cliente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'fornecedor_id', function (Blueprint $table) {
                return $table->unsignedInteger('fornecedor_id')->nullable()->default(null);
            ...
            $this->ensureColumn('locacaos', 'material_previsto', function (Blueprint $table) {
                return $table->string('material_previsto', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('locacaos', 'contrato_id', function (Blueprint $table) {
                return $table->unsignedInteger('contrato_id')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'data_entrega', function (Blueprint $table) {
                return $table->dateTime('data_entrega')->nullable()->default(null);
            ...
            $this->ensureColumn('locacaos', 'data_solicitacao_retirada', function (Blueprint $table) {
                return $table->dateTime('data_solicitacao_retirada')->nullable()->default(null);
            }, ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'data_retirada', function (Blueprint $table) {
                return $table->dateTime('data_retirada')->nullable()->default(null);
            }, ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'rua_entrega', function (Blueprint $table) {
                return $table->string('rua_entrega', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'numero_entrega', function (Blueprint $table) {
                return $table->string('numero_entrega', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('locacaos', 'bairro_entrega', function (Blueprint $table) {
                return $table->string('bairro_entrega', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('locacaos', 'cep_entrega', function (Blueprint $table) {
                return $table->string('cep_entrega', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('locacaos', 'referencia_entrega', function (Blueprint $table) {
                return $table->string('referencia_entrega', 250)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(250)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'cidade_id_entrega', function (Blueprint $table) {
                return $table->unsignedInteger('cidade_id_entrega')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'usuario_id', function (Blueprint $table) {
                return $table->unsignedInteger('usuario_id')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'filial_id', function (Blueprint $table) {
                return $table->unsignedInteger('filial_id')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'faturado', function (Blueprint $table) {
                return $table->tinyInteger('faturado')->nullable()->default('0');
            ...
            $this->ensureColumn('locacaos', 'tipo_calculo', function (Blueprint $table) {
                return $table->enum('tipo_calculo', ['fechado', 'dia', 'mes'])->nullable()->default('fechado')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'fechado\',\'dia\',\'mes\')', 'nullable' => true, 'column_default' => 'fechado', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'valor_unitario_calculo', function (Blueprint $table) {
                return $table->decimal('valor_unitario_calculo', 10, 2)->nullable()->default('0.00');
            ...
            $this->ensureColumn('locacaos', 'valor_frete', function (Blueprint $table) {
                return $table->decimal('valor_frete', 10, 2)->nullable()->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'quantidade_parcelas', function (Blueprint $table) {
                return $table->integer('quantidade_parcelas')->nullable()->default('1');
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'primeiro_vencimento', function (Blueprint $table) {
                return $table->date('primeiro_vencimento')->nullable()->default(null);
            }, ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'forma_pagamento', function (Blueprint $table) {
                return $table->string('forma_pagamento', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('locacaos', 'observacao', function (Blueprint $table) {
                return $table->text('observacao')->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->addIndexIfMissing('locacaos', 'locacaos_contrato_id_foreign', ['contrato_id'], false);
            $this->addIndexIfMissing('locacaos', 'locacaos_cidade_id_entrega_foreign', ['cidade_id_entrega'], false);
            $this->addForeignIfMissing('locacaos', 'locacaos_cidade_id_entrega_foreign', 'cidade_id_entrega', 'cidades', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('locacaos', 'locacaos_contrato_id_foreign', 'contrato_id', 'contratos', 'set null', 'id', 'restrict');
        });
    }
