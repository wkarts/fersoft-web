...
{
    private const REFERENCE_COLUMNS = ['cidade_id' => ['cidade_deliveries', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120105_update_delivery_configs_table';
    private const TABLE_NAME = 'delivery_configs';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('delivery_configs');
            $this->preflightColumn('delivery_configs', 'celular_notificacao', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('delivery_configs', 'valor_minimo_pedido', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('delivery_configs', 'celular_notificacao', function (Blueprint $table) {
                return $table->string('celular_notificacao', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('delivery_configs', 'valor_minimo_pedido', function (Blueprint $table) {
                return $table->decimal('valor_minimo_pedido', 10, 2)->nullable()->default('0.00');
