...
{
    private const REFERENCE_COLUMNS = ['empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120051_update_balanca_configs_table';
    private const TABLE_NAME = 'balanca_configs';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('balanca_configs');
            $this->preflightColumn('balanca_configs', 'integrador', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => 'local', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('balanca_configs', 'quantidade_cameras', ['column_type' => 'int', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('balanca_configs', 'adp_camera_uuids', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('balanca_configs', 'integrador', function (Blueprint $table) {
                return $table->string('integrador', 255)->nullable()->default('local')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => 'local', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('balanca_configs', 'quantidade_cameras', function (Blueprint $table) {
                return $table->integer('quantidade_cameras')->nullable()->default('0');
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('balanca_configs', 'adp_camera_uuids', function (Blueprint $table) {
                return $table->longText('adp_camera_uuids')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
