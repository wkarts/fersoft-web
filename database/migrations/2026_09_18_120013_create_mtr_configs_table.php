...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120013_create_mtr_configs_table';
    private const TABLE_NAME = 'mtr_configs';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('mtr_configs', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'orgao', ['column_type' => 'enum(\'SINIR\',\'IEMA\',\'SIGOR\',\'FEAM\',\'IMA\',\'FEPAM\')', 'nullable' => false, 'column_default' => 'SINIR', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'cpf_cnpj', ['column_type' => 'varchar(19)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'cpf_usuario', ['column_type' => 'varchar(14)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'senha', ['column_type' => 'varchar(500)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'unidade_id', ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'perfil', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => 'Gerador', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'descricao', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'ambiente', ['column_type' => 'enum(\'homologacao\',\'producao\')', 'nullable' => false, 'column_default' => 'homologacao', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'ativo', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_configs', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('mtr_configs', 'PRIMARY', ['id'], true);
            $this->preflightIndex('mtr_configs', 'idx_mtr_configs_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('mtr_configs', 'idx_mtr_configs_filial_id', ['filial_id'], false);
            $this->preflightIndex('mtr_configs', 'idx_mtr_configs_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('mtr_configs', 'mtr_configs_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('mtr_configs', 'mtr_configs_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('mtr_configs', 'mtr_configs_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('mtr_configs')) {
                if (!$this->beginChange('table', 'mtr_configs', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('mtr_configs', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->string('cpf_cnpj', 19)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cpf_usuario', 14)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('senha', 500)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('unidade_id', 50)->default('1')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('perfil', 50)->nullable()->default('Gerador')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('descricao', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('ambiente', ['homologacao', 'producao'])->default('homologacao')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->tinyInteger('ativo')->default('1');
                    $table->timestamps();

                    $table->index('empresa_id', 'idx_mtr_configs_empresa_id');
                    $table->index('filial_id', 'idx_mtr_configs_filial_id');
                    $table->index('usuario_id', 'idx_mtr_configs_usuario_id');
                });
                $this->markCreated('table', 'mtr_configs');
            }

            $this->ensureBaseTenantColumns('mtr_configs');
            $this->ensureColumn('mtr_configs', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_configs', 'orgao', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_configs', 'cpf_cnpj', function (Blueprint $table) {
                return $table->string('cpf_cnpj', 19)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_configs', 'cpf_usuario', function (Blueprint $table) {
                return $table->string('cpf_usuario', 14)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(14)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_configs', 'senha', function (Blueprint $table) {
                return $table->string('senha', 500)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(500)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_configs', 'unidade_id', function (Blueprint $table) {
                return $table->string('unidade_id', 50)->nullable(false)->default('1')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_configs', 'perfil', function (Blueprint $table) {
                return $table->string('perfil', 50)->nullable()->default('Gerador')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => 'Gerador', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_configs', 'descricao', function (Blueprint $table) {
                return $table->string('descricao', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_configs', 'ambiente', function (Blueprint $table) {
                return $table->enum('ambiente', ['homologacao', 'producao'])->nullable(false)->default('homologacao')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'homologacao\',\'producao\')', 'nullable' => false, 'column_default' => 'homologacao', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_configs', 'ativo', function (Blueprint $table) {
                return $table->tinyInteger('ativo')->nullable(false)->default('1');
            ...
            $this->ensureColumn('mtr_configs', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_configs', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('mtr_configs', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('mtr_configs', 'idx_mtr_configs_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('mtr_configs', 'idx_mtr_configs_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('mtr_configs', 'idx_mtr_configs_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('mtr_configs', 'mtr_configs_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_configs', 'mtr_configs_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_configs', 'mtr_configs_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('mtr_configs', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('mtr_configs', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('mtr_configs', 'usuario_id', function (Blueprint $table) {
