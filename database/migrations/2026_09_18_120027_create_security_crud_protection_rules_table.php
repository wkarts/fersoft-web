...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120027_create_security_crud_protection_rules_table';
    private const TABLE_NAME = 'security_crud_protection_rules';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('security_crud_protection_rules', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'security_crud_resource_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'action', ['column_type' => 'varchar(40)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'protection_type', ['column_type' => 'varchar(60)', 'nullable' => false, 'column_default' => 'none', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'requires_authorizer', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'allow_self_authorization', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'bypass_super_admin', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'bypass_company_admin', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'message', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'source', ['column_type' => 'varchar(30)', 'nullable' => false, 'column_default' => 'manual', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'created_by', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'updated_by', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_protection_rules', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('security_crud_protection_rules', 'PRIMARY', ['id'], true);
            $this->preflightIndex('security_crud_protection_rules', 'sec_crud_rule_unique', ['empresa_id', 'security_crud_resource_id', 'action'], true);
            $this->preflightIndex('security_crud_protection_rules', 'security_crud_protection_rules_security_crud_resource_id_index', ['security_crud_resource_id'], false);
            $this->preflightIndex('security_crud_protection_rules', 'security_crud_protection_rules_action_index', ['action'], false);
            $this->preflightIndex('security_crud_protection_rules', 'security_crud_protection_rules_protection_type_index', ['protection_type'], false);
            $this->preflightIndex('security_crud_protection_rules', 'security_crud_protection_rules_enabled_index', ['enabled'], false);
            $this->preflightIndex('security_crud_protection_rules', 'security_crud_protection_rules_source_index', ['source'], false);
            $this->preflightIndex('security_crud_protection_rules', 'security_crud_protection_rules_created_by_index', ['created_by'], false);
            $this->preflightIndex('security_crud_protection_rules', 'security_crud_protection_rules_updated_by_index', ['updated_by'], false);
            $this->preflightIndex('security_crud_protection_rules', 'idx_security_crud_protection_rules_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('security_crud_protection_rules', 'idx_security_crud_protection_rules_filial_id', ['filial_id'], false);
            $this->preflightIndex('security_crud_protection_rules', 'idx_security_crud_protection_rules_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('security_crud_protection_rules', 'security_crud_protection_rules_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('security_crud_protection_rules', 'security_crud_protection_rules_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('security_crud_protection_rules', 'security_crud_protection_rules_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('security_crud_protection_rules')) {
                if (!$this->beginChange('table', 'security_crud_protection_rules', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('security_crud_protection_rules', function (Blueprint $table) {
                    ...
                    $table->unsignedBigInteger('security_crud_resource_id');
                    $table->string('action', 40)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('protection_type', 60)->default('none')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->tinyInteger('requires_authorizer')->default('0');
                    $table->tinyInteger('allow_self_authorization')->default('0');
                    $table->tinyInteger('bypass_super_admin')->default('1');
                    $table->tinyInteger('bypass_company_admin')->default('0');
                    $table->tinyInteger('enabled')->default('1');
                    $table->text('message')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('source', 30)->default('manual')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    ...
                    $table->index('security_crud_resource_id', 'security_crud_protection_rules_security_crud_resource_id_index');
                    $table->index('action', 'security_crud_protection_rules_action_index');
                    $table->index('protection_type', 'security_crud_protection_rules_protection_type_index');
                    $table->index('enabled', 'security_crud_protection_rules_enabled_index');
                    $table->index('source', 'security_crud_protection_rules_source_index');
                    $table->index('created_by', 'security_crud_protection_rules_created_by_index');
                    $table->index('updated_by', 'security_crud_protection_rules_updated_by_index');
                    $table->index('empresa_id', 'idx_security_crud_protection_rules_empresa_id');
                    $table->index('filial_id', 'idx_security_crud_protection_rules_filial_id');
                    $table->index('usuario_id', 'idx_security_crud_protection_rules_usuario_id');
                });
                $this->markCreated('table', 'security_crud_protection_rules');
            }

            $this->ensureBaseTenantColumns('security_crud_protection_rules');
            $this->ensureColumn('security_crud_protection_rules', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_crud_protection_rules', 'security_crud_resource_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('security_crud_resource_id')->nullable(false)->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'action', function (Blueprint $table) {
                return $table->string('action', 40)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(40)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'protection_type', function (Blueprint $table) {
                return $table->string('protection_type', 60)->nullable(false)->default('none')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(60)', 'nullable' => false, 'column_default' => 'none', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'requires_authorizer', function (Blueprint $table) {
                return $table->tinyInteger('requires_authorizer')->nullable(false)->default('0');
            ...
            $this->ensureColumn('security_crud_protection_rules', 'allow_self_authorization', function (Blueprint $table) {
                return $table->tinyInteger('allow_self_authorization')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'bypass_super_admin', function (Blueprint $table) {
                return $table->tinyInteger('bypass_super_admin')->nullable(false)->default('1');
            ...
            $this->ensureColumn('security_crud_protection_rules', 'bypass_company_admin', function (Blueprint $table) {
                return $table->tinyInteger('bypass_company_admin')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'enabled', function (Blueprint $table) {
                return $table->tinyInteger('enabled')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'message', function (Blueprint $table) {
                return $table->text('message')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('security_crud_protection_rules', 'source', function (Blueprint $table) {
                return $table->string('source', 30)->nullable(false)->default('manual')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(30)', 'nullable' => false, 'column_default' => 'manual', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'created_by', function (Blueprint $table) {
                return $table->unsignedBigInteger('created_by')->nullable()->default(null);
            ...
            $this->ensureColumn('security_crud_protection_rules', 'updated_by', function (Blueprint $table) {
                return $table->unsignedBigInteger('updated_by')->nullable()->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_crud_protection_rules', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_protection_rules', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('security_crud_protection_rules', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('security_crud_protection_rules', 'sec_crud_rule_unique', ['empresa_id', 'security_crud_resource_id', 'action'], true);
            $this->addIndexIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_security_crud_resource_id_index', ['security_crud_resource_id'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_action_index', ['action'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_protection_type_index', ['protection_type'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_enabled_index', ['enabled'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_source_index', ['source'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_created_by_index', ['created_by'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_updated_by_index', ['updated_by'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'idx_security_crud_protection_rules_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'idx_security_crud_protection_rules_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('security_crud_protection_rules', 'idx_security_crud_protection_rules_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('security_crud_protection_rules', 'security_crud_protection_rules_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('security_crud_protection_rules', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_crud_protection_rules', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_crud_protection_rules', 'usuario_id', function (Blueprint $table) {
