...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureNullableAndComment('cliente_oticas', 'empresa_id', true, null);
        $this->ensureNullableAndComment('cliente_oticas', 'filial_id', true, null);
        $this->ensureNullableAndComment('cliente_oticas', 'medico', true, null);
        $this->ensureNullableAndComment('cliente_oticas', 'status', true, null);
        $this->ensureNullableAndComment('cliente_oticas', 'cil_oe_longe', true, null);
    }
