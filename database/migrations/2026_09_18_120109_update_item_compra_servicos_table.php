...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120109_update_item_compra_servicos_table';
    private const TABLE_NAME = 'item_compra_servicos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('item_compra_servicos');
            $this->preflightColumn('item_compra_servicos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compra_servicos', 'compra_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compra_servicos', 'codigo_servico_lc116', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('item_compra_servicos', 'discriminacao', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('item_compra_servicos', 'valor_servico', ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('item_compra_servicos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('item_compra_servicos', 'compra_id', function (Blueprint $table) {
                return $table->unsignedInteger('compra_id')->nullable()->default(null);
            ...
            $this->ensureColumn('item_compra_servicos', 'codigo_servico_lc116', function (Blueprint $table) {
                return $table->string('codigo_servico_lc116', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('item_compra_servicos', 'discriminacao', function (Blueprint $table) {
                return $table->text('discriminacao')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('item_compra_servicos', 'valor_servico', function (Blueprint $table) {
