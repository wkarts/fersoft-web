...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120119_update_pesagem_pagamentos_table';
    private const TABLE_NAME = 'pesagem_pagamentos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('pesagem_pagamentos');
            $this->preflightColumn('pesagem_pagamentos', 'fornecedor_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pesagem_pagamentos', 'remessa_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pesagem_pagamentos', 'valor_total_pago', ['column_type' => 'decimal(12,2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pesagem_pagamentos', 'status', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => 'PROCESSANDO', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightIndex('pesagem_pagamentos', 'pesagem_id', ['pesagem_id'], true);

            $this->ensureColumn('pesagem_pagamentos', 'fornecedor_id', function (Blueprint $table) {
                return $table->integer('fornecedor_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('pesagem_pagamentos', 'remessa_id', function (Blueprint $table) {
                return $table->integer('remessa_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('pesagem_pagamentos', 'valor_total_pago', function (Blueprint $table) {
                return $table->decimal('valor_total_pago', 12, 2)->nullable()->default(null);
            }, ['column_type' => 'decimal(12,2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('pesagem_pagamentos', 'status', function (Blueprint $table) {
                return $table->string('status', 30)->nullable()->default('PROCESSANDO')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => 'PROCESSANDO', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->addIndexIfMissing('pesagem_pagamentos', 'pesagem_id', ['pesagem_id'], true);
        });
    }
