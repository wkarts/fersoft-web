...
{
    private const REFERENCE_COLUMNS = ['cidade_cobranca_id' => ['cidades', 'id', 'cascade', 'restrict'], 'cidade_id' => ['cidades', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120056_update_clientes_table';
    ...
    public function up()
    {
        $this->runWithSchemaLock(function () {
            ...
            $this->ensureTableExists('clientes');
            $this->preflightColumn('clientes', 'latitude', ['column_type' => 'decimal(10,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('clientes', 'longitude', ['column_type' => 'decimal(11,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('clientes', 'latitude', function (Blueprint $table) {
            ...
            $this->ensureColumn('clientes', 'longitude', function (Blueprint $table) {
