...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120054_update_categoria_contas_table';
    private const TABLE_NAME = 'categoria_contas';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('categoria_contas');
            $this->preflightColumn('categoria_contas', 'int_ctb', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('categoria_contas', 'int_ctb_servico', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('categoria_contas', 'int_ctb', function (Blueprint $table) {
                return $table->string('int_ctb', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('categoria_contas', 'int_ctb_servico', function (Blueprint $table) {
                return $table->string('int_ctb_servico', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
        });
    }
