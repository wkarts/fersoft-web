...
<div class="card card-custom gutter-b view-acesso d-none">
	<div class="card-body">
															...
															<tr class="datatable-row" style="left: 0px; @if($v->estado == 'REJEITADO') background: #ffcdd2; @elseif($v->estado == 'APROVADO') background: #a7ffeb; @endif">
																...
																<td class="datatable-cell">
																	<span class="codigo" style="width: 220px;">
																		...
																		<a class="btn btn-info" onclick='swal("Atenção!", "Deseja retornar o estoque desta venda?", "warning").then((sim) => {if(sim){ location.href="/frenteCaixa/retornaEstoque/{{ $v->id }}" }else{return false} })' href="#!">
...
<div class="modal fade" id="modal2" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group validated col-sm-4 col-lg-4 col-Numero NF Inicial-6">
					...
					<div class="form-group validated col-sm-4 col-lg-4">
						<label class="col-form-label" id="">Número de Série</label>
						<div class="">
							<input type="text" id="nSerie" placeholder="" name="nSerie" class="form-control" value="">
						</div>
					</div>
...
@endsection
@section('javascript')
<script type="text/javascript" src="/js/validaAcessoTela.js"></script>
@endsection
