...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureNullableAndComment('produto_fornecedors', 'usuario_id', true, null);
        $this->ensureNullableAndComment('produto_fornecedors', 'descricao_fornecedor', true, null);
        $this->ensureNullableAndComment('produto_fornecedors', 'codigo_barras_fornecedor', true, null);
    }
