...
{
    private const REFERENCE_COLUMNS = ['cliente_id' => ['clientes', 'id', 'restrict', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'cascade', 'restrict'], 'frete_id' => ['fretes', 'id', 'cascade', 'restrict'], 'natureza_id' => ['natureza_operacaos', 'id', 'restrict', 'restrict'], 'transportadora_id' => ['transportadoras', 'id', 'cascade', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'restrict', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120130_update_vendas_table';
    private const TABLE_NAME = 'vendas';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('vendas');
            $this->preflightColumn('vendas', 'estado_cliente', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('vendas', 'estado_cliente', function (Blueprint $table) {
                return $table->string('estado_cliente', 30)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
