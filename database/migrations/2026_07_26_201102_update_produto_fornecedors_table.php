...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('produto_fornecedors', 'produto_id', 'INT UNSIGNED NOT NULL');
        $this->applyColumnDefinition('produto_fornecedors', 'fornecedor_id', 'INT UNSIGNED NOT NULL');
        $this->applyColumnDefinition('produto_fornecedors', 'codigo_fornecedor', 'VARCHAR(100) NOT NULL');
    }
