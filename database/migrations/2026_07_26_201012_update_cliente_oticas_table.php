...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('cliente_oticas', 'eixo_od_longe', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'dnp_od_longe', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'dp_od_longe', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'eixo_oe_longe', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'dnp_oe_longe', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'eixo_od_perto', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'adicao_od_perto', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'altura_od_perto', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'dnp_od_perto', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'dp_od_perto', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'eixo_oe_perto', 'DECIMAL(6, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'qtd_armacao', 'INT NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'valor_armacao', 'DECIMAL(15, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'qtd_lente', 'INT NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'valor_lente', 'DECIMAL(15, 2) NOT NULL');
        $this->applyColumnDefinition('cliente_oticas', 'referencia', 'VARCHAR(100) NOT NULL');
    }
