...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120121_update_plano_contas_contabil_table';
    private const TABLE_NAME = 'plano_contas_contabil';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('plano_contas_contabil');
            $this->preflightColumn('plano_contas_contabil', 'codigo_acesso', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('plano_contas_contabil', 'classificador', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('plano_contas_contabil', 'nome', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('plano_contas_contabil', 'codigo_acesso', function (Blueprint $table) {
                return $table->string('codigo_acesso', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('plano_contas_contabil', 'classificador', function (Blueprint $table) {
                return $table->string('classificador', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('plano_contas_contabil', 'nome', function (Blueprint $table) {
                return $table->string('nome', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
