										...
										<table class="datatable-table" style="max-width: 100%; overflow: scroll">
											<thead class="datatable-head">
												<tr class="datatable-row" style="left: 0px;">
                                                    ...
                                                    <th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 150px;">FAB/MOD</span></th>
                                                    <th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 150px;">QUILOMETRAGEM</span></th>
                                                    <th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 170px;">STATUS MANUTENÇÃO</span></th>
                                                    <th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 170px;">PRÓXIMA REVISÃO</span></th>
											...
											<tbody id="body" class="datatable-body">
												...
												<tr class="datatable-row">
                                                    ...
                                                    <td class="datatable-cell"><span class="codigo" style="width: 150px;" id="id">{{$v->ano_fabricacao}}/{{$v->ano_modelo}}</span>
                                                    </td>
                                                    <td class="datatable-cell"><span class="codigo" style="width: 150px;" id="id">{{ number_format($v->quilometragem ?? 0, 0, ',', '.') }} km</span>
                                                    </td>
                                                    <td class="datatable-cell"><span class="codigo" style="width: 170px;" id="id">{{$v->status_manutencao ?? 'Em dia'}}</span>
                                                    </td>
                                                    <td class="datatable-cell"><span class="codigo" style="width: 170px;" id="id">{{ optional($v->data_proxima_revisao)->format('d/m/Y') ?? 'N/A' }}</span>
                                                    </td>
									...
									<div class="card card-custom gutter-b example example-compact">
										...
										<div class="card-body">
                                            ...
                                            <div class="kt-widget__info">
                                                ...
                                                <a target="_blank" class="kt-widget__data text-success">{{ $c->placa }}</a>
                                            </div>
											<div class="kt-widget__info">
											...
											<div class="kt-widget__info">
												...
												<a class="kt-widget__data text-success">{{$c->rntrc}}</a>
                                                                                        ...
                                                                                        <div class="kt-widget__info">
                                                                                                <span class="kt-widget__label">Quilometragem:</span>
                                                                                                <a class="kt-widget__data text-success">{{ number_format($c->quilometragem ?? 0, 0, ',', '.') }} km</a>
                                                                                        </div>

                                                                                        <div class="kt-widget__info">
                                                                                                <span class="kt-widget__label">Status Manutenção:</span>
                                                                                                <a class="kt-widget__data text-success">{{$c->status_manutencao ?? 'Em dia'}}</a>
                                                                                        </div>

                                                                                        <div class="kt-widget__info">
                                                                                                <span class="kt-widget__label">Próxima Revisão:</span>
                                                                                                <a class="kt-widget__data text-success">{{ optional($c->data_proxima_revisao)->format('d/m/Y') ?? '--' }}</a>
                                                                                        </div>

                                                                                        <div class="kt-widget__info">
                                                                                                <span class="kt-widget__label">Última Manutenção:</span>
                                                                                                <a class="kt-widget__data text-success">{{ optional($c->data_ultima_manutencao)->format('d/m/Y') ?? '--' }}</a>
                                                                                        </div>
