...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('ctes')) { return; }

        $this->ensureBaseTenantColumns('ctes');

        Schema::table('ctes', function (Blueprint $table) {

            if (!Schema::hasColumn('ctes', 'data_emissao')) { $table->date('data_emissao')->nullable()->after('cte_numero'); }
    ...
    public function down()
    {
        if (!Schema::hasTable('ctes')) { return; }
        Schema::table('ctes', function (Blueprint $table) {
                if (Schema::hasColumn('ctes', 'data_emissao')) { $table->dropColumn('data_emissao'); }
        });
    }
