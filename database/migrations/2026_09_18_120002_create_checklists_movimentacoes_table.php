...
{
    private const REFERENCE_COLUMNS = ['movimentacao_veiculo_id' => ['movimentacoes_veiculos', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120002_create_checklists_movimentacoes_table';
    private const TABLE_NAME = 'checklists_movimentacoes';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('checklists_movimentacoes', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklists_movimentacoes', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklists_movimentacoes', 'movimentacao_veiculo_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklists_movimentacoes', 'funcionario_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'Motorista que preencheu']);
            $this->preflightColumn('checklists_movimentacoes', 'data_resposta', ['column_type' => 'datetime', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklists_movimentacoes', 'obrigatorio', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => '1 = Sim, 0 = Opcional']);
            $this->preflightColumn('checklists_movimentacoes', 'status_geral', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => 'aprovado', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'aprovado, com_ressalvas, reprovado']);
            $this->preflightColumn('checklists_movimentacoes', 'observacoes', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Observação geral informada pelo motorista']);
            $this->preflightColumn('checklists_movimentacoes', 'respostas_json', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Guarda as respostas detalhadas dos itens em formato JSON']);
            $this->preflightColumn('checklists_movimentacoes', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklists_movimentacoes', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklists_movimentacoes', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklists_movimentacoes', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('checklists_movimentacoes', 'PRIMARY', ['id'], true);
            $this->preflightIndex('checklists_movimentacoes', 'fk_checklist_movimentacao', ['movimentacao_veiculo_id'], false);
            $this->preflightIndex('checklists_movimentacoes', 'idx_checklists_movimentacoes_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('checklists_movimentacoes', 'idx_checklists_movimentacoes_filial_id', ['filial_id'], false);
            $this->preflightIndex('checklists_movimentacoes', 'idx_checklists_movimentacoes_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('checklists_movimentacoes', 'fk_checklist_movimentacao', 'movimentacao_veiculo_id', 'movimentacoes_veiculos', 'cascade', 'id', 'restrict');
            $this->preflightForeign('checklists_movimentacoes', 'checklists_movimentacoes_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('checklists_movimentacoes', 'checklists_movimentacoes_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('checklists_movimentacoes', 'checklists_movimentacoes_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('checklists_movimentacoes')) {
                if (!$this->beginChange('table', 'checklists_movimentacoes', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('checklists_movimentacoes', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->unsignedBigInteger('movimentacao_veiculo_id');
                    $table->integer('funcionario_id')->comment('Motorista que preencheu');
                    $table->dateTime('data_resposta');
                    $table->tinyInteger('obrigatorio')->nullable()->default('1')->comment('1 = Sim, 0 = Opcional');
                    $table->string('status_geral', 30)->nullable()->default('aprovado')->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('aprovado, com_ressalvas, reprovado');
                    $table->text('observacoes')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Observação geral informada pelo motorista');
                    $table->text('respostas_json')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Guarda as respostas detalhadas dos itens em formato JSON');
                    $table->timestamps();

                    $table->index('movimentacao_veiculo_id', 'fk_checklist_movimentacao');
                    $table->index('empresa_id', 'idx_checklists_movimentacoes_empresa_id');
                    $table->index('filial_id', 'idx_checklists_movimentacoes_filial_id');
                    $table->index('usuario_id', 'idx_checklists_movimentacoes_usuario_id');
                });
                $this->markCreated('table', 'checklists_movimentacoes');
            }

            $this->ensureBaseTenantColumns('checklists_movimentacoes');
            $this->ensureColumn('checklists_movimentacoes', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('checklists_movimentacoes', 'movimentacao_veiculo_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('movimentacao_veiculo_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('checklists_movimentacoes', 'funcionario_id', function (Blueprint $table) {
                return $table->integer('funcionario_id')->nullable(false)->default(null)->comment('Motorista que preencheu');
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'Motorista que preencheu']);
            $this->ensureColumn('checklists_movimentacoes', 'data_resposta', function (Blueprint $table) {
                return $table->dateTime('data_resposta')->nullable(false)->default(null);
            ...
            $this->ensureColumn('checklists_movimentacoes', 'obrigatorio', function (Blueprint $table) {
                return $table->tinyInteger('obrigatorio')->nullable()->default('1')->comment('1 = Sim, 0 = Opcional');
            }, ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => '1 = Sim, 0 = Opcional']);
            $this->ensureColumn('checklists_movimentacoes', 'status_geral', function (Blueprint $table) {
                return $table->string('status_geral', 30)->nullable()->default('aprovado')->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('aprovado, com_ressalvas, reprovado');
            }, ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => 'aprovado', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'aprovado, com_ressalvas, reprovado']);
            $this->ensureColumn('checklists_movimentacoes', 'observacoes', function (Blueprint $table) {
                return $table->text('observacoes')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Observação geral informada pelo motorista');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Observação geral informada pelo motorista']);
            $this->ensureColumn('checklists_movimentacoes', 'respostas_json', function (Blueprint $table) {
                return $table->text('respostas_json')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Guarda as respostas detalhadas dos itens em formato JSON');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Guarda as respostas detalhadas dos itens em formato JSON']);
            $this->ensureColumn('checklists_movimentacoes', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('checklists_movimentacoes', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('checklists_movimentacoes', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('checklists_movimentacoes', 'fk_checklist_movimentacao', ['movimentacao_veiculo_id'], false);
            $this->addIndexIfMissing('checklists_movimentacoes', 'idx_checklists_movimentacoes_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('checklists_movimentacoes', 'idx_checklists_movimentacoes_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('checklists_movimentacoes', 'idx_checklists_movimentacoes_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('checklists_movimentacoes', 'fk_checklist_movimentacao', 'movimentacao_veiculo_id', 'movimentacoes_veiculos', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('checklists_movimentacoes', 'checklists_movimentacoes_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('checklists_movimentacoes', 'checklists_movimentacoes_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('checklists_movimentacoes', 'checklists_movimentacoes_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('checklists_movimentacoes', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('checklists_movimentacoes', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('checklists_movimentacoes', 'usuario_id', function (Blueprint $table) {
