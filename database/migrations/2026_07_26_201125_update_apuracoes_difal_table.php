...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureNullableAndComment('apuracoes_difal', 'filial_id', true, null);
        $this->ensureNullableAndComment('apuracoes_difal', 'contas_a_pagar_id', true, null);
        $this->ensureNullableAndComment('apuracoes_difal', 'status', true, null);
    }
