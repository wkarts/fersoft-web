	...
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<div class="row @if(env('ANIMACAO')) animate__animated @endif animate__backInRight">
                <div class="d-flex align-items-center @if(env('ANIMACAO')) animate__animated animate__backInRight @endif">
                    <a href="/vendas/nova" class="btn btn-success mr-3">
                        <i class="la la-plus"></i>
                        Nova Venda
                    </a>
                    @if(isset($vendas) && count($vendas) > 0)
                        <a href="{{ url('/vendas/syncDataEmissaoRetroativa') }}" class="btn btn-light">
                            <i class="fa fa-sync"></i>
                            Sincronizar Data de Emissão Retroativa
                        </a>
                    @endif
                </div>
...
@endphp
															...
															<div class="row">
                                                                ...
                                                                <i class="la la-edit"></i>
                                                                                                                               ...
                                                                                                                               @elseif($podeInutilizar)
                                                                                                                               <a class="btn btn-danger btn-sm" onclick='swal("Atenção!", "Deseja inutilizar a numeração desta venda?", "warning").then((sim) => {if(sim){ location.href="/vendas/inutilizar/{{ $v->id }}" }else{return false} })' href="#!">
                                                                                                                               <i class="la la-ban"></i>
                                                                                                                               </a>
                                                                                                                               @endif
...
@elseif($podeInutilizar)
<li class="navi-item">
<a onclick='swal("Atenção!", "Deseja inutilizar a numeração desta venda?", "warning").then((sim) => {if(sim){ location.href="/vendas/inutilizar/{{ $v->id }}" }else{return false} })' href="#!" class="navi-link">
<span class="navi-text">
<span class="label label-xl label-inline label-light-danger">Inutilizar NF-e</span>
</span>
</a>
</li>
@endif
												...
												<div class="row">
													...
													@endif
                                                                                                        ...
                                                                                                        <div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
                                                                                                                ...
                                                                                                                @elseif($podeInutilizar)
                                                                                                                <a style="width: 100%; margin-top: 5px;" onclick='swal("Atenção!", "Deseja inutilizar a numeração desta venda?", "warning").then((sim) => {if(sim){ location.href="/vendas/inutilizar/{{ $v->id }}" }else{return false} })' href="#!" class="btn btn-danger spinner-white spinner-right">
                                                                                                                        <i class="la la-ban"></i>
                                                                                                                        Inutilizar NF-e
                                                                                                                </a>
                                                                                                                @endif
