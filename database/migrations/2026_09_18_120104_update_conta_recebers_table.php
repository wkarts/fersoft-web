...
{
    private const REFERENCE_COLUMNS = ['categoria_id' => ['categoria_contas', 'id', 'cascade', 'restrict'], 'cliente_id' => ['clientes', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'cascade', 'restrict'], 'venda_caixa_id' => ['venda_caixas', 'id', 'cascade', 'restrict'], 'venda_id' => ['vendas', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120104_update_conta_recebers_table';
    private const TABLE_NAME = 'conta_recebers';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('conta_recebers');
            $this->preflightColumn('conta_recebers', 'usuario_edicao_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('conta_recebers', 'filial_ajustada_auto', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('conta_recebers', 'usuario_baixa_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('conta_recebers', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('conta_recebers', 'usuario_edicao_id', function (Blueprint $table) {
                return $table->integer('usuario_edicao_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('conta_recebers', 'filial_ajustada_auto', function (Blueprint $table) {
            ...
            $this->ensureColumn('conta_recebers', 'usuario_baixa_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('usuario_baixa_id')->nullable()->default(null);
            ...
            $this->ensureColumn('conta_recebers', 'usuario_id', function (Blueprint $table) {
