...
{
    private const REFERENCE_COLUMNS = ['fatura_eng_id' => ['faturas_engenharia', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120038_create_fatura_eng_funcionarios_table';
    private const TABLE_NAME = 'fatura_eng_funcionarios';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('fatura_eng_funcionarios', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'fatura_eng_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'funcionario_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'funcao', ['column_type' => 'varchar(150)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'diarias', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '1.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'valor_diaria', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'valor_total', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_funcionarios', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('fatura_eng_funcionarios', 'PRIMARY', ['id'], true);
            $this->preflightIndex('fatura_eng_funcionarios', 'fatura_eng_funcionarios_fatura_eng_id_foreign', ['fatura_eng_id'], false);
            $this->preflightIndex('fatura_eng_funcionarios', 'idx_fatura_eng_funcionarios_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('fatura_eng_funcionarios', 'idx_fatura_eng_funcionarios_filial_id', ['filial_id'], false);
            $this->preflightIndex('fatura_eng_funcionarios', 'idx_fatura_eng_funcionarios_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('fatura_eng_funcionarios', 'fatura_eng_funcionarios_fatura_eng_id_foreign', 'fatura_eng_id', 'faturas_engenharia', 'cascade', 'id', 'restrict');
            $this->preflightForeign('fatura_eng_funcionarios', 'fatura_eng_funcionarios_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('fatura_eng_funcionarios', 'fatura_eng_funcionarios_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('fatura_eng_funcionarios', 'fatura_eng_funcionarios_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('fatura_eng_funcionarios')) {
                if (!$this->beginChange('table', 'fatura_eng_funcionarios', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('fatura_eng_funcionarios', function (Blueprint $table) {
                    ...
                    $table->string('funcao', 150)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->decimal('diarias', 10, 2)->nullable()->default('1.00');
                    $table->decimal('valor_diaria', 10, 2)->nullable()->default('0.00');
                    $table->decimal('valor_total', 10, 2)->nullable()->default('0.00');
                    $table->timestamps();

                    $table->index('fatura_eng_id', 'fatura_eng_funcionarios_fatura_eng_id_foreign');
                    $table->index('empresa_id', 'idx_fatura_eng_funcionarios_empresa_id');
                    $table->index('filial_id', 'idx_fatura_eng_funcionarios_filial_id');
                    $table->index('usuario_id', 'idx_fatura_eng_funcionarios_usuario_id');
                });
                $this->markCreated('table', 'fatura_eng_funcionarios');
            }

            $this->ensureBaseTenantColumns('fatura_eng_funcionarios');
            $this->ensureColumn('fatura_eng_funcionarios', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('fatura_eng_funcionarios', 'fatura_eng_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('fatura_eng_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('fatura_eng_funcionarios', 'funcionario_id', function (Blueprint $table) {
                return $table->integer('funcionario_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('fatura_eng_funcionarios', 'funcao', function (Blueprint $table) {
                return $table->string('funcao', 150)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('fatura_eng_funcionarios', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('fatura_eng_funcionarios', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('fatura_eng_funcionarios', 'diarias', function (Blueprint $table) {
                return $table->decimal('diarias', 10, 2)->nullable()->default('1.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '1.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('fatura_eng_funcionarios', 'valor_diaria', function (Blueprint $table) {
                return $table->decimal('valor_diaria', 10, 2)->nullable()->default('0.00');
            ...
            $this->ensureColumn('fatura_eng_funcionarios', 'valor_total', function (Blueprint $table) {
                return $table->decimal('valor_total', 10, 2)->nullable()->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('fatura_eng_funcionarios', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('fatura_eng_funcionarios', 'fatura_eng_funcionarios_fatura_eng_id_foreign', ['fatura_eng_id'], false);
            $this->addIndexIfMissing('fatura_eng_funcionarios', 'idx_fatura_eng_funcionarios_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('fatura_eng_funcionarios', 'idx_fatura_eng_funcionarios_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('fatura_eng_funcionarios', 'idx_fatura_eng_funcionarios_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('fatura_eng_funcionarios', 'fatura_eng_funcionarios_fatura_eng_id_foreign', 'fatura_eng_id', 'faturas_engenharia', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('fatura_eng_funcionarios', 'fatura_eng_funcionarios_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('fatura_eng_funcionarios', 'fatura_eng_funcionarios_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('fatura_eng_funcionarios', 'fatura_eng_funcionarios_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('fatura_eng_funcionarios', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('fatura_eng_funcionarios', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('fatura_eng_funcionarios', 'usuario_id', function (Blueprint $table) {
