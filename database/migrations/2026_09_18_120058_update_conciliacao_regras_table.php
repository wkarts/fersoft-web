...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120058_update_conciliacao_regras_table';
    private const TABLE_NAME = 'conciliacao_regras';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('conciliacao_regras');
            $this->preflightColumn('conciliacao_regras', 'tipo_conta', ['column_type' => 'enum(\'pagar\',\'receber\')', 'nullable' => false, 'column_default' => 'pagar', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('conciliacao_regras', 'tipo_conta', function (Blueprint $table) {
                return $table->enum('tipo_conta', ['pagar', 'receber'])->nullable(false)->default('pagar')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'pagar\',\'receber\')', 'nullable' => false, 'column_default' => 'pagar', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
        });
    }
