...
{
    private const REFERENCE_COLUMNS = ['categoria_id' => ['categoria_contas', 'id', 'cascade', 'restrict'], 'compra_id' => ['compras', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'cascade', 'restrict'], 'veiculo_id' => ['veiculos', 'id', 'set null', 'restrict'], 'contrato_eng_id' => ['contratos_engenharia', 'id', 'set null', 'cascade']];
    private const MIGRATION_NAME = '2026_09_18_120103_update_conta_pagars_table';
    private const TABLE_NAME = 'conta_pagars';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('conta_pagars');
            $this->preflightColumn('conta_pagars', 'contrato_eng_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('conta_pagars', 'filial_ajustada_auto', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('conta_pagars', 'numero_nota_fiscal', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightIndex('conta_pagars', 'fk_contas_pagar_contrato_eng', ['contrato_eng_id'], false);
            $this->preflightForeign('conta_pagars', 'fk_contas_pagar_contrato_eng', 'contrato_eng_id', 'contratos_engenharia', 'set null', 'id', 'cascade');

            $this->ensureColumn('conta_pagars', 'contrato_eng_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('contrato_eng_id')->nullable()->default(null);
            ...
            $this->ensureColumn('conta_pagars', 'filial_ajustada_auto', function (Blueprint $table) {
                return $table->tinyInteger('filial_ajustada_auto')->nullable()->default('0');
            ...
            $this->ensureColumn('conta_pagars', 'numero_nota_fiscal', function (Blueprint $table) {
                return $table->string('numero_nota_fiscal', 20)->nullable()->default('0')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->addIndexIfMissing('conta_pagars', 'fk_contas_pagar_contrato_eng', ['contrato_eng_id'], false);
            $this->addForeignIfMissing('conta_pagars', 'fk_contas_pagar_contrato_eng', 'contrato_eng_id', 'contratos_engenharia', 'set null', 'id', 'cascade');
        });
    }
