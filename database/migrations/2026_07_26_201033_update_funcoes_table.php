...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addIndexIfMissing('funcoes', 'uq_funcoes_empresa_filial_nome', ['empresa_id', 'filial_id', 'nome'], true);
        $this->addForeignIfMissing('funcoes', 'funcoes_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
    }
