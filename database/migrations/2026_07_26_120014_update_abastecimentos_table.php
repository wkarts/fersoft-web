...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('abastecimentos', 'abastecimentos_filial_id_foreign', 'filial_id', 'filials', 'id', 'cascade', null);

        $this->addForeignIfMissing('abastecimentos', 'abastecimentos_fornecedor_fk', 'fornecedor_id', 'fornecedors', 'id', 'set null', null);
    }
