...
{
    private const REFERENCE_COLUMNS = ['empresa_id' => ['empresas', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120050_update_bairro_delivery_lojas_table';
    private const TABLE_NAME = 'bairro_delivery_lojas';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('bairro_delivery_lojas');
            $this->preflightColumn('bairro_delivery_lojas', 'cidade_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('bairro_delivery_lojas', 'nome', ['column_type' => 'varchar(60)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('bairro_delivery_lojas', 'cidade_id', function (Blueprint $table) {
                return $table->integer('cidade_id')->nullable()->default('1');
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('bairro_delivery_lojas', 'nome', function (Blueprint $table) {
                return $table->string('nome', 60)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(60)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
        });
    }
