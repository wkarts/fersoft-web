...
{
    private const REFERENCE_COLUMNS = ['funcionario_id' => ['funcionarios', 'id', 'cascade', 'restrict'], 'movimentacao_id' => ['movimentacoes_veiculos', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120012_create_movimentacao_ajudantes_table';
    private const TABLE_NAME = 'movimentacao_ajudantes';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('movimentacao_ajudantes', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacao_ajudantes', 'movimentacao_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacao_ajudantes', 'funcionario_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacao_ajudantes', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacao_ajudantes', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacao_ajudantes', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacao_ajudantes', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacao_ajudantes', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('movimentacao_ajudantes', 'PRIMARY', ['id'], true);
            $this->preflightIndex('movimentacao_ajudantes', 'fk_mov_ajudantes_mov', ['movimentacao_id'], false);
            $this->preflightIndex('movimentacao_ajudantes', 'fk_mov_ajudantes_func', ['funcionario_id'], false);
            $this->preflightIndex('movimentacao_ajudantes', 'idx_movimentacao_ajudantes_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('movimentacao_ajudantes', 'idx_movimentacao_ajudantes_filial_id', ['filial_id'], false);
            $this->preflightIndex('movimentacao_ajudantes', 'idx_movimentacao_ajudantes_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('movimentacao_ajudantes', 'fk_mov_ajudantes_func', 'funcionario_id', 'funcionarios', 'cascade', 'id', 'restrict');
            $this->preflightForeign('movimentacao_ajudantes', 'fk_mov_ajudantes_mov', 'movimentacao_id', 'movimentacoes_veiculos', 'cascade', 'id', 'restrict');
            $this->preflightForeign('movimentacao_ajudantes', 'movimentacao_ajudantes_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('movimentacao_ajudantes', 'movimentacao_ajudantes_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('movimentacao_ajudantes', 'movimentacao_ajudantes_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('movimentacao_ajudantes')) {
                if (!$this->beginChange('table', 'movimentacao_ajudantes', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('movimentacao_ajudantes', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->index('movimentacao_id', 'fk_mov_ajudantes_mov');
                    $table->index('funcionario_id', 'fk_mov_ajudantes_func');
                    $table->index('empresa_id', 'idx_movimentacao_ajudantes_empresa_id');
                    $table->index('filial_id', 'idx_movimentacao_ajudantes_filial_id');
                    $table->index('usuario_id', 'idx_movimentacao_ajudantes_usuario_id');
                });
                $this->markCreated('table', 'movimentacao_ajudantes');
            }

            $this->ensureBaseTenantColumns('movimentacao_ajudantes');
            $this->ensureColumn('movimentacao_ajudantes', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('movimentacao_ajudantes', 'movimentacao_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('movimentacao_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('movimentacao_ajudantes', 'funcionario_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('movimentacao_ajudantes', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('movimentacao_ajudantes', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('movimentacao_ajudantes', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('movimentacao_ajudantes', 'fk_mov_ajudantes_mov', ['movimentacao_id'], false);
            $this->addIndexIfMissing('movimentacao_ajudantes', 'fk_mov_ajudantes_func', ['funcionario_id'], false);
            $this->addIndexIfMissing('movimentacao_ajudantes', 'idx_movimentacao_ajudantes_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('movimentacao_ajudantes', 'idx_movimentacao_ajudantes_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('movimentacao_ajudantes', 'idx_movimentacao_ajudantes_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('movimentacao_ajudantes', 'fk_mov_ajudantes_func', 'funcionario_id', 'funcionarios', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('movimentacao_ajudantes', 'fk_mov_ajudantes_mov', 'movimentacao_id', 'movimentacoes_veiculos', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('movimentacao_ajudantes', 'movimentacao_ajudantes_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('movimentacao_ajudantes', 'movimentacao_ajudantes_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('movimentacao_ajudantes', 'movimentacao_ajudantes_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('movimentacao_ajudantes', 'empresa_id', function (Blueprint $table) {
            return $table->unsignedInteger('empresa_id')->nullable(false)->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('movimentacao_ajudantes', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('movimentacao_ajudantes', 'usuario_id', function (Blueprint $table) {
