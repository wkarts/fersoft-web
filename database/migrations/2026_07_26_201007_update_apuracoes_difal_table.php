...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureTableCollation('apuracoes_difal', 'utf8mb4_0900_ai_ci');

        $this->applyColumnDefinition('apuracoes_difal', 'referencia', 'VARCHAR(7) NOT NULL');
        $this->applyColumnDefinition('apuracoes_difal', 'data_inicial', 'DATE NOT NULL');
        $this->applyColumnDefinition('apuracoes_difal', 'data_final', 'DATE NOT NULL');
        $this->applyColumnDefinition('apuracoes_difal', 'valor_total_difal', 'DECIMAL(15, 4) NOT NULL');
        $this->applyColumnDefinition('apuracoes_difal', 'status', 'ENUM(\'aberta\',\'fechada\') NULL DEFAULT \'aberta\'');
    }
