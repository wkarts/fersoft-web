...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/vendasEmCredito/filtro">
			...
			<br>
			<h4 class="@if(env('ANIMACAO')) animate__animated @endif animate__backInRight">Conta Crédito</h4>
							...
							<table class="datatable-table" style="max-width: 100%; overflow: scroll">
								...
								<tbody id="body" class="datatable-body">
									...
									<tr class="datatable-row">
										...
										<td class="datatable-cell"><span class="codigo" style="width: 100px;" id="valor">{{ number_format($v->venda->valor_total, $casasDecimais, ',', '.') }}</span>
										</td>
										<td class="datatable-cell">
