...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('produto_prateleiras')) {
            return;
        }

        $this->addForeignIfMissing('produto_prateleiras', 'produto_prateleiras_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
    }
