...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120021_create_produto_embalagens_table';
    private const TABLE_NAME = 'produto_embalagens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('produto_embalagens', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'produto_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'unidade', ['column_type' => 'varchar(10)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'fator_conversao', ['column_type' => 'decimal(10,3)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'codigo_barras', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'preco_venda', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_embalagens', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('produto_embalagens', 'PRIMARY', ['id'], true);
            $this->preflightIndex('produto_embalagens', 'idx_produto_embalagens_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('produto_embalagens', 'idx_produto_embalagens_filial_id', ['filial_id'], false);
            $this->preflightIndex('produto_embalagens', 'idx_produto_embalagens_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('produto_embalagens', 'produto_embalagens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('produto_embalagens', 'produto_embalagens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('produto_embalagens', 'produto_embalagens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('produto_embalagens')) {
                if (!$this->beginChange('table', 'produto_embalagens', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('produto_embalagens', function (Blueprint $table) {
                    ...
                    $table->string('unidade', 10)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->decimal('fator_conversao', 10, 3);
                    $table->string('codigo_barras', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->decimal('preco_venda', 10, 2)->nullable()->default('0.00');
                    $table->timestamps();

                    $table->index('empresa_id', 'idx_produto_embalagens_empresa_id');
                    $table->index('filial_id', 'idx_produto_embalagens_filial_id');
                    $table->index('usuario_id', 'idx_produto_embalagens_usuario_id');
                });
                $this->markCreated('table', 'produto_embalagens');
            }

            $this->ensureBaseTenantColumns('produto_embalagens');
            $this->ensureColumn('produto_embalagens', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('produto_embalagens', 'produto_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('produto_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('produto_embalagens', 'unidade', function (Blueprint $table) {
                return $table->string('unidade', 10)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('produto_embalagens', 'fator_conversao', function (Blueprint $table) {
                return $table->decimal('fator_conversao', 10, 3)->nullable(false)->default(null);
            }, ['column_type' => 'decimal(10,3)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('produto_embalagens', 'codigo_barras', function (Blueprint $table) {
                return $table->string('codigo_barras', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('produto_embalagens', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('produto_embalagens', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('produto_embalagens', 'preco_venda', function (Blueprint $table) {
                return $table->decimal('preco_venda', 10, 2)->nullable()->default('0.00');
            ...
            $this->addIndexIfMissing('produto_embalagens', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('produto_embalagens', 'idx_produto_embalagens_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('produto_embalagens', 'idx_produto_embalagens_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('produto_embalagens', 'idx_produto_embalagens_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('produto_embalagens', 'produto_embalagens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('produto_embalagens', 'produto_embalagens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('produto_embalagens', 'produto_embalagens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('produto_embalagens', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('produto_embalagens', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('produto_embalagens', 'usuario_id', function (Blueprint $table) {
