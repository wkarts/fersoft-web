...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120018_create_pessoas_pre_cadastro_table';
    private const TABLE_NAME = 'pessoas_pre_cadastro';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('pessoas_pre_cadastro', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'nome_completo', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'tipo_pessoa', ['column_type' => 'enum(\'Fisica\',\'Juridica\')', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'cpf_cnpj', ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'regime_tributario', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'simples_nacional', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'rg_ie', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'telefone', ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'email', ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'rua_coleta', ['column_type' => 'varchar(200)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'numero_coleta', ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'bairro_coleta', ['column_type' => 'varchar(100)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'cep_coleta', ['column_type' => 'varchar(15)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'cidade_coleta', ['column_type' => 'varchar(100)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'estado_coleta', ['column_type' => 'char(2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'endereco_cobranca', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'pessoa_contato', ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'responsavel_comercial', ['column_type' => 'varchar(150)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'origem_cadastro', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'banco', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'agencia', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'conta', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'digito', ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'tipo_conta', ['column_type' => 'enum(\'Corrente\',\'Poupanca\')', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'chave_pix', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'status', ['column_type' => 'enum(\'pendente\',\'aprovado\',\'convertido\')', 'nullable' => false, 'column_default' => 'pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'motivo_rejeicao', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'senha', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('pessoas_pre_cadastro', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('pessoas_pre_cadastro', 'PRIMARY', ['id'], true);
            $this->preflightIndex('pessoas_pre_cadastro', 'idx_status', ['status'], false);
            $this->preflightIndex('pessoas_pre_cadastro', 'idx_pessoas_pre_cadastro_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('pessoas_pre_cadastro', 'idx_pessoas_pre_cadastro_filial_id', ['filial_id'], false);
            $this->preflightIndex('pessoas_pre_cadastro', 'idx_pessoas_pre_cadastro_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('pessoas_pre_cadastro', 'pessoas_pre_cadastro_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('pessoas_pre_cadastro', 'pessoas_pre_cadastro_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('pessoas_pre_cadastro', 'pessoas_pre_cadastro_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('pessoas_pre_cadastro')) {
                if (!$this->beginChange('table', 'pessoas_pre_cadastro', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('pessoas_pre_cadastro', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->string('nome_completo', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('tipo_pessoa', ['Fisica', 'Juridica'])->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cpf_cnpj', 20)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('regime_tributario', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->tinyInteger('simples_nacional')->nullable()->default('0');
                    $table->string('rg_ie', 30)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('telefone', 20)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('email', 150)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('rua_coleta', 200)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('numero_coleta', 20)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('bairro_coleta', 100)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cep_coleta', 15)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cidade_coleta', 100)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->char('estado_coleta', 2)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('endereco_cobranca', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('pessoa_contato', 150)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('responsavel_comercial', 150)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('origem_cadastro', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('banco', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('agencia', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('conta', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('digito', 5)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('tipo_conta', ['Corrente', 'Poupanca'])->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('chave_pix', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('status', ['pendente', 'aprovado', 'convertido'])->default('pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('motivo_rejeicao')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('senha', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('status', 'idx_status');
                    $table->index('empresa_id', 'idx_pessoas_pre_cadastro_empresa_id');
                    $table->index('filial_id', 'idx_pessoas_pre_cadastro_filial_id');
                    $table->index('usuario_id', 'idx_pessoas_pre_cadastro_usuario_id');
                });
                $this->markCreated('table', 'pessoas_pre_cadastro');
            }

            $this->ensureBaseTenantColumns('pessoas_pre_cadastro');
            $this->ensureColumn('pessoas_pre_cadastro', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('pessoas_pre_cadastro', 'nome_completo', function (Blueprint $table) {
                return $table->string('nome_completo', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'tipo_pessoa', function (Blueprint $table) {
                return $table->enum('tipo_pessoa', ['Fisica', 'Juridica'])->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'Fisica\',\'Juridica\')', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'cpf_cnpj', function (Blueprint $table) {
                return $table->string('cpf_cnpj', 20)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'regime_tributario', function (Blueprint $table) {
                return $table->string('regime_tributario', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('pessoas_pre_cadastro', 'simples_nacional', function (Blueprint $table) {
                return $table->tinyInteger('simples_nacional')->nullable()->default('0');
            ...
            $this->ensureColumn('pessoas_pre_cadastro', 'rg_ie', function (Blueprint $table) {
                return $table->string('rg_ie', 30)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('pessoas_pre_cadastro', 'telefone', function (Blueprint $table) {
                return $table->string('telefone', 20)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'email', function (Blueprint $table) {
                return $table->string('email', 150)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'rua_coleta', function (Blueprint $table) {
                return $table->string('rua_coleta', 200)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(200)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'numero_coleta', function (Blueprint $table) {
                return $table->string('numero_coleta', 20)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'bairro_coleta', function (Blueprint $table) {
                return $table->string('bairro_coleta', 100)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('pessoas_pre_cadastro', 'cep_coleta', function (Blueprint $table) {
                return $table->string('cep_coleta', 15)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(15)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'cidade_coleta', function (Blueprint $table) {
                return $table->string('cidade_coleta', 100)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(100)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'estado_coleta', function (Blueprint $table) {
                return $table->char('estado_coleta', 2)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'char(2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'endereco_cobranca', function (Blueprint $table) {
                return $table->string('endereco_cobranca', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('pessoas_pre_cadastro', 'pessoa_contato', function (Blueprint $table) {
                return $table->string('pessoa_contato', 150)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'responsavel_comercial', function (Blueprint $table) {
                return $table->string('responsavel_comercial', 150)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(150)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'origem_cadastro', function (Blueprint $table) {
                return $table->string('origem_cadastro', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'banco', function (Blueprint $table) {
                return $table->string('banco', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'agencia', function (Blueprint $table) {
                return $table->string('agencia', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('pessoas_pre_cadastro', 'conta', function (Blueprint $table) {
                return $table->string('conta', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'digito', function (Blueprint $table) {
                return $table->string('digito', 5)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'tipo_conta', function (Blueprint $table) {
                return $table->enum('tipo_conta', ['Corrente', 'Poupanca'])->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'Corrente\',\'Poupanca\')', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'chave_pix', function (Blueprint $table) {
                return $table->string('chave_pix', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'status', function (Blueprint $table) {
                return $table->enum('status', ['pendente', 'aprovado', 'convertido'])->nullable(false)->default('pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'pendente\',\'aprovado\',\'convertido\')', 'nullable' => false, 'column_default' => 'pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'motivo_rejeicao', function (Blueprint $table) {
                return $table->text('motivo_rejeicao')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'senha', function (Blueprint $table) {
                return $table->string('senha', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('pessoas_pre_cadastro', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('pessoas_pre_cadastro', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('pessoas_pre_cadastro', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('pessoas_pre_cadastro', 'idx_status', ['status'], false);
            $this->addIndexIfMissing('pessoas_pre_cadastro', 'idx_pessoas_pre_cadastro_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('pessoas_pre_cadastro', 'idx_pessoas_pre_cadastro_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('pessoas_pre_cadastro', 'idx_pessoas_pre_cadastro_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('pessoas_pre_cadastro', 'pessoas_pre_cadastro_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('pessoas_pre_cadastro', 'pessoas_pre_cadastro_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('pessoas_pre_cadastro', 'pessoas_pre_cadastro_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('pessoas_pre_cadastro', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('pessoas_pre_cadastro', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('pessoas_pre_cadastro', 'usuario_id', function (Blueprint $table) {
