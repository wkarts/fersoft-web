...
{
    private const REFERENCE_COLUMNS = ['apuracao_difal_id' => ['apuracoes_difal', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120047_update_apuracao_difal_itens_table';
    private const TABLE_NAME = 'apuracao_difal_itens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('apuracao_difal_itens');
            $this->preflightColumn('apuracao_difal_itens', 'chave_acesso', ['column_type' => 'varchar(44)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('apuracao_difal_itens', 'valor_sem_icms_origem', ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('apuracao_difal_itens', 'icms_destino', ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('apuracao_difal_itens', 'icms_origem', ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('apuracao_difal_itens', 'nota_fiscal_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('apuracao_difal_itens', 'valor_operacao', ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('apuracao_difal_itens', 'base_calculo_dupla', ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('apuracao_difal_itens', 'valor_difal', ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('apuracao_difal_itens', 'chave_acesso', function (Blueprint $table) {
                return $table->string('chave_acesso', 44)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('apuracao_difal_itens', 'valor_sem_icms_origem', function (Blueprint $table) {
                return $table->decimal('valor_sem_icms_origem', 15, 2)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('apuracao_difal_itens', 'icms_destino', function (Blueprint $table) {
                return $table->decimal('icms_destino', 15, 2)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('apuracao_difal_itens', 'icms_origem', function (Blueprint $table) {
                return $table->decimal('icms_origem', 15, 2)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('apuracao_difal_itens', 'nota_fiscal_id', function (Blueprint $table) {
                return $table->integer('nota_fiscal_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('apuracao_difal_itens', 'valor_operacao', function (Blueprint $table) {
                return $table->decimal('valor_operacao', 15, 4)->nullable()->default(null);
            ...
            $this->ensureColumn('apuracao_difal_itens', 'base_calculo_dupla', function (Blueprint $table) {
                return $table->decimal('base_calculo_dupla', 15, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('apuracao_difal_itens', 'valor_difal', function (Blueprint $table) {
                return $table->decimal('valor_difal', 15, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        });
    }
