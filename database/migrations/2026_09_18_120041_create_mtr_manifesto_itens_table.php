...
{
    private const REFERENCE_COLUMNS = ['mtr_manifesto_id' => ['mtr_manifestos', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120041_create_mtr_manifesto_itens_table';
    private const TABLE_NAME = 'mtr_manifesto_itens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('mtr_manifesto_itens', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'mtr_manifesto_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'produto_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'cod_ibama', ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'descricao_residuo', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'quantidade', ['column_type' => 'decimal(15,4)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'unidade_medida', ['column_type' => 'varchar(10)', 'nullable' => false, 'column_default' => 'Kg', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'estado_fisico', ['column_type' => 'int', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'classe_residuo', ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'acondicionamento_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'tratamento_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifesto_itens', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('mtr_manifesto_itens', 'PRIMARY', ['id'], true);
            $this->preflightIndex('mtr_manifesto_itens', 'idx_mtr_itens_manifesto', ['mtr_manifesto_id'], false);
            $this->preflightIndex('mtr_manifesto_itens', 'idx_mtr_manifesto_itens_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('mtr_manifesto_itens', 'idx_mtr_manifesto_itens_filial_id', ['filial_id'], false);
            $this->preflightIndex('mtr_manifesto_itens', 'idx_mtr_manifesto_itens_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('mtr_manifesto_itens', 'fk_mtr_itens_manifesto', 'mtr_manifesto_id', 'mtr_manifestos', 'cascade', 'id', 'restrict');
            $this->preflightForeign('mtr_manifesto_itens', 'mtr_manifesto_itens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('mtr_manifesto_itens', 'mtr_manifesto_itens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('mtr_manifesto_itens', 'mtr_manifesto_itens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('mtr_manifesto_itens')) {
                if (!$this->beginChange('table', 'mtr_manifesto_itens', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('mtr_manifesto_itens', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->unsignedBigInteger('mtr_manifesto_id');
                    ...
                    $table->integer('estado_fisico')->nullable()->default('1');
                    ...
                    $table->index('mtr_manifesto_id', 'idx_mtr_itens_manifesto');
                    $table->index('empresa_id', 'idx_mtr_manifesto_itens_empresa_id');
                    $table->index('filial_id', 'idx_mtr_manifesto_itens_filial_id');
                    $table->index('usuario_id', 'idx_mtr_manifesto_itens_usuario_id');
                });
                $this->markCreated('table', 'mtr_manifesto_itens');
            }

            $this->ensureBaseTenantColumns('mtr_manifesto_itens');
            $this->ensureColumn('mtr_manifesto_itens', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'mtr_manifesto_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('mtr_manifesto_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'produto_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'cod_ibama', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'descricao_residuo', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'quantidade', function (Blueprint $table) {
                return $table->decimal('quantidade', 15, 4)->nullable(false)->default(null);
            }, ['column_type' => 'decimal(15,4)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_manifesto_itens', 'unidade_medida', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'estado_fisico', function (Blueprint $table) {
                return $table->integer('estado_fisico')->nullable()->default('1');
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_manifesto_itens', 'classe_residuo', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'acondicionamento_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'tratamento_id', function (Blueprint $table) {
                return $table->integer('tratamento_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_manifesto_itens', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifesto_itens', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('mtr_manifesto_itens', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('mtr_manifesto_itens', 'idx_mtr_itens_manifesto', ['mtr_manifesto_id'], false);
            $this->addIndexIfMissing('mtr_manifesto_itens', 'idx_mtr_manifesto_itens_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('mtr_manifesto_itens', 'idx_mtr_manifesto_itens_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('mtr_manifesto_itens', 'idx_mtr_manifesto_itens_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('mtr_manifesto_itens', 'fk_mtr_itens_manifesto', 'mtr_manifesto_id', 'mtr_manifestos', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_manifesto_itens', 'mtr_manifesto_itens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_manifesto_itens', 'mtr_manifesto_itens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_manifesto_itens', 'mtr_manifesto_itens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('mtr_manifesto_itens', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('mtr_manifesto_itens', 'filial_id', function (Blueprint $table) {
            return $table->unsignedInteger('filial_id')->nullable()->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('mtr_manifesto_itens', 'usuario_id', function (Blueprint $table) {
