...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120024_create_security_authorizer_tokens_table';
    private const TABLE_NAME = 'security_authorizer_tokens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('security_authorizer_tokens', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'security_authorizer_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'name', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => 'Token principal', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'token_hash', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'expires_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'last_used_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizer_tokens', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('security_authorizer_tokens', 'PRIMARY', ['id'], true);
            $this->preflightIndex('security_authorizer_tokens', 'security_authorizer_tokens_security_authorizer_id_index', ['security_authorizer_id'], false);
            $this->preflightIndex('security_authorizer_tokens', 'security_authorizer_tokens_enabled_index', ['enabled'], false);
            $this->preflightIndex('security_authorizer_tokens', 'idx_security_authorizer_tokens_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('security_authorizer_tokens', 'idx_security_authorizer_tokens_filial_id', ['filial_id'], false);
            $this->preflightIndex('security_authorizer_tokens', 'idx_security_authorizer_tokens_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('security_authorizer_tokens', 'security_authorizer_tokens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('security_authorizer_tokens', 'security_authorizer_tokens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('security_authorizer_tokens', 'security_authorizer_tokens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('security_authorizer_tokens')) {
                if (!$this->beginChange('table', 'security_authorizer_tokens', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('security_authorizer_tokens', function (Blueprint $table) {
                    ...
                    $table->string('name', 255)->default('Token principal')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    ...
                    $table->index('security_authorizer_id', 'security_authorizer_tokens_security_authorizer_id_index');
                    $table->index('enabled', 'security_authorizer_tokens_enabled_index');
                    $table->index('empresa_id', 'idx_security_authorizer_tokens_empresa_id');
                    $table->index('filial_id', 'idx_security_authorizer_tokens_filial_id');
                    $table->index('usuario_id', 'idx_security_authorizer_tokens_usuario_id');
                });
                $this->markCreated('table', 'security_authorizer_tokens');
            }

            $this->ensureBaseTenantColumns('security_authorizer_tokens');
            $this->ensureColumn('security_authorizer_tokens', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_authorizer_tokens', 'security_authorizer_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_authorizer_tokens', 'name', function (Blueprint $table) {
                return $table->string('name', 255)->nullable(false)->default('Token principal')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => 'Token principal', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_tokens', 'token_hash', function (Blueprint $table) {
                return $table->string('token_hash', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('security_authorizer_tokens', 'enabled', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_authorizer_tokens', 'expires_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_authorizer_tokens', 'last_used_at', function (Blueprint $table) {
                return $table->timestamp('last_used_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_tokens', 'created_at', function (Blueprint $table) {
                return $table->timestamp('created_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_tokens', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizer_tokens', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('security_authorizer_tokens', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('security_authorizer_tokens', 'security_authorizer_tokens_security_authorizer_id_index', ['security_authorizer_id'], false);
            $this->addIndexIfMissing('security_authorizer_tokens', 'security_authorizer_tokens_enabled_index', ['enabled'], false);
            $this->addIndexIfMissing('security_authorizer_tokens', 'idx_security_authorizer_tokens_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('security_authorizer_tokens', 'idx_security_authorizer_tokens_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('security_authorizer_tokens', 'idx_security_authorizer_tokens_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('security_authorizer_tokens', 'security_authorizer_tokens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('security_authorizer_tokens', 'security_authorizer_tokens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('security_authorizer_tokens', 'security_authorizer_tokens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('security_authorizer_tokens', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_authorizer_tokens', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_authorizer_tokens', 'usuario_id', function (Blueprint $table) {
