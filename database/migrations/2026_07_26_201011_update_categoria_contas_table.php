...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('categoria_contas', 'conta_contabil_despesa_id', 'INT UNSIGNED DEFAULT NULL', 'deleted_at', false);
        $this->applyColumnDefinition('categoria_contas', 'conta_contabil_provisao_id', 'INT UNSIGNED DEFAULT NULL', 'conta_contabil_despesa_id', false);
        $this->applyColumnDefinition('categoria_contas', 'ignora_terceiro', 'TINYINT(1) NOT NULL DEFAULT 0', 'conta_contabil_provisao_id', false);
        $this->applyColumnDefinition('categoria_contas', 'gera_provisao', 'TINYINT(1) NOT NULL DEFAULT 0', 'ignora_terceiro', false);
        $this->addForeignIfMissing('categoria_contas', 'categoria_contas_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
    }
