...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120004_create_contratos_engenharia_table';
    private const TABLE_NAME = 'contratos_engenharia';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('contratos_engenharia', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'cliente_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'vendedor_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'centro_custo_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'numero_contrato', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'contato_nome', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'contato_telefone', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'cep_obra', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'endereco_obra', ['column_type' => 'varchar(150)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'numero_obra', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'bairro_obra', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'cidade_obra_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'valor_contrato', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'valor_faturado', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'percentual_retencao', ['column_type' => 'decimal(5,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'data_inicio', ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'data_fim', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'arquivo_contrato', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'status', ['column_type' => 'varchar(30)', 'nullable' => false, 'column_default' => 'Ativo', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'observacoes', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contratos_engenharia', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('contratos_engenharia', 'PRIMARY', ['id'], true);
            $this->preflightIndex('contratos_engenharia', 'idx_contratos_engenharia_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('contratos_engenharia', 'idx_contratos_engenharia_filial_id', ['filial_id'], false);
            $this->preflightIndex('contratos_engenharia', 'idx_contratos_engenharia_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('contratos_engenharia', 'contratos_engenharia_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('contratos_engenharia', 'contratos_engenharia_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('contratos_engenharia', 'contratos_engenharia_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('contratos_engenharia')) {
                if (!$this->beginChange('table', 'contratos_engenharia', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('contratos_engenharia', function (Blueprint $table) {
                    ...
                    $table->string('numero_contrato', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('contato_nome', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('contato_telefone', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cep_obra', 10)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('endereco_obra', 150)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('numero_obra', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('bairro_obra', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->integer('cidade_obra_id')->nullable();
                    $table->decimal('valor_contrato', 15, 2);
                    $table->decimal('valor_faturado', 15, 2)->default('0.00');
                    $table->decimal('percentual_retencao', 5, 2)->default('0.00');
                    $table->date('data_inicio');
                    $table->date('data_fim')->nullable();
                    $table->string('arquivo_contrato', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('status', 30)->default('Ativo')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('observacoes')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('empresa_id', 'idx_contratos_engenharia_empresa_id');
                    $table->index('filial_id', 'idx_contratos_engenharia_filial_id');
                    $table->index('usuario_id', 'idx_contratos_engenharia_usuario_id');
                });
                $this->markCreated('table', 'contratos_engenharia');
            }

            $this->ensureBaseTenantColumns('contratos_engenharia');
            $this->ensureColumn('contratos_engenharia', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('contratos_engenharia', 'cliente_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('contratos_engenharia', 'vendedor_id', function (Blueprint $table) {
                return $table->integer('vendedor_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contratos_engenharia', 'centro_custo_id', function (Blueprint $table) {
                return $table->integer('centro_custo_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contratos_engenharia', 'numero_contrato', function (Blueprint $table) {
                return $table->string('numero_contrato', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('contratos_engenharia', 'contato_nome', function (Blueprint $table) {
                return $table->string('contato_nome', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('contratos_engenharia', 'contato_telefone', function (Blueprint $table) {
                return $table->string('contato_telefone', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('contratos_engenharia', 'cep_obra', function (Blueprint $table) {
                return $table->string('cep_obra', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('contratos_engenharia', 'endereco_obra', function (Blueprint $table) {
                return $table->string('endereco_obra', 150)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('contratos_engenharia', 'numero_obra', function (Blueprint $table) {
                return $table->string('numero_obra', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('contratos_engenharia', 'bairro_obra', function (Blueprint $table) {
                return $table->string('bairro_obra', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('contratos_engenharia', 'cidade_obra_id', function (Blueprint $table) {
                return $table->integer('cidade_obra_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contratos_engenharia', 'valor_contrato', function (Blueprint $table) {
                return $table->decimal('valor_contrato', 15, 2)->nullable(false)->default(null);
            ...
            $this->ensureColumn('contratos_engenharia', 'valor_faturado', function (Blueprint $table) {
                return $table->decimal('valor_faturado', 15, 2)->nullable(false)->default('0.00');
            ...
            $this->ensureColumn('contratos_engenharia', 'percentual_retencao', function (Blueprint $table) {
                return $table->decimal('percentual_retencao', 5, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(5,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contratos_engenharia', 'data_inicio', function (Blueprint $table) {
                return $table->date('data_inicio')->nullable(false)->default(null);
            ...
            $this->ensureColumn('contratos_engenharia', 'data_fim', function (Blueprint $table) {
                return $table->date('data_fim')->nullable()->default(null);
            }, ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contratos_engenharia', 'arquivo_contrato', function (Blueprint $table) {
                return $table->string('arquivo_contrato', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('contratos_engenharia', 'status', function (Blueprint $table) {
                return $table->string('status', 30)->nullable(false)->default('Ativo')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(30)', 'nullable' => false, 'column_default' => 'Ativo', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('contratos_engenharia', 'observacoes', function (Blueprint $table) {
                return $table->text('observacoes')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('contratos_engenharia', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('contratos_engenharia', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('contratos_engenharia', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('contratos_engenharia', 'idx_contratos_engenharia_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('contratos_engenharia', 'idx_contratos_engenharia_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('contratos_engenharia', 'idx_contratos_engenharia_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('contratos_engenharia', 'contratos_engenharia_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('contratos_engenharia', 'contratos_engenharia_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('contratos_engenharia', 'contratos_engenharia_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('contratos_engenharia', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('contratos_engenharia', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('contratos_engenharia', 'usuario_id', function (Blueprint $table) {
