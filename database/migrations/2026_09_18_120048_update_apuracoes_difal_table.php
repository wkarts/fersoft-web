...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120048_update_apuracoes_difal_table';
    private const TABLE_NAME = 'apuracoes_difal';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('apuracoes_difal');
            $this->preflightColumn('apuracoes_difal', 'valor_total_difal', ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('apuracoes_difal', 'status', ['column_type' => 'enum(\'aberta\',\'fechada\',\'cancelada\')', 'nullable' => true, 'column_default' => 'aberta', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('apuracoes_difal', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => ' on update CURRENT_TIMESTAMP', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('apuracoes_difal', 'uq_empresa_referencia', ['empresa_id', 'referencia'], true);

            $this->ensureColumn('apuracoes_difal', 'valor_total_difal', function (Blueprint $table) {
                return $table->decimal('valor_total_difal', 15, 4)->nullable()->default(null);
            ...
            $this->ensureColumn('apuracoes_difal', 'status', function (Blueprint $table) {
                return $table->enum('status', ['aberta', 'fechada', 'cancelada'])->nullable()->default('aberta')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'aberta\',\'fechada\',\'cancelada\')', 'nullable' => true, 'column_default' => 'aberta', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('apuracoes_difal', 'updated_at', function (Blueprint $table) {
            ...
            $this->addIndexIfMissing('apuracoes_difal', 'uq_empresa_referencia', ['empresa_id', 'referencia'], true);
        });
    }
