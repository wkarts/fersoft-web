									...
									<form action="/payment/paymentPix" method="post" id="paymentFormBoleto">
										...
										<div class="row">
											...
											<div class="form-group col-lg-3 col-md-8 col-12">
												...
												<div class="">
													<div class="input-group">
														<input type="text" class="form-control" required data-checkout="docNumber" name="docNumber" id="docNumber"/>
													</div>
												</div>
											</div>
										</div>
									...
									<form action="/payment/paymentCard" method="post" id="paymentForm">
										...
										<div class="row">
											...
											<div class="form-group col-lg-3 col-12">
												...
												<div class="">
													<div class="input-group">
														<input type="tel" class="form-control" data-checkout="docNumber" name="docNumber" id="docNumber2"/>
													</div>
												</div>
											</div>
										...
										<div class="row">
											...
											<div class="form-group col-lg-2 col-6">
												...
												<div class="row">
													<div class="col-6">
														<div class="input-group">
															<input placeholder="MM" type="tel" class="form-control" id="cardExpirationMonth" data-checkout="cardExpirationMonth"/>
														</div>
													</div>

													<div class="col-6">
														<div class="input-group">
															<input placeholder="AA" type="tel" class="form-control" id="cardExpirationYear" data-checkout="cardExpirationYear"/>
														</div>
													</div>
												</div>
											</div>
									...
									<form action="/payment/paymentBoleto" method="post" id="paymentFormBoleto">
										...
										<div class="row">
											...
											<div class="form-group col-lg-3 col-md-8 col-12">
												...
												<div class="">
													<div class="input-group">
														<input type="text" class="form-control" data-checkout="docNumber" name="docNumber" id="docNumber3"/>
													</div>
												</div>
											</div>
