...
{
    private const REFERENCE_COLUMNS = ['cidade_id' => ['cidades', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120107_update_fornecedors_table';
    private const TABLE_NAME = 'fornecedors';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('fornecedors');
            $this->preflightColumn('fornecedors', 'latitude', ['column_type' => 'decimal(10,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fornecedors', 'longitude', ['column_type' => 'decimal(11,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('fornecedors', 'latitude', function (Blueprint $table) {
                return $table->decimal('latitude', 10, 8)->nullable()->default(null);
            ...
            $this->ensureColumn('fornecedors', 'longitude', function (Blueprint $table) {
                return $table->decimal('longitude', 11, 8)->nullable()->default(null);
