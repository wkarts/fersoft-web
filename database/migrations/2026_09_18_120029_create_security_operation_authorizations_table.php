...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120029_create_security_operation_authorizations_table';
    private const TABLE_NAME = 'security_operation_authorizations';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('security_operation_authorizations', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'security_crud_resource_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'executor_user_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'authorizer_user_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'action', ['column_type' => 'varchar(40)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'record_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'authorization_token_hash', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'expires_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'used_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'ip_address', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'user_agent', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'metadata', ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_operation_authorizations', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('security_operation_authorizations', 'PRIMARY', ['id'], true);
            $this->preflightIndex('security_operation_authorizations', 'soa_resource_idx', ['security_crud_resource_id'], false);
            $this->preflightIndex('security_operation_authorizations', 'soa_executor_idx', ['executor_user_id'], false);
            $this->preflightIndex('security_operation_authorizations', 'soa_authorizer_idx', ['authorizer_user_id'], false);
            $this->preflightIndex('security_operation_authorizations', 'soa_action_idx', ['action'], false);
            $this->preflightIndex('security_operation_authorizations', 'soa_record_idx', ['record_id'], false);
            $this->preflightIndex('security_operation_authorizations', 'soa_expires_idx', ['expires_at'], false);
            $this->preflightIndex('security_operation_authorizations', 'soa_used_idx', ['used_at'], false);
            $this->preflightIndex('security_operation_authorizations', 'idx_security_operation_authorizations_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('security_operation_authorizations', 'idx_security_operation_authorizations_filial_id', ['filial_id'], false);
            $this->preflightIndex('security_operation_authorizations', 'idx_security_operation_authorizations_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('security_operation_authorizations', 'security_operation_authorizations_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('security_operation_authorizations', 'security_operation_authorizations_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('security_operation_authorizations', 'security_operation_authorizations_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('security_operation_authorizations')) {
                if (!$this->beginChange('table', 'security_operation_authorizations', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('security_operation_authorizations', function (Blueprint $table) {
                    ...
                    $table->string('authorization_token_hash', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamp('expires_at')->nullable();
                    $table->timestamp('used_at')->nullable();
                    $table->string('ip_address', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('user_agent')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    ...
                    $table->index('empresa_id', 'idx_security_operation_authorizations_empresa_id');
                    $table->index('filial_id', 'idx_security_operation_authorizations_filial_id');
                    $table->index('usuario_id', 'idx_security_operation_authorizations_usuario_id');
                });
                $this->markCreated('table', 'security_operation_authorizations');
            }

            $this->ensureBaseTenantColumns('security_operation_authorizations');
            $this->ensureColumn('security_operation_authorizations', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_operation_authorizations', 'security_crud_resource_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('security_crud_resource_id')->nullable()->default(null);
            ...
            $this->ensureColumn('security_operation_authorizations', 'executor_user_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('executor_user_id')->nullable()->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_operation_authorizations', 'authorizer_user_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('authorizer_user_id')->nullable()->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_operation_authorizations', 'action', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_operation_authorizations', 'record_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('record_id')->nullable()->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_operation_authorizations', 'authorization_token_hash', function (Blueprint $table) {
                return $table->string('authorization_token_hash', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('security_operation_authorizations', 'expires_at', function (Blueprint $table) {
                return $table->timestamp('expires_at')->nullable()->default(null);
            ...
            $this->ensureColumn('security_operation_authorizations', 'used_at', function (Blueprint $table) {
                return $table->timestamp('used_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_operation_authorizations', 'ip_address', function (Blueprint $table) {
                return $table->string('ip_address', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_operation_authorizations', 'user_agent', function (Blueprint $table) {
                return $table->text('user_agent')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('security_operation_authorizations', 'metadata', function (Blueprint $table) {
                return $table->json('metadata')->nullable()->default(null);
            }, ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_operation_authorizations', 'created_at', function (Blueprint $table) {
                return $table->timestamp('created_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_operation_authorizations', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_operation_authorizations', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('security_operation_authorizations', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('security_operation_authorizations', 'soa_resource_idx', ['security_crud_resource_id'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'soa_executor_idx', ['executor_user_id'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'soa_authorizer_idx', ['authorizer_user_id'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'soa_action_idx', ['action'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'soa_record_idx', ['record_id'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'soa_expires_idx', ['expires_at'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'soa_used_idx', ['used_at'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'idx_security_operation_authorizations_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'idx_security_operation_authorizations_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('security_operation_authorizations', 'idx_security_operation_authorizations_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('security_operation_authorizations', 'security_operation_authorizations_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('security_operation_authorizations', 'security_operation_authorizations_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('security_operation_authorizations', 'security_operation_authorizations_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('security_operation_authorizations', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_operation_authorizations', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_operation_authorizations', 'usuario_id', function (Blueprint $table) {
