...
<div class="card card-custom gutter-b">
	<div class="card-body">
		<div class="" id="kt_user_profile_aside">
			...
			<label class="ml-3">Registros: <strong class="text-success">{{sizeof($codigos)}}</strong></label>
									...
									<table class="datatable-table" style="max-width: 100%; overflow: scroll">
										<thead class="datatable-head">
											<tr class="datatable-row" style="left: 0px;">
												...
												<th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Expiração</span></th>
											...
											<tr class="datatable-row">
												...
												<td class="datatable-cell">
													<span class="codigo" style="width: 250px;">
														...
														<a class="btn btn-sm btn-warning" href="/codigoDesconto/edit/{{ $c->id }}">
														...
														<a title="enviar SMS" class="btn btn-sm btn-dark" href="/codigoDesconto/sms/{{$c->id}}">
															<i class="la la-sms"></i>
														</a>

														<a title="Desativar Cupom" class="btn btn-sm btn-warning" href="/codigoDesconto/alterarStatus/{{$c->id}}">
															<i class="la la-times"></i>
														</a>
														@else

														<a title="Ativar Cupom" class="btn btn-sm btn-success" href="/codigoDesconto/alterarStatus/{{$c->id}}">
