...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120017_create_os_checklists_table';
    private const TABLE_NAME = 'os_checklists';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('os_checklists', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'ordem_servico_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'item_avaliado', ['column_type' => 'varchar(100)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'situacao', ['column_type' => 'enum(\'ok\',\'atencao\',\'critico\')', 'nullable' => true, 'column_default' => 'ok', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'executado', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'observacao', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('os_checklists', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('os_checklists', 'PRIMARY', ['id'], true);
            $this->preflightIndex('os_checklists', 'idx_os_checklist_os', ['ordem_servico_id'], false);
            $this->preflightIndex('os_checklists', 'idx_os_checklists_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('os_checklists', 'idx_os_checklists_filial_id', ['filial_id'], false);
            $this->preflightIndex('os_checklists', 'idx_os_checklists_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('os_checklists', 'os_checklists_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('os_checklists', 'os_checklists_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('os_checklists', 'os_checklists_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('os_checklists')) {
                if (!$this->beginChange('table', 'os_checklists', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('os_checklists', function (Blueprint $table) {
                    ...
                    $table->string('item_avaliado', 100)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('situacao', ['ok', 'atencao', 'critico'])->nullable()->default('ok')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->tinyInteger('executado')->nullable()->default('0');
                    $table->string('observacao', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('ordem_servico_id', 'idx_os_checklist_os');
                    $table->index('empresa_id', 'idx_os_checklists_empresa_id');
                    $table->index('filial_id', 'idx_os_checklists_filial_id');
                    $table->index('usuario_id', 'idx_os_checklists_usuario_id');
                });
                $this->markCreated('table', 'os_checklists');
            }

            $this->ensureBaseTenantColumns('os_checklists');
            $this->ensureColumn('os_checklists', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('os_checklists', 'ordem_servico_id', function (Blueprint $table) {
                return $table->integer('ordem_servico_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('os_checklists', 'item_avaliado', function (Blueprint $table) {
                return $table->string('item_avaliado', 100)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('os_checklists', 'situacao', function (Blueprint $table) {
                return $table->enum('situacao', ['ok', 'atencao', 'critico'])->nullable()->default('ok')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'ok\',\'atencao\',\'critico\')', 'nullable' => true, 'column_default' => 'ok', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('os_checklists', 'executado', function (Blueprint $table) {
                return $table->tinyInteger('executado')->nullable()->default('0');
            ...
            $this->ensureColumn('os_checklists', 'observacao', function (Blueprint $table) {
            ...
            $this->ensureColumn('os_checklists', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('os_checklists', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('os_checklists', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('os_checklists', 'idx_os_checklist_os', ['ordem_servico_id'], false);
            $this->addIndexIfMissing('os_checklists', 'idx_os_checklists_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('os_checklists', 'idx_os_checklists_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('os_checklists', 'idx_os_checklists_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('os_checklists', 'os_checklists_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('os_checklists', 'os_checklists_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('os_checklists', 'os_checklists_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('os_checklists', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('os_checklists', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('os_checklists', 'usuario_id', function (Blueprint $table) {
