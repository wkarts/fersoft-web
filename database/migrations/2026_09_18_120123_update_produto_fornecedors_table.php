...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120123_update_produto_fornecedors_table';
    private const TABLE_NAME = 'produto_fornecedors';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('produto_fornecedors');
            $this->preflightColumn('produto_fornecedors', 'produto_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_fornecedors', 'fornecedor_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produto_fornecedors', 'codigo_fornecedor', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('produto_fornecedors', 'produto_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('produto_fornecedors', 'fornecedor_id', function (Blueprint $table) {
                return $table->unsignedInteger('fornecedor_id')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('produto_fornecedors', 'codigo_fornecedor', function (Blueprint $table) {
                return $table->string('codigo_fornecedor', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
