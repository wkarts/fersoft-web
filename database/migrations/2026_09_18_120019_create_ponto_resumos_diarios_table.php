...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120019_create_ponto_resumos_diarios_table';
    private const TABLE_NAME = 'ponto_resumos_diarios';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('ponto_resumos_diarios', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'funcionario_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'data', ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'horas_previstas', ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '08:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'horas_trabalhadas', ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '00:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'horas_extras', ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '00:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'horas_atraso', ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '00:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'horas_banco', ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '00:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'status', ['column_type' => 'enum(\'normal\',\'incompleto\',\'falta\',\'folga\',\'feriado\')', 'nullable' => true, 'column_default' => 'normal', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'observacoes', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ponto_resumos_diarios', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('ponto_resumos_diarios', 'PRIMARY', ['id'], true);
            $this->preflightIndex('ponto_resumos_diarios', 'uq_func_data', ['funcionario_id', 'data'], true);
            $this->preflightIndex('ponto_resumos_diarios', 'idx_data', ['data'], false);
            $this->preflightIndex('ponto_resumos_diarios', 'idx_ponto_resumos_diarios_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('ponto_resumos_diarios', 'idx_ponto_resumos_diarios_filial_id', ['filial_id'], false);
            $this->preflightIndex('ponto_resumos_diarios', 'idx_ponto_resumos_diarios_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('ponto_resumos_diarios', 'ponto_resumos_diarios_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('ponto_resumos_diarios', 'ponto_resumos_diarios_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('ponto_resumos_diarios', 'ponto_resumos_diarios_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('ponto_resumos_diarios')) {
                if (!$this->beginChange('table', 'ponto_resumos_diarios', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('ponto_resumos_diarios', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->date('data');
                    $table->string('horas_previstas', 5)->nullable()->default('08:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('horas_trabalhadas', 5)->nullable()->default('00:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('horas_extras', 5)->nullable()->default('00:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('horas_atraso', 5)->nullable()->default('00:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('horas_banco', 5)->nullable()->default('00:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('status', ['normal', 'incompleto', 'falta', 'folga', 'feriado'])->nullable()->default('normal')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('observacoes')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->unique(['funcionario_id', 'data'], 'uq_func_data');
                    $table->index('data', 'idx_data');
                    $table->index('empresa_id', 'idx_ponto_resumos_diarios_empresa_id');
                    $table->index('filial_id', 'idx_ponto_resumos_diarios_filial_id');
                    $table->index('usuario_id', 'idx_ponto_resumos_diarios_usuario_id');
                });
                $this->markCreated('table', 'ponto_resumos_diarios');
            }

            $this->ensureBaseTenantColumns('ponto_resumos_diarios');
            $this->ensureColumn('ponto_resumos_diarios', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('ponto_resumos_diarios', 'funcionario_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('funcionario_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('ponto_resumos_diarios', 'data', function (Blueprint $table) {
                return $table->date('data')->nullable(false)->default(null);
            ...
            $this->ensureColumn('ponto_resumos_diarios', 'horas_previstas', function (Blueprint $table) {
                return $table->string('horas_previstas', 5)->nullable()->default('08:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '08:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ponto_resumos_diarios', 'horas_trabalhadas', function (Blueprint $table) {
                return $table->string('horas_trabalhadas', 5)->nullable()->default('00:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '00:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ponto_resumos_diarios', 'horas_extras', function (Blueprint $table) {
                return $table->string('horas_extras', 5)->nullable()->default('00:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '00:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ponto_resumos_diarios', 'horas_atraso', function (Blueprint $table) {
                return $table->string('horas_atraso', 5)->nullable()->default('00:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '00:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ponto_resumos_diarios', 'horas_banco', function (Blueprint $table) {
                return $table->string('horas_banco', 5)->nullable()->default('00:00')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => '00:00', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ponto_resumos_diarios', 'status', function (Blueprint $table) {
                return $table->enum('status', ['normal', 'incompleto', 'falta', 'folga', 'feriado'])->nullable()->default('normal')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'normal\',\'incompleto\',\'falta\',\'folga\',\'feriado\')', 'nullable' => true, 'column_default' => 'normal', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ponto_resumos_diarios', 'observacoes', function (Blueprint $table) {
            ...
            $this->ensureColumn('ponto_resumos_diarios', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('ponto_resumos_diarios', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('ponto_resumos_diarios', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('ponto_resumos_diarios', 'uq_func_data', ['funcionario_id', 'data'], true);
            $this->addIndexIfMissing('ponto_resumos_diarios', 'idx_data', ['data'], false);
            $this->addIndexIfMissing('ponto_resumos_diarios', 'idx_ponto_resumos_diarios_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('ponto_resumos_diarios', 'idx_ponto_resumos_diarios_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('ponto_resumos_diarios', 'idx_ponto_resumos_diarios_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('ponto_resumos_diarios', 'ponto_resumos_diarios_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('ponto_resumos_diarios', 'ponto_resumos_diarios_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('ponto_resumos_diarios', 'ponto_resumos_diarios_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('ponto_resumos_diarios', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('ponto_resumos_diarios', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('ponto_resumos_diarios', 'usuario_id', function (Blueprint $table) {
