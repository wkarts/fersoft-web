...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('manifesta_nfse_tomadas', 'numero_nota', 'VARCHAR(15) NOT NULL');
        $this->applyColumnDefinition('manifesta_nfse_tomadas', 'data_emissao', 'DATETIME NOT NULL');
        $this->applyColumnDefinition('manifesta_nfse_tomadas', 'prestador_nome', 'VARCHAR(255) NOT NULL');
        $this->applyColumnDefinition('manifesta_nfse_tomadas', 'prestador_cnpj_cpf', 'VARCHAR(18) NOT NULL');
        $this->applyColumnDefinition('manifesta_nfse_tomadas', 'valor_servico', 'DECIMAL(15, 2) NOT NULL');
        $this->applyColumnDefinition('manifesta_nfse_tomadas', 'valor_liquido', 'DECIMAL(15, 2) NOT NULL');
    }
