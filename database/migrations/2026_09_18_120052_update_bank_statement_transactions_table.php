...
{
    private const REFERENCE_COLUMNS = ['empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'cascade', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120052_update_bank_statement_transactions_table';
    private const TABLE_NAME = 'bank_statement_transactions';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('bank_statement_transactions');
            $this->preflightColumn('bank_statement_transactions', 'movimentacao_financeira_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('bank_statement_transactions', 'numero_documento', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('bank_statement_transactions', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('bank_statement_transactions', 'conta_bancaria_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('bank_statement_transactions', 'tipo', ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('bank_statement_transactions', 'import_hash', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('bank_statement_transactions', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => ' on update CURRENT_TIMESTAMP', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('bank_statement_transactions', 'unique_import_hash', ['empresa_id', 'import_hash'], true);
            $this->preflightIndex('bank_statement_transactions', 'idx_tenant', ['empresa_id', 'filial_id'], false);
            $this->preflightIndex('bank_statement_transactions', 'idx_status', ['empresa_id', 'status'], false);

            $this->ensureColumn('bank_statement_transactions', 'movimentacao_financeira_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('movimentacao_financeira_id')->nullable()->default(null);
            ...
            $this->ensureColumn('bank_statement_transactions', 'numero_documento', function (Blueprint $table) {
                return $table->string('numero_documento', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('bank_statement_transactions', 'deleted_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('bank_statement_transactions', 'conta_bancaria_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('conta_bancaria_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('bank_statement_transactions', 'tipo', function (Blueprint $table) {
                return $table->string('tipo', 20)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('bank_statement_transactions', 'import_hash', function (Blueprint $table) {
                return $table->string('import_hash', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('bank_statement_transactions', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null)->useCurrentOnUpdate();
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => ' on update CURRENT_TIMESTAMP', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('bank_statement_transactions', 'unique_import_hash', ['empresa_id', 'import_hash'], true);
            $this->addIndexIfMissing('bank_statement_transactions', 'idx_tenant', ['empresa_id', 'filial_id'], false);
            $this->addIndexIfMissing('bank_statement_transactions', 'idx_status', ['empresa_id', 'status'], false);
        });
    }
