...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applySafeColumnUpgrade([
            'table' => 'tarefas',
            'column' => 'aviso_supervisor_enviado',
            'type' => 'TINYINT(1)',
            'nullable' => true,
        ...
        $this->applySafeColumnUpgrade([
            ...
            'comment' => 'pendente, em_andamento, concluida',
            'auto_increment' => false,
            'on_update' => null,
            'source_line' => 2608,
        ]);
