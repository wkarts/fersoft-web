...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('configuracoes_contabeis')) {
            Schema::create('configuracoes_contabeis', function (Blueprint $table) {
                $table->unsignedBigInteger('id')->autoIncrement();
                $table->unsignedInteger('empresa_id');
                $table->unsignedInteger('filial_id')->nullable();
                $table->unsignedInteger('usuario_id')->nullable();
                $table->unsignedInteger('conta_irrf_recolher')->nullable();
                $table->unsignedInteger('conta_iss_recolher')->nullable();
                $table->unsignedInteger('conta_pis_recolher')->nullable();
                $table->unsignedInteger('conta_cofins_recolher')->nullable();
                $table->unsignedInteger('conta_csll_recolher')->nullable();
                $table->unsignedInteger('conta_inss_recolher')->nullable();
                $table->unsignedInteger('conta_juros_pagos')->nullable();
                $table->unsignedInteger('conta_multas_pagas')->nullable();
                $table->unsignedInteger('conta_descontos_obtidos')->nullable();
                $table->unsignedInteger('conta_juros_recebidos')->nullable();
                $table->unsignedInteger('conta_multas_recebidas')->nullable();
                $table->unsignedInteger('conta_descontos_concedidos')->nullable();
                $table->unsignedInteger('conta_cliente_padrao')->nullable();
                $table->unsignedInteger('conta_fornecedor_padrao')->nullable();
                $table->string('codigo_prosoft', 4)->nullable();
                $table->unsignedInteger('conta_estoque')->nullable();
                $table->timestamps();

                $table->index('empresa_id', 'idx_configuracoes_contabeis_empresa_id');
                $table->index('filial_id', 'idx_configuracoes_contabeis_filial_id');
                $table->index('usuario_id', 'idx_configuracoes_contabeis_usuario_id');
                $table->index('codigo_prosoft', 'idx_configuracoes_contabeis_codigo_prosoft');
            });
        } else {
            $this->ensureBaseTenantColumns('configuracoes_contabeis');
        }

        $this->addForeignIfMissing('configuracoes_contabeis', 'configuracoes_contabeis_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade');
        $this->addForeignIfMissing('configuracoes_contabeis', 'configuracoes_contabeis_filial_id_foreign', 'filial_id', 'filials', 'set null');
        $this->addForeignIfMissing('configuracoes_contabeis', 'configuracoes_contabeis_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null');
    }

    public function down()
    {
        if (!Schema::hasTable('configuracoes_contabeis')) { return; }
        $this->dropForeignIfExists('configuracoes_contabeis', 'configuracoes_contabeis_usuario_id_foreign');
        $this->dropForeignIfExists('configuracoes_contabeis', 'configuracoes_contabeis_filial_id_foreign');
        $this->dropForeignIfExists('configuracoes_contabeis', 'configuracoes_contabeis_empresa_id_foreign');
        Schema::dropIfExists('configuracoes_contabeis');
    }
