...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120037_create_contrato_eng_itens_table';
    private const TABLE_NAME = 'contrato_eng_itens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('contrato_eng_itens', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'contrato_eng_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'tipo_item', ['column_type' => 'enum(\'Servico\',\'Locacao\')', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'servico_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'produto_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'quantidade_prevista', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'valor_unitario', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'valor_total', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_itens', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('contrato_eng_itens', 'PRIMARY', ['id'], true);
            $this->preflightIndex('contrato_eng_itens', 'contrato_eng_itens_contrato_eng_id_foreign', ['contrato_eng_id'], false);
            $this->preflightIndex('contrato_eng_itens', 'idx_contrato_eng_itens_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('contrato_eng_itens', 'idx_contrato_eng_itens_filial_id', ['filial_id'], false);
            $this->preflightIndex('contrato_eng_itens', 'idx_contrato_eng_itens_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('contrato_eng_itens', 'contrato_eng_itens_contrato_eng_id_foreign', 'contrato_eng_id', 'contratos_engenharia', 'cascade', 'id', 'restrict');
            $this->preflightForeign('contrato_eng_itens', 'contrato_eng_itens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('contrato_eng_itens', 'contrato_eng_itens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('contrato_eng_itens', 'contrato_eng_itens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('contrato_eng_itens')) {
                if (!$this->beginChange('table', 'contrato_eng_itens', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('contrato_eng_itens', function (Blueprint $table) {
                    ...
                    $table->enum('tipo_item', ['Servico', 'Locacao'])->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    ...
                    $table->index('contrato_eng_id', 'contrato_eng_itens_contrato_eng_id_foreign');
                    $table->index('empresa_id', 'idx_contrato_eng_itens_empresa_id');
                    $table->index('filial_id', 'idx_contrato_eng_itens_filial_id');
                    $table->index('usuario_id', 'idx_contrato_eng_itens_usuario_id');
                });
                $this->markCreated('table', 'contrato_eng_itens');
            }

            $this->ensureBaseTenantColumns('contrato_eng_itens');
            $this->ensureColumn('contrato_eng_itens', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('contrato_eng_itens', 'contrato_eng_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('contrato_eng_itens', 'tipo_item', function (Blueprint $table) {
                return $table->enum('tipo_item', ['Servico', 'Locacao'])->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'Servico\',\'Locacao\')', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('contrato_eng_itens', 'servico_id', function (Blueprint $table) {
                return $table->integer('servico_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contrato_eng_itens', 'produto_id', function (Blueprint $table) {
                return $table->integer('produto_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contrato_eng_itens', 'quantidade_prevista', function (Blueprint $table) {
                return $table->decimal('quantidade_prevista', 10, 2)->nullable(false)->default(null);
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contrato_eng_itens', 'valor_unitario', function (Blueprint $table) {
                return $table->decimal('valor_unitario', 15, 2)->nullable(false)->default(null);
            ...
            $this->ensureColumn('contrato_eng_itens', 'valor_total', function (Blueprint $table) {
                return $table->decimal('valor_total', 15, 2)->nullable(false)->default(null);
            }, ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contrato_eng_itens', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('contrato_eng_itens', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('contrato_eng_itens', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('contrato_eng_itens', 'contrato_eng_itens_contrato_eng_id_foreign', ['contrato_eng_id'], false);
            $this->addIndexIfMissing('contrato_eng_itens', 'idx_contrato_eng_itens_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('contrato_eng_itens', 'idx_contrato_eng_itens_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('contrato_eng_itens', 'idx_contrato_eng_itens_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('contrato_eng_itens', 'contrato_eng_itens_contrato_eng_id_foreign', 'contrato_eng_id', 'contratos_engenharia', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('contrato_eng_itens', 'contrato_eng_itens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('contrato_eng_itens', 'contrato_eng_itens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('contrato_eng_itens', 'contrato_eng_itens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('contrato_eng_itens', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('contrato_eng_itens', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('contrato_eng_itens', 'usuario_id', function (Blueprint $table) {
