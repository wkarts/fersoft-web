...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('tipos_movimentacoes')) {
            return;
        }

        $this->addForeignIfMissing('tipos_movimentacoes', 'tipos_movimentacoes_filial_id_foreign', 'filial_id', 'filials', 'id', 'set null', null);
    }
