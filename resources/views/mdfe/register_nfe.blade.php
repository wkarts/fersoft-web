	...
	<div class="card-body @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
		<div class="content d-flex flex-column flex-column-fluid" id="kt_content" >
			...
			<div class="col-lg-12" id="content">
				...
				<h1 class="text-success">EMISSÃO DE MDFe IMPORTAÇÃO DE XML</h1>
				...
				<div class="row">
						...
						<div class="">
							<div class="input-group date">
								<select class="custom-select form-control" id="uf_inicio" name="uf_inicio">
									...
									<option value="{{$u}}" @if($docs['ufInicio'] == $u) selected @endif>{{$u}}</option>
									@endforeach
								</select>
							</div>
						</div>
						...
						<div class="">
							<div class="input-group date">
								<select class="custom-select form-control" id="uf_fim" name="uf_fim">
									@foreach($ufs as $key => $u)
									<option value="{{$u}}" @if($docs['ufFim'] == $u) selected @endif>{{$u}}</option>
									@endforeach
								</select>
							</div>
						</div>
					...
					<div class="form-group col-lg-2 col-sm-6 col-6">
						...
						<div class="">
							<div class="input-group date">
								<input type="text" name="data_inicio_viagem" class="form-control" value="{{ date('d/m/Y') }}" id="kt_datepicker_3" />
					...
					<div class="form-group col-sm-2 col-12">
						...
						<div class="">
							<div class="input-group">
								<input type="text" name="valor_transporte" class="form-control type-ref" value="00" id="lacre_rodo"/>
							</div>
						</div>
					</div>
						...
						<div class="">
							<div class="input-group date">
								<select class="custom-select form-control" id="tpDoc" name="tpDoc">
									<option @if(strlen($docs['cnpjContratante']) == 14) selected @endif value="CNPJ">CNPJ</option>
									<option @if(strlen($docs['cnpjContratante']) == 11) selected @endif value="CPF">CPF</option>
					...
					<div class="form-group col-lg-2 col-12">
						...
						<div class="">
							<div class="input-group">
								<input type="text" name="cnpj_contratante" class="form-control type-ref" value="{{ $docs['cnpjContratante'] }}" id="cnpj_contratante"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group col-lg-2 col-12">
						...
						<div class="">
							<div class="input-group">
								<input type="text" name="quantidade_carga" class="form-control type-ref" value="{{ $docs['qtdCarga'] }}" id="quantidade_carga"/>
							</div>
						</div>
					</div>
								...
								<div class="">
									<div class="input-group date">
										<select class="custom-select form-control" id="veiculo_tracao" name="veiculo_tracao">
											...
											<option value="{{$v}}" @if($docs['veiculoTracao'] != null) @if($v->id == $docs['veiculoTracao']->id) selected @endif @endif>{{$v->marca}} {{$v->modelo}} - {{$v->placa}}</option>
											@endforeach
										</select>
									</div>
								</div>
																		...
																		<div class="row">
																			<div class="col-xl-12">
																				<div class="row align-items-center">
																					...
																					<div class="form-group col-lg-3 col-md-4 col-xl-4 col-12">
																						<label class="col-form-label">Nome</label>
																						<div class="">
																							<div class="input-group">
																					...
																					<div class="form-group col-lg-2 col-md-3 col-xl-3 col-12">
