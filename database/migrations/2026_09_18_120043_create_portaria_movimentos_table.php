...
{
    private const REFERENCE_COLUMNS = ['agendamento_id' => ['portaria_agendamentos', 'id', 'set null', 'restrict'], 'visitante_id' => ['visitantes', 'id', 'restrict', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120043_create_portaria_movimentos_table';
    private const TABLE_NAME = 'portaria_movimentos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('portaria_movimentos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'visitante_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'funcionario_visitado_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'agendamento_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'usuario_porteiro_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'placa_veiculo', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'data_hora_entrada', ['column_type' => 'datetime', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'data_hora_saida', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'observacoes', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'termo_lgpd_epi', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('portaria_movimentos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('portaria_movimentos', 'PRIMARY', ['id'], true);
            $this->preflightIndex('portaria_movimentos', 'fk_mov_visitante', ['visitante_id'], false);
            $this->preflightIndex('portaria_movimentos', 'fk_mov_agendamento', ['agendamento_id'], false);
            $this->preflightIndex('portaria_movimentos', 'idx_portaria_movimentos_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('portaria_movimentos', 'idx_portaria_movimentos_filial_id', ['filial_id'], false);
            $this->preflightIndex('portaria_movimentos', 'idx_portaria_movimentos_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('portaria_movimentos', 'fk_mov_agendamento', 'agendamento_id', 'portaria_agendamentos', 'set null', 'id', 'restrict');
            $this->preflightForeign('portaria_movimentos', 'fk_mov_visitante', 'visitante_id', 'visitantes', 'restrict', 'id', 'restrict');
            $this->preflightForeign('portaria_movimentos', 'portaria_movimentos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('portaria_movimentos', 'portaria_movimentos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('portaria_movimentos', 'portaria_movimentos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('portaria_movimentos')) {
                if (!$this->beginChange('table', 'portaria_movimentos', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('portaria_movimentos', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->unsignedBigInteger('funcionario_visitado_id');
                    $table->unsignedBigInteger('agendamento_id')->nullable();
                    $table->unsignedBigInteger('usuario_porteiro_id');
                    $table->string('placa_veiculo', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    ...
                    $table->tinyInteger('termo_lgpd_epi')->nullable()->default('0');
                    $table->timestamps();

                    $table->index('visitante_id', 'fk_mov_visitante');
                    $table->index('agendamento_id', 'fk_mov_agendamento');
                    $table->index('empresa_id', 'idx_portaria_movimentos_empresa_id');
                    $table->index('filial_id', 'idx_portaria_movimentos_filial_id');
                    $table->index('usuario_id', 'idx_portaria_movimentos_usuario_id');
                });
                $this->markCreated('table', 'portaria_movimentos');
            }

            $this->ensureBaseTenantColumns('portaria_movimentos');
            $this->ensureColumn('portaria_movimentos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_movimentos', 'visitante_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('visitante_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('portaria_movimentos', 'funcionario_visitado_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('funcionario_visitado_id')->nullable(false)->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('portaria_movimentos', 'agendamento_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('agendamento_id')->nullable()->default(null);
            ...
            $this->ensureColumn('portaria_movimentos', 'usuario_porteiro_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('usuario_porteiro_id')->nullable(false)->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('portaria_movimentos', 'placa_veiculo', function (Blueprint $table) {
                return $table->string('placa_veiculo', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('portaria_movimentos', 'data_hora_entrada', function (Blueprint $table) {
                return $table->dateTime('data_hora_entrada')->nullable(false)->default(null);
            ...
            $this->ensureColumn('portaria_movimentos', 'data_hora_saida', function (Blueprint $table) {
                return $table->dateTime('data_hora_saida')->nullable()->default(null);
            ...
            $this->ensureColumn('portaria_movimentos', 'observacoes', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_movimentos', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('portaria_movimentos', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('portaria_movimentos', 'termo_lgpd_epi', function (Blueprint $table) {
                return $table->tinyInteger('termo_lgpd_epi')->nullable()->default('0');
            ...
            $this->addIndexIfMissing('portaria_movimentos', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('portaria_movimentos', 'fk_mov_visitante', ['visitante_id'], false);
            $this->addIndexIfMissing('portaria_movimentos', 'fk_mov_agendamento', ['agendamento_id'], false);
            $this->addIndexIfMissing('portaria_movimentos', 'idx_portaria_movimentos_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('portaria_movimentos', 'idx_portaria_movimentos_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('portaria_movimentos', 'idx_portaria_movimentos_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('portaria_movimentos', 'fk_mov_agendamento', 'agendamento_id', 'portaria_agendamentos', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_movimentos', 'fk_mov_visitante', 'visitante_id', 'visitantes', 'restrict', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_movimentos', 'portaria_movimentos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_movimentos', 'portaria_movimentos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('portaria_movimentos', 'portaria_movimentos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('portaria_movimentos', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('portaria_movimentos', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('portaria_movimentos', 'usuario_id', function (Blueprint $table) {
