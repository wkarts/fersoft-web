...
{
    private const REFERENCE_COLUMNS = ['empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120126_update_sped_configs_table';
    private const TABLE_NAME = 'sped_configs';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('sped_configs');
            $this->preflightColumn('sped_configs', 'perfil', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'B', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('sped_configs', 'ind_ativ', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightForeign('sped_configs', 'sped_configs_filial_id_foreign', 'filial_id', 'filials', 'cascade', 'id', 'restrict');

            $this->ensureColumn('sped_configs', 'perfil', function (Blueprint $table) {
                return $table->string('perfil', 20)->nullable()->default('B')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'B', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('sped_configs', 'ind_ativ', function (Blueprint $table) {
                return $table->string('ind_ativ', 20)->nullable()->default('1')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->addForeignIfMissing('sped_configs', 'sped_configs_filial_id_foreign', 'filial_id', 'filials', 'cascade', 'id', 'restrict');
        });
    }
