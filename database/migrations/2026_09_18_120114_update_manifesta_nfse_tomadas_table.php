...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120114_update_manifesta_nfse_tomadas_table';
    private const TABLE_NAME = 'manifesta_nfse_tomadas';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('manifesta_nfse_tomadas');
            $this->preflightColumn('manifesta_nfse_tomadas', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('manifesta_nfse_tomadas', 'numero_nota', ['column_type' => 'varchar(15)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('manifesta_nfse_tomadas', 'data_emissao', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('manifesta_nfse_tomadas', 'prestador_nome', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('manifesta_nfse_tomadas', 'prestador_cnpj_cpf', ['column_type' => 'varchar(18)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('manifesta_nfse_tomadas', 'valor_servico', ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('manifesta_nfse_tomadas', 'valor_liquido', ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('manifesta_nfse_tomadas', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('manifesta_nfse_tomadas', 'numero_nota', function (Blueprint $table) {
                return $table->string('numero_nota', 15)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(15)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('manifesta_nfse_tomadas', 'data_emissao', function (Blueprint $table) {
                return $table->dateTime('data_emissao')->nullable()->default(null);
            ...
            $this->ensureColumn('manifesta_nfse_tomadas', 'prestador_nome', function (Blueprint $table) {
                return $table->string('prestador_nome', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('manifesta_nfse_tomadas', 'prestador_cnpj_cpf', function (Blueprint $table) {
                return $table->string('prestador_cnpj_cpf', 18)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(18)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('manifesta_nfse_tomadas', 'valor_servico', function (Blueprint $table) {
                return $table->decimal('valor_servico', 15, 2)->nullable()->default('0.00');
            ...
            $this->ensureColumn('manifesta_nfse_tomadas', 'valor_liquido', function (Blueprint $table) {
                return $table->decimal('valor_liquido', 15, 2)->nullable()->default('0.00');
            }, ['column_type' => 'decimal(15,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        });
    }
