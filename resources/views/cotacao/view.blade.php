									...
									<table class="datatable-table" style="max-width: 100%; overflow: scroll">
										<thead class="datatable-head">
											<tr class="datatable-row" style="left: 0px;">
												...
												<th data-field="Country" class="datatable-cell datatable-cell-sort"><span style="width: 120px;">Valor unitário</span></th>
												<th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span style="width: 120px;">SubTotal</span></th>
										...
										<tbody class="datatable-body">
											...
											<tr class="datatable-row" style="left: 0px;">
												...
												<td class="datatable-cell"><span class="codigo" style="width: 120px;">{{number_format($i->valor_unitario, 2, ',', '.')}}</span></td>
			...
			<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
				<div class="card card-custom gutter-b example example-compact">
					<div class="card-body">
						...
						<h5 class="card-title">Total: <strong class="text-danger">R$
							{{number_format($cotacao->valor, 2, ',', '.')}}</strong></h5>
