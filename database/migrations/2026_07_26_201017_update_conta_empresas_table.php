...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('conta_empresas', 'conta_contabil_id', 'INT DEFAULT NULL', 'usuario_id', false);
        $this->addForeignIfMissing('conta_empresas', 'conta_empresas_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'set null', 'cascade');
    }
