...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('transferencias', 'transferencias_natureza_id_foreign', ['natureza_id'], 'natureza_operacaos', ['id'], null, null);
        $this->addForeignIfMissing('transferencias', 'transferencias_filial_saida_id_foreign', ['filial_saida_id'], 'filials', ['id'], 'cascade', null);
        $this->addForeignIfMissing('transferencias', 'transferencias_filial_entrada_id_foreign', ['filial_entrada_id'], 'filials', ['id'], 'cascade', null);
    }
