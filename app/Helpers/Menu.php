...
class Menu {
            ...
            */
            ...
            [
                ...
                'subs' => [
                    ...
                    [
                        'nome' => 'Grupo de Categorias',
                        'rota' => '/grupo-categorias'
                    ],
                    [
                        'nome' => 'Veiculos',
                        'rota' => '/veiculos'
            ...
            [
                ...
                'subs' => [
                    ...
                    [
                        'nome' => 'Reprocessar CFOP / Tributos',
                        'rota' => '/compras/reprocessar-cfop'
                    ],
                    [
                        'nome' => 'Manifesto NFe',
                        'rota' => '/dfe'
            ...
            [
                ...
                'icone' => $this->getIcone('RelatoriosFinanceiros'),
                'subs' => [
                    [
                        'nome' => 'Despesas - Visão Semanal',
                        'rota' => '/relatorios-financeiros/despesas-semanal'
                    ],
                    [
                        'nome' => 'Resumo Gerencial de Despesas',
                        'rota' => '/relatorios-financeiros/resumo-despesas'
                    ],
                    [
                        'nome' => 'Comparativo de Despesas (Mês vs Mês)',
                        'rota' => '/relatorios-financeiros/comparativo-meses'
                    ],
                ]
            ],
            [
            ...
            [
                ...
                'subs' => [
                    [
                        'nome' => 'Pré-cadastros (Aprovar)',
                        'rota' => '/cadastros-pendentes'
                    ],
                    [
                        'nome' => 'Gestão de Coletas',
                        'rota' => '/gestao-coletas'
                    ],
                    [
                        'nome' => 'Agenda de Coletas',
                        'rota' => '/movimentacaoVeiculo/agenda'
                    ],
                    [
                        'nome' => 'Funcionários',
                    ...
                    [
                        'nome' => 'Relatório de Coletas',
                        'rota' => '/movimentacaoVeiculo/relatorioColetas'
                    ],
                    [
                        'nome' => 'Dashboard',
            ...
            [
                ...
                'subs' => [
                    ...
                    [
                        'nome' => 'Ajuste Fiscal',
                        'rota' => '/relatorios-financeiros/prosoft/ajuste-fiscal'
                    ],
                    [
                    ...
                    [
                        'nome' => 'Exportação Fiscal',
                        'rota' => '/relatorios-financeiros/exportar-prosoft'
                    ],
                    [
    ...
    public function getIcone($titulo){
        ...
        if ($titulo == 'Portaria') {
            return '<span class="svg-icon menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24px" height="24px">
                    <path fill="currentColor" d="M256 0c-17.7 0-32 14.3-32 32V64H96c-17.7 0-32 14.3-32 32V480c0 17.7 14.3 32 32 32s32-14.3 32-32V256h160V480c0 17.7 14.3 32 32 32s32-14.3 32-32V96c0-17.7-14.3-32-32-32H288V32c0-17.7-14.3-32-32-32zM96 128h128v64H96v-64zm192 0h128v64H288v-64z" opacity="0.7"/>
                </svg>
            </span>';
        }
        ...
        if ($titulo == 'RelatoriosFinanceiros') {
            return '<span class="svg-icon menu-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <rect x="0" y="0" width="24" height="24"/>
                ...
                <rect fill="#000000" opacity="0.3" x="6" y="8" width="12" height="2" rx="1"/>
                <rect fill="#000000" opacity="0.3" x="6" y="12" width="8" height="2" rx="1"/>
                <circle cx="17" cy="13" r="2" fill="#000000" opacity="0.8"/>
            </g>
        </svg>
    </span>';
        }
