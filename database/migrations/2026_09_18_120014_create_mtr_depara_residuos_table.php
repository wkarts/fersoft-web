...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120014_create_mtr_depara_residuos_table';
    private const TABLE_NAME = 'mtr_depara_residuos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('mtr_depara_residuos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'orgao', ['column_type' => 'enum(\'SINIR\',\'IEMA\',\'SIGOR\',\'FEAM\',\'IMA\',\'FEPAM\')', 'nullable' => false, 'column_default' => 'SINIR', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'produto_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'categoria_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'sub_categoria_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'ncm', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'cod_ibama', ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'descricao_residuo', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'classe_residuo', ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'estado_fisico', ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => 'Solido', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'acondicionamento_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'tratamento_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'unidade_medida', ['column_type' => 'varchar(10)', 'nullable' => false, 'column_default' => 'Kg', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'fator_conversao', ['column_type' => 'decimal(12,4)', 'nullable' => false, 'column_default' => '1.0000', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_depara_residuos', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('mtr_depara_residuos', 'PRIMARY', ['id'], true);
            $this->preflightIndex('mtr_depara_residuos', 'idx_depara_produto', ['produto_id'], false);
            $this->preflightIndex('mtr_depara_residuos', 'idx_mtr_depara_residuos_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('mtr_depara_residuos', 'idx_mtr_depara_residuos_filial_id', ['filial_id'], false);
            $this->preflightIndex('mtr_depara_residuos', 'idx_mtr_depara_residuos_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('mtr_depara_residuos', 'mtr_depara_residuos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('mtr_depara_residuos', 'mtr_depara_residuos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('mtr_depara_residuos', 'mtr_depara_residuos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('mtr_depara_residuos')) {
                if (!$this->beginChange('table', 'mtr_depara_residuos', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('mtr_depara_residuos', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->unsignedInteger('sub_categoria_id')->nullable();
                    $table->string('ncm', 10)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cod_ibama', 20)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('descricao_residuo', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('classe_residuo', 50)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('estado_fisico', 20)->default('Solido')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->integer('acondicionamento_id');
                    $table->integer('tratamento_id');
                    $table->string('unidade_medida', 10)->default('Kg')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->decimal('fator_conversao', 12, 4)->default('1.0000');
                    $table->timestamps();

                    $table->index('produto_id', 'idx_depara_produto');
                    $table->index('empresa_id', 'idx_mtr_depara_residuos_empresa_id');
                    $table->index('filial_id', 'idx_mtr_depara_residuos_filial_id');
                    $table->index('usuario_id', 'idx_mtr_depara_residuos_usuario_id');
                });
                $this->markCreated('table', 'mtr_depara_residuos');
            }

            $this->ensureBaseTenantColumns('mtr_depara_residuos');
            $this->ensureColumn('mtr_depara_residuos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_depara_residuos', 'orgao', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_depara_residuos', 'produto_id', function (Blueprint $table) {
                return $table->unsignedInteger('produto_id')->nullable()->default(null);
            ...
            $this->ensureColumn('mtr_depara_residuos', 'categoria_id', function (Blueprint $table) {
                return $table->unsignedInteger('categoria_id')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_depara_residuos', 'sub_categoria_id', function (Blueprint $table) {
                return $table->unsignedInteger('sub_categoria_id')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_depara_residuos', 'ncm', function (Blueprint $table) {
                return $table->string('ncm', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_depara_residuos', 'cod_ibama', function (Blueprint $table) {
                return $table->string('cod_ibama', 20)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_depara_residuos', 'descricao_residuo', function (Blueprint $table) {
                return $table->string('descricao_residuo', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_depara_residuos', 'classe_residuo', function (Blueprint $table) {
                return $table->string('classe_residuo', 50)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_depara_residuos', 'estado_fisico', function (Blueprint $table) {
                return $table->string('estado_fisico', 20)->nullable(false)->default('Solido')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => 'Solido', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_depara_residuos', 'acondicionamento_id', function (Blueprint $table) {
                return $table->integer('acondicionamento_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_depara_residuos', 'tratamento_id', function (Blueprint $table) {
                return $table->integer('tratamento_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_depara_residuos', 'unidade_medida', function (Blueprint $table) {
                return $table->string('unidade_medida', 10)->nullable(false)->default('Kg')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(10)', 'nullable' => false, 'column_default' => 'Kg', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_depara_residuos', 'fator_conversao', function (Blueprint $table) {
                return $table->decimal('fator_conversao', 12, 4)->nullable(false)->default('1.0000');
            }, ['column_type' => 'decimal(12,4)', 'nullable' => false, 'column_default' => '1.0000', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_depara_residuos', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_depara_residuos', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('mtr_depara_residuos', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('mtr_depara_residuos', 'idx_depara_produto', ['produto_id'], false);
            $this->addIndexIfMissing('mtr_depara_residuos', 'idx_mtr_depara_residuos_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('mtr_depara_residuos', 'idx_mtr_depara_residuos_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('mtr_depara_residuos', 'idx_mtr_depara_residuos_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('mtr_depara_residuos', 'mtr_depara_residuos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_depara_residuos', 'mtr_depara_residuos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_depara_residuos', 'mtr_depara_residuos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('mtr_depara_residuos', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('mtr_depara_residuos', 'filial_id', function (Blueprint $table) {
            return $table->unsignedInteger('filial_id')->nullable()->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('mtr_depara_residuos', 'usuario_id', function (Blueprint $table) {
