...
{
    private const REFERENCE_COLUMNS = ['categoria_id' => ['categorias', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'marca_id' => ['marcas', 'id', 'cascade', 'restrict'], 'produto_prateleira_id' => ['produto_prateleiras', 'id', 'set null', 'restrict'], 'produto_referenciado_id' => ['produtos', 'id', 'set null', 'restrict'], 'sub_categoria_id' => ['sub_categorias', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120124_update_produtos_table';
    private const TABLE_NAME = 'produtos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('produtos');
            $this->preflightColumn('produtos', 'qtd_minima_atacado', ['column_type' => 'decimal(10,3)', 'nullable' => true, 'column_default' => '0.000', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('produtos', 'preco_atacado', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('produtos', 'qtd_minima_atacado', function (Blueprint $table) {
                return $table->decimal('qtd_minima_atacado', 10, 3)->nullable()->default('0.000');
            }, ['column_type' => 'decimal(10,3)', 'nullable' => true, 'column_default' => '0.000', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('produtos', 'preco_atacado', function (Blueprint $table) {
                return $table->decimal('preco_atacado', 10, 2)->nullable()->default('0.00');
