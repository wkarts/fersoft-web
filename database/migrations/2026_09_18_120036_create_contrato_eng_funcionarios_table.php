...
{
    private const REFERENCE_COLUMNS = ['contrato_eng_id' => ['contratos_engenharia', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120036_create_contrato_eng_funcionarios_table';
    private const TABLE_NAME = 'contrato_eng_funcionarios';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('contrato_eng_funcionarios', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'contrato_eng_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'funcionario_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'data_alocacao', ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'data_desalocacao', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'status', ['column_type' => 'enum(\'Ativo\',\'Finalizado\')', 'nullable' => true, 'column_default' => 'Ativo', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'observacao', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('contrato_eng_funcionarios', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('contrato_eng_funcionarios', 'PRIMARY', ['id'], true);
            $this->preflightIndex('contrato_eng_funcionarios', 'contrato_eng_id', ['contrato_eng_id'], false);
            $this->preflightIndex('contrato_eng_funcionarios', 'idx_contrato_eng_funcionarios_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('contrato_eng_funcionarios', 'idx_contrato_eng_funcionarios_filial_id', ['filial_id'], false);
            $this->preflightIndex('contrato_eng_funcionarios', 'idx_contrato_eng_funcionarios_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('contrato_eng_funcionarios', 'contrato_eng_funcionarios_ibfk_1', 'contrato_eng_id', 'contratos_engenharia', 'cascade', 'id', 'restrict');
            $this->preflightForeign('contrato_eng_funcionarios', 'contrato_eng_funcionarios_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('contrato_eng_funcionarios', 'contrato_eng_funcionarios_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('contrato_eng_funcionarios', 'contrato_eng_funcionarios_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('contrato_eng_funcionarios')) {
                if (!$this->beginChange('table', 'contrato_eng_funcionarios', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('contrato_eng_funcionarios', function (Blueprint $table) {
                    ...
                    $table->enum('status', ['Ativo', 'Finalizado'])->nullable()->default('Ativo')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('observacao', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('contrato_eng_id', 'contrato_eng_id');
                    $table->index('empresa_id', 'idx_contrato_eng_funcionarios_empresa_id');
                    $table->index('filial_id', 'idx_contrato_eng_funcionarios_filial_id');
                    $table->index('usuario_id', 'idx_contrato_eng_funcionarios_usuario_id');
                });
                $this->markCreated('table', 'contrato_eng_funcionarios');
            }

            $this->ensureBaseTenantColumns('contrato_eng_funcionarios');
            $this->ensureColumn('contrato_eng_funcionarios', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('contrato_eng_funcionarios', 'contrato_eng_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('contrato_eng_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('contrato_eng_funcionarios', 'funcionario_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('funcionario_id')->nullable(false)->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contrato_eng_funcionarios', 'data_alocacao', function (Blueprint $table) {
                return $table->date('data_alocacao')->nullable(false)->default(null);
            ...
            $this->ensureColumn('contrato_eng_funcionarios', 'data_desalocacao', function (Blueprint $table) {
                return $table->date('data_desalocacao')->nullable()->default(null);
            }, ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('contrato_eng_funcionarios', 'status', function (Blueprint $table) {
                return $table->enum('status', ['Ativo', 'Finalizado'])->nullable()->default('Ativo')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'Ativo\',\'Finalizado\')', 'nullable' => true, 'column_default' => 'Ativo', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('contrato_eng_funcionarios', 'observacao', function (Blueprint $table) {
                return $table->string('observacao', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('contrato_eng_funcionarios', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('contrato_eng_funcionarios', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('contrato_eng_funcionarios', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('contrato_eng_funcionarios', 'contrato_eng_id', ['contrato_eng_id'], false);
            $this->addIndexIfMissing('contrato_eng_funcionarios', 'idx_contrato_eng_funcionarios_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('contrato_eng_funcionarios', 'idx_contrato_eng_funcionarios_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('contrato_eng_funcionarios', 'idx_contrato_eng_funcionarios_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('contrato_eng_funcionarios', 'contrato_eng_funcionarios_ibfk_1', 'contrato_eng_id', 'contratos_engenharia', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('contrato_eng_funcionarios', 'contrato_eng_funcionarios_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('contrato_eng_funcionarios', 'contrato_eng_funcionarios_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('contrato_eng_funcionarios', 'contrato_eng_funcionarios_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('contrato_eng_funcionarios', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('contrato_eng_funcionarios', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('contrato_eng_funcionarios', 'usuario_id', function (Blueprint $table) {
