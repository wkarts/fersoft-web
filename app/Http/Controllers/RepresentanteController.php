...
class RepresentanteController extends Controller
{
		...
		try{
			...
			if($usuario){
				$data = [
					...
					'mensagem_cobranca_login' => $request->mensagem_cobranca_login ? 1 : 0,
				];
	...
	public function detalhes($id){
		...
		$empresa = $representante->usuario->empresa;
		$hoje = date('Y-m-d');
		$planoExpirado = false;
	...
	public function update(Request $request){
		...
		$representante->senha_master = $request->senha_master;
		$representante->cpf_cnpj = $request->cpf_cnpj;
		...
		$representante->bloquear_empresa = $request->bloquear_empresa ? 1 : 0;
		$representante->mensagem_cobranca_login = $request->mensagem_cobranca_login ? 1 : 0;
	...
	private function _validate2(Request $request){
		...
		$messages = [
			'empresa.required' => 'Selecione a empresa para atribuir!',
			'empresa.numeric' => 'Selecione a empresa para atribuir!',
		];
