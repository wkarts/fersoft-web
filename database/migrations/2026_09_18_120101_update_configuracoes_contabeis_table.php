...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120101_update_configuracoes_contabeis_table';
    private const TABLE_NAME = 'configuracoes_contabeis';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('configuracoes_contabeis');
            $this->preflightColumn('configuracoes_contabeis', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('configuracoes_contabeis', 'id', function (Blueprint $table) {
