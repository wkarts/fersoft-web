...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120122_update_ponto_marcacoes_table';
    private const TABLE_NAME = 'ponto_marcacoes';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('ponto_marcacoes');
            $this->preflightColumn('ponto_marcacoes', 'tipo_marcacao', ['column_type' => 'enum(\'entrada\',\'inicio_almoco\',\'fim_almoco\',\'saida\')', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_marcacoes', 'latitude', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_marcacoes', 'longitude', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_marcacoes', 'endereco_traccar', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ponto_marcacoes', 'movimentacao_veiculo_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('ponto_marcacoes', 'tipo_marcacao', function (Blueprint $table) {
                return $table->enum('tipo_marcacao', ['entrada', 'inicio_almoco', 'fim_almoco', 'saida'])->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'entrada\',\'inicio_almoco\',\'fim_almoco\',\'saida\')', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ponto_marcacoes', 'latitude', function (Blueprint $table) {
                return $table->string('latitude', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('ponto_marcacoes', 'longitude', function (Blueprint $table) {
                return $table->string('longitude', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ponto_marcacoes', 'endereco_traccar', function (Blueprint $table) {
                return $table->string('endereco_traccar', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('ponto_marcacoes', 'movimentacao_veiculo_id', function (Blueprint $table) {
                return $table->unsignedInteger('movimentacao_veiculo_id')->nullable()->default(null);
