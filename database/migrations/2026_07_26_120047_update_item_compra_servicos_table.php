...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applySafeColumnUpgrade([
            'table' => 'item_compra_servicos',
            'column' => 'codigo_servico_lc116',
            'type' => 'VARCHAR(10)',
            'nullable' => false,
        ...
        $this->addPrimaryKeyIfMissing('item_compra_servicos', ['id']);

        $this->ensureAutoIncrement('item_compra_servicos', 'id');
    }
