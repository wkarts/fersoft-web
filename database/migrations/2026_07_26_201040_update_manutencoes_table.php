...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('manutencoes', 'manutencoes_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'set null', null);
        $this->addForeignIfMissing('manutencoes', 'manutencoes_fornecedor_id_foreign', ['fornecedor_id'], 'fornecedors', ['id'], 'set null', null);
    }
