...
class FrontBoxController extends Controller
{
    ...
    public function deleteVenda($id){
        ...
        if(valida_objeto($venda)){
            if(($venda->NFcNumero > 0 || !empty($venda->chave)) && $venda->estado != 'CANCELADO'){
                session()->flash('mensagem_erro', 'Venda possui NFCe associada. Cancele a NFCe antes de remover a venda.');
