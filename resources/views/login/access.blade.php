...
<head>
  ...
  <style type="text/css">
    ...
    #kt_login .overflow-hidden{
     box-shadow:0px 0px 50px 0px #2b579a;
    ...
    /* Body */
    body{
     background-color:rgba(238,240,248,0);
    }
            ...
            <div class="login-form login-signin py-11">
              ...
              <form method="post" action="/login/request" class="form animate__animated animate__backInDown" novalidate="novalidate" id="kt_login_signin_form">
                ...
                @if(env("APP_ENV") === "demo")
                  ...
                  <button type="button" class="btn btn-success mb-2" onclick="doLogin('{{ env('DEMO_SUPER_USER', 'super') }}', '{{ env('DEMO_SUPER_PASS', '12345') }}')">
                      Super Admin
                  </button>
                  <button type="button" class="btn btn-info mb-2" onclick="doLogin('{{ env('DEMO_ADMIN_USER', 'admin') }}', '{{ env('DEMO_ADMIN_PASS', '12345') }}')">
                      Administrador
                  </button>
                @endif
