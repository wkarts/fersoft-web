    ...
    */
    public function __construct()
    {
        ...
        if ($categorias->isNotEmpty()) {
            for ($aux = 0; $aux < 4; $aux++) {
                $n = rand(0, $categorias->count() - 1);
                array_push($this->imagensRandom, $categorias[$n]->path);
            }
        } else {
            // Define um valor padrão caso a tabela esteja vazia
            $this->imagensRandom = ['/imgs/no_image.png', '/imgs/no_image.png', '/imgs/no_image.png', '/imgs/no_image.png'];
        }
    }
