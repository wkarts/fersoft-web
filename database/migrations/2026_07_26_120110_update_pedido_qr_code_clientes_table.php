...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('pedido_qr_code_clientes')) {
            return;
        }

        $this->addForeignIfMissing('pedido_qr_code_clientes', 'pedido_qr_code_clientes_filial_id_foreign', 'filial_id', 'filials', 'id', 'cascade', null);
    }
