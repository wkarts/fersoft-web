...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('conta_recebers', 'usuario_id', 'INT DEFAULT NULL', 'updated_at', false);
        $this->applyColumnDefinition('conta_recebers', 'usuario_edit_id', 'INT DEFAULT NULL', 'usuario_id', false);
        $this->applyColumnDefinition('conta_recebers', 'usuario_baixa_id', 'INT DEFAULT NULL', 'usuario_edit_id', false);
        $this->addForeignIfMissing('conta_recebers', 'conta_recebers_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
    }
