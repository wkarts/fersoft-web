						...
						<div class="card card-custom gutter-b">
							...
							<div class="card-footer">
								<div id="kt_datatable" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
									...
									<br>
									<h3 class="text-danger">Total: R$ {{moeda($cte->somaDespesa())}}</h3>
						...
						<div class="card card-custom gutter-b">
							...
							<div class="card-footer">
								<div id="kt_datatable" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
									...
									<br>
									<h3 class="text-success">Total: R$ {{moeda($cte->somaReceita())}}</h3>
				...
				<div class="row">
					<h2>Saldo: R$ 
						<strong class=" @if($cte->somaReceita()>$cte->somaDespesa()) text-success
							...
							@else text-danger @endif">{{moeda($cte->somaReceita()-$cte->somaDespesa())}}</strong>
						</h2>
					</div>
