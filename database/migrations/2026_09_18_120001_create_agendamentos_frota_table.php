...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120001_create_agendamentos_frota_table';
    private const TABLE_NAME = 'agendamentos_frota';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('agendamentos_frota', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'veiculo_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'solicitacao_coleta_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'data_saida', ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'status_portaria', ['column_type' => 'enum(\'aguardando_saida\',\'em_rota\',\'concluido\')', 'nullable' => true, 'column_default' => 'aguardando_saida', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos_frota', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('agendamentos_frota', 'PRIMARY', ['id'], true);
            $this->preflightIndex('agendamentos_frota', 'idx_agendamentos_frota_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('agendamentos_frota', 'idx_agendamentos_frota_filial_id', ['filial_id'], false);
            $this->preflightIndex('agendamentos_frota', 'idx_agendamentos_frota_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('agendamentos_frota', 'agendamentos_frota_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('agendamentos_frota', 'agendamentos_frota_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('agendamentos_frota', 'agendamentos_frota_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('agendamentos_frota')) {
                if (!$this->beginChange('table', 'agendamentos_frota', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('agendamentos_frota', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->unsignedBigInteger('solicitacao_coleta_id');
                    $table->date('data_saida');
                    $table->enum('status_portaria', ['aguardando_saida', 'em_rota', 'concluido'])->nullable()->default('aguardando_saida')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('empresa_id', 'idx_agendamentos_frota_empresa_id');
                    $table->index('filial_id', 'idx_agendamentos_frota_filial_id');
                    $table->index('usuario_id', 'idx_agendamentos_frota_usuario_id');
                });
                $this->markCreated('table', 'agendamentos_frota');
            }

            $this->ensureBaseTenantColumns('agendamentos_frota');
            $this->ensureColumn('agendamentos_frota', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('agendamentos_frota', 'veiculo_id', function (Blueprint $table) {
                return $table->unsignedInteger('veiculo_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('agendamentos_frota', 'solicitacao_coleta_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('solicitacao_coleta_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('agendamentos_frota', 'data_saida', function (Blueprint $table) {
                return $table->date('data_saida')->nullable(false)->default(null);
            ...
            $this->ensureColumn('agendamentos_frota', 'status_portaria', function (Blueprint $table) {
                return $table->enum('status_portaria', ['aguardando_saida', 'em_rota', 'concluido'])->nullable()->default('aguardando_saida')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'aguardando_saida\',\'em_rota\',\'concluido\')', 'nullable' => true, 'column_default' => 'aguardando_saida', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('agendamentos_frota', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('agendamentos_frota', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('agendamentos_frota', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('agendamentos_frota', 'idx_agendamentos_frota_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('agendamentos_frota', 'idx_agendamentos_frota_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('agendamentos_frota', 'idx_agendamentos_frota_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('agendamentos_frota', 'agendamentos_frota_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('agendamentos_frota', 'agendamentos_frota_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('agendamentos_frota', 'agendamentos_frota_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('agendamentos_frota', 'empresa_id', function (Blueprint $table) {
            return $table->unsignedInteger('empresa_id')->nullable(false)->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('agendamentos_frota', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('agendamentos_frota', 'usuario_id', function (Blueprint $table) {
