...
{
    private const REFERENCE_COLUMNS = ['categoria_conta_id' => ['categoria_contas', 'id', 'cascade', 'restrict'], 'grupo_categoria_id' => ['grupo_categorias', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120034_create_categoria_conta_grupo_table';
    private const TABLE_NAME = 'categoria_conta_grupo';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('categoria_conta_grupo', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('categoria_conta_grupo', 'grupo_categoria_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('categoria_conta_grupo', 'categoria_conta_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('categoria_conta_grupo', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('categoria_conta_grupo', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('categoria_conta_grupo', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('categoria_conta_grupo', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('categoria_conta_grupo', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('categoria_conta_grupo', 'PRIMARY', ['id'], true);
            $this->preflightIndex('categoria_conta_grupo', 'categoria_conta_grupo_grupo_categoria_id_foreign', ['grupo_categoria_id'], false);
            $this->preflightIndex('categoria_conta_grupo', 'categoria_conta_grupo_categoria_conta_id_foreign', ['categoria_conta_id'], false);
            $this->preflightIndex('categoria_conta_grupo', 'idx_categoria_conta_grupo_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('categoria_conta_grupo', 'idx_categoria_conta_grupo_filial_id', ['filial_id'], false);
            $this->preflightIndex('categoria_conta_grupo', 'idx_categoria_conta_grupo_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('categoria_conta_grupo', 'categoria_conta_grupo_categoria_conta_id_foreign', 'categoria_conta_id', 'categoria_contas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('categoria_conta_grupo', 'categoria_conta_grupo_grupo_categoria_id_foreign', 'grupo_categoria_id', 'grupo_categorias', 'cascade', 'id', 'restrict');
            $this->preflightForeign('categoria_conta_grupo', 'categoria_conta_grupo_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('categoria_conta_grupo', 'categoria_conta_grupo_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('categoria_conta_grupo', 'categoria_conta_grupo_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('categoria_conta_grupo')) {
                if (!$this->beginChange('table', 'categoria_conta_grupo', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('categoria_conta_grupo', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->unsignedBigInteger('grupo_categoria_id');
                    $table->unsignedInteger('categoria_conta_id');
                    $table->timestamps();

                    $table->index('grupo_categoria_id', 'categoria_conta_grupo_grupo_categoria_id_foreign');
                    $table->index('categoria_conta_id', 'categoria_conta_grupo_categoria_conta_id_foreign');
                    $table->index('empresa_id', 'idx_categoria_conta_grupo_empresa_id');
                    $table->index('filial_id', 'idx_categoria_conta_grupo_filial_id');
                    $table->index('usuario_id', 'idx_categoria_conta_grupo_usuario_id');
                });
                $this->markCreated('table', 'categoria_conta_grupo');
            }

            $this->ensureBaseTenantColumns('categoria_conta_grupo');
            $this->ensureColumn('categoria_conta_grupo', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('categoria_conta_grupo', 'grupo_categoria_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('grupo_categoria_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('categoria_conta_grupo', 'categoria_conta_id', function (Blueprint $table) {
                return $table->unsignedInteger('categoria_conta_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('categoria_conta_grupo', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('categoria_conta_grupo', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('categoria_conta_grupo', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('categoria_conta_grupo', 'categoria_conta_grupo_grupo_categoria_id_foreign', ['grupo_categoria_id'], false);
            $this->addIndexIfMissing('categoria_conta_grupo', 'categoria_conta_grupo_categoria_conta_id_foreign', ['categoria_conta_id'], false);
            $this->addIndexIfMissing('categoria_conta_grupo', 'idx_categoria_conta_grupo_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('categoria_conta_grupo', 'idx_categoria_conta_grupo_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('categoria_conta_grupo', 'idx_categoria_conta_grupo_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('categoria_conta_grupo', 'categoria_conta_grupo_categoria_conta_id_foreign', 'categoria_conta_id', 'categoria_contas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('categoria_conta_grupo', 'categoria_conta_grupo_grupo_categoria_id_foreign', 'grupo_categoria_id', 'grupo_categorias', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('categoria_conta_grupo', 'categoria_conta_grupo_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('categoria_conta_grupo', 'categoria_conta_grupo_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('categoria_conta_grupo', 'categoria_conta_grupo_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('categoria_conta_grupo', 'empresa_id', function (Blueprint $table) {
            return $table->unsignedInteger('empresa_id')->nullable(false)->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('categoria_conta_grupo', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('categoria_conta_grupo', 'usuario_id', function (Blueprint $table) {
