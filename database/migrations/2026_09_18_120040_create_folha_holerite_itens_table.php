...
{
    private const REFERENCE_COLUMNS = ['folha_holerite_id' => ['folha_holerites', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120040_create_folha_holerite_itens_table';
    private const TABLE_NAME = 'folha_holerite_itens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('folha_holerite_itens', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'folha_holerite_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'codigo_evento', ['column_type' => 'varchar(10)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'descricao', ['column_type' => 'varchar(100)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'referencia', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'tipo', ['column_type' => 'enum(\'provento\',\'desconto\')', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'valor', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerite_itens', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('folha_holerite_itens', 'PRIMARY', ['id'], true);
            $this->preflightIndex('folha_holerite_itens', 'folha_holerite_id', ['folha_holerite_id'], false);
            $this->preflightIndex('folha_holerite_itens', 'idx_folha_holerite_itens_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('folha_holerite_itens', 'idx_folha_holerite_itens_filial_id', ['filial_id'], false);
            $this->preflightIndex('folha_holerite_itens', 'idx_folha_holerite_itens_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('folha_holerite_itens', 'folha_holerite_itens_ibfk_1', 'folha_holerite_id', 'folha_holerites', 'cascade', 'id', 'restrict');
            $this->preflightForeign('folha_holerite_itens', 'folha_holerite_itens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('folha_holerite_itens', 'folha_holerite_itens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('folha_holerite_itens', 'folha_holerite_itens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('folha_holerite_itens')) {
                if (!$this->beginChange('table', 'folha_holerite_itens', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('folha_holerite_itens', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->unsignedBigInteger('folha_holerite_id');
                    $table->string('codigo_evento', 10)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('descricao', 100)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('referencia', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('tipo', ['provento', 'desconto'])->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->decimal('valor', 10, 2)->default('0.00');
                    $table->timestamps();

                    $table->index('folha_holerite_id', 'folha_holerite_id');
                    $table->index('empresa_id', 'idx_folha_holerite_itens_empresa_id');
                    $table->index('filial_id', 'idx_folha_holerite_itens_filial_id');
                    $table->index('usuario_id', 'idx_folha_holerite_itens_usuario_id');
                });
                $this->markCreated('table', 'folha_holerite_itens');
            }

            $this->ensureBaseTenantColumns('folha_holerite_itens');
            $this->ensureColumn('folha_holerite_itens', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('folha_holerite_itens', 'folha_holerite_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('folha_holerite_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('folha_holerite_itens', 'codigo_evento', function (Blueprint $table) {
                return $table->string('codigo_evento', 10)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerite_itens', 'descricao', function (Blueprint $table) {
                return $table->string('descricao', 100)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerite_itens', 'referencia', function (Blueprint $table) {
                return $table->string('referencia', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerite_itens', 'tipo', function (Blueprint $table) {
                return $table->enum('tipo', ['provento', 'desconto'])->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'provento\',\'desconto\')', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('folha_holerite_itens', 'valor', function (Blueprint $table) {
                return $table->decimal('valor', 10, 2)->nullable(false)->default('0.00');
            ...
            $this->ensureColumn('folha_holerite_itens', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('folha_holerite_itens', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('folha_holerite_itens', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('folha_holerite_itens', 'folha_holerite_id', ['folha_holerite_id'], false);
            $this->addIndexIfMissing('folha_holerite_itens', 'idx_folha_holerite_itens_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('folha_holerite_itens', 'idx_folha_holerite_itens_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('folha_holerite_itens', 'idx_folha_holerite_itens_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('folha_holerite_itens', 'folha_holerite_itens_ibfk_1', 'folha_holerite_id', 'folha_holerites', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('folha_holerite_itens', 'folha_holerite_itens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('folha_holerite_itens', 'folha_holerite_itens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('folha_holerite_itens', 'folha_holerite_itens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('folha_holerite_itens', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('folha_holerite_itens', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('folha_holerite_itens', 'usuario_id', function (Blueprint $table) {
