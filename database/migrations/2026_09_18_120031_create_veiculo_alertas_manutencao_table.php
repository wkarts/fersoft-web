...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120031_create_veiculo_alertas_manutencao_table';
    private const TABLE_NAME = 'veiculo_alertas_manutencao';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('veiculo_alertas_manutencao', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'veiculo_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'manutencao_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'tipo', ['column_type' => 'enum(\'preventiva\',\'corretiva\')', 'nullable' => false, 'column_default' => 'corretiva', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'titulo', ['column_type' => 'varchar(191)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'descricao', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'prioridade', ['column_type' => 'enum(\'Baixa\',\'Media\',\'Alta\',\'Urgente\')', 'nullable' => false, 'column_default' => 'Alta', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'fase', ['column_type' => 'enum(\'identificado\',\'aguardando_cotacao\',\'aguardando_autorizacao\',\'aguardando_peca\',\'em_manutencao\',\'resolvido\')', 'nullable' => false, 'column_default' => 'identificado', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'impedir_circulacao', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'intervalo_km', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'ultimo_km_executado', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'previsao_conclusao', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'valor_estimado', ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'usuario_aprovador_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'data_aprovacao', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'motivo_rejeicao', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_alertas_manutencao', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('veiculo_alertas_manutencao', 'PRIMARY', ['id'], true);
            $this->preflightIndex('veiculo_alertas_manutencao', 'idx_empresa_veiculo', ['empresa_id', 'veiculo_id'], false);
            $this->preflightIndex('veiculo_alertas_manutencao', 'idx_fase_tipo', ['fase', 'tipo'], false);
            $this->preflightIndex('veiculo_alertas_manutencao', 'idx_veiculo_alertas_manutencao_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('veiculo_alertas_manutencao', 'idx_veiculo_alertas_manutencao_filial_id', ['filial_id'], false);
            $this->preflightIndex('veiculo_alertas_manutencao', 'idx_veiculo_alertas_manutencao_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('veiculo_alertas_manutencao', 'veiculo_alertas_manutencao_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('veiculo_alertas_manutencao', 'veiculo_alertas_manutencao_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('veiculo_alertas_manutencao', 'veiculo_alertas_manutencao_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('veiculo_alertas_manutencao')) {
                if (!$this->beginChange('table', 'veiculo_alertas_manutencao', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('veiculo_alertas_manutencao', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->integer('manutencao_id')->nullable();
                    $table->enum('tipo', ['preventiva', 'corretiva'])->default('corretiva')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('titulo', 191)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('descricao')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('prioridade', ['Baixa', 'Media', 'Alta', 'Urgente'])->default('Alta')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('fase', ['identificado', 'aguardando_cotacao', 'aguardando_autorizacao', 'aguardando_peca', 'em_manutencao', 'resolvido'])->default('identificado')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->tinyInteger('impedir_circulacao')->default('0');
                    $table->integer('intervalo_km')->nullable();
                    $table->integer('ultimo_km_executado')->nullable();
                    $table->date('previsao_conclusao')->nullable();
                    $table->decimal('valor_estimado', 10, 2)->nullable()->default('0.00');
                    $table->integer('usuario_aprovador_id')->nullable();
                    $table->dateTime('data_aprovacao')->nullable();
                    $table->text('motivo_rejeicao')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index(['empresa_id', 'veiculo_id'], 'idx_empresa_veiculo');
                    $table->index(['fase', 'tipo'], 'idx_fase_tipo');
                    $table->index('empresa_id', 'idx_veiculo_alertas_manutencao_empresa_id');
                    $table->index('filial_id', 'idx_veiculo_alertas_manutencao_filial_id');
                    $table->index('usuario_id', 'idx_veiculo_alertas_manutencao_usuario_id');
                });
                $this->markCreated('table', 'veiculo_alertas_manutencao');
            }

            $this->ensureBaseTenantColumns('veiculo_alertas_manutencao');
            $this->ensureColumn('veiculo_alertas_manutencao', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('veiculo_alertas_manutencao', 'veiculo_id', function (Blueprint $table) {
                return $table->integer('veiculo_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'manutencao_id', function (Blueprint $table) {
                return $table->integer('manutencao_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'tipo', function (Blueprint $table) {
                return $table->enum('tipo', ['preventiva', 'corretiva'])->nullable(false)->default('corretiva')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'preventiva\',\'corretiva\')', 'nullable' => false, 'column_default' => 'corretiva', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'titulo', function (Blueprint $table) {
                return $table->string('titulo', 191)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(191)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'descricao', function (Blueprint $table) {
                return $table->text('descricao')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('veiculo_alertas_manutencao', 'prioridade', function (Blueprint $table) {
                return $table->enum('prioridade', ['Baixa', 'Media', 'Alta', 'Urgente'])->nullable(false)->default('Alta')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'Baixa\',\'Media\',\'Alta\',\'Urgente\')', 'nullable' => false, 'column_default' => 'Alta', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'fase', function (Blueprint $table) {
                return $table->enum('fase', ['identificado', 'aguardando_cotacao', 'aguardando_autorizacao', 'aguardando_peca', 'em_manutencao', 'resolvido'])->nullable(false)->default('identificado')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'identificado\',\'aguardando_cotacao\',\'aguardando_autorizacao\',\'aguardando_peca\',\'em_manutencao\',\'resolvido\')', 'nullable' => false, 'column_default' => 'identificado', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'impedir_circulacao', function (Blueprint $table) {
                return $table->tinyInteger('impedir_circulacao')->nullable(false)->default('0');
            ...
            $this->ensureColumn('veiculo_alertas_manutencao', 'intervalo_km', function (Blueprint $table) {
                return $table->integer('intervalo_km')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'ultimo_km_executado', function (Blueprint $table) {
                return $table->integer('ultimo_km_executado')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'previsao_conclusao', function (Blueprint $table) {
                return $table->date('previsao_conclusao')->nullable()->default(null);
            }, ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'valor_estimado', function (Blueprint $table) {
                return $table->decimal('valor_estimado', 10, 2)->nullable()->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'usuario_aprovador_id', function (Blueprint $table) {
                return $table->integer('usuario_aprovador_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'data_aprovacao', function (Blueprint $table) {
                return $table->dateTime('data_aprovacao')->nullable()->default(null);
            ...
            $this->ensureColumn('veiculo_alertas_manutencao', 'motivo_rejeicao', function (Blueprint $table) {
                return $table->text('motivo_rejeicao')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('veiculo_alertas_manutencao', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('veiculo_alertas_manutencao', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('veiculo_alertas_manutencao', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('veiculo_alertas_manutencao', 'idx_empresa_veiculo', ['empresa_id', 'veiculo_id'], false);
            $this->addIndexIfMissing('veiculo_alertas_manutencao', 'idx_fase_tipo', ['fase', 'tipo'], false);
            $this->addIndexIfMissing('veiculo_alertas_manutencao', 'idx_veiculo_alertas_manutencao_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('veiculo_alertas_manutencao', 'idx_veiculo_alertas_manutencao_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('veiculo_alertas_manutencao', 'idx_veiculo_alertas_manutencao_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('veiculo_alertas_manutencao', 'veiculo_alertas_manutencao_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('veiculo_alertas_manutencao', 'veiculo_alertas_manutencao_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('veiculo_alertas_manutencao', 'veiculo_alertas_manutencao_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('veiculo_alertas_manutencao', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('veiculo_alertas_manutencao', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('veiculo_alertas_manutencao', 'usuario_id', function (Blueprint $table) {
