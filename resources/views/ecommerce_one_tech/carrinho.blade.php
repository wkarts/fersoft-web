							...
							<li class="cart_item clearfix">
								...
								<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
									...
									<div class="cart_item_quantity cart_info_col">
										...
										<div class="cart_item_text">
											<input style="width: 80px" id="{{$i->id}}" class="qtd form-control" type="number" value="{{$i->quantidade}}" min="1" max="25">
										</div>
									</div>
						...
						<div class="col-12">
							<div class="row">
								...
								<form method="get" action="{{$rota}}/checkout">
									...
									<button type="submit" class="button cart_button_checkout">FINALIZAR</button>
								</form>
								@else
								<form method="get" action="{{$rota}}/checkout">
									<input type="hidden" id="tp_frete" value="" name="tp_frete">
