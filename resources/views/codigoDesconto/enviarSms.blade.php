								...
								<div class="kt-section__body">
									...
									<div class="row">
										<div class="form-group validated col-12">
											...
											<div class="">
												<textarea class="form-control" name="mensagem" placeholder="Descrição" rows="3">Utilize {{$cupom->codigo}} para desconto de @if($cupom->tipo == 'valor')R$ @endif{{moeda($cupom->valor)}}@if($cupom->tipo == 'percentual')%@endif, especial para você@if($cupom->cliente_id != null) {{$cupom->cliente->nome}}@endif!</textarea>
											</div>
										</div>
									</div>
								</div>
