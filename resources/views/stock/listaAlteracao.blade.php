									...
									<table class="datatable-table" style="max-width: 100%; overflow: scroll">
										<thead class="datatable-head">
											<tr class="datatable-row" style="left: 0px;">
												...
												<th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span style="width: 120px;">Motivo</span></th>
										...
										<tbody class="datatable-body">
											...
											<tr class="datatable-row" style="left: 0px;">
												<td class="datatable-cell"><span class="codigo" style="width: 150px;">
													{{$a->produto->nome}} 
													{{$a->produto->grade ? " (" . $a->produto->str_grade . ")" : ""}}
												</span></td>
												...
												<td class="datatable-cell">
													...
													<span class="codigo" style="width: 90px;">
														<button @if(strlen($a->observacao) == 0) disabled @endif type="button" class="btn btn-primary" data-toggle="popover" data-html="true" onclick="swalAlert('{{$a->observacao}}')">
