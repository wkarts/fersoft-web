...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('pesagens', 'pesagens_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'set null', null);
        $this->addForeignIfMissing('pesagens', 'pesagens_fornecedor_id_foreign', ['fornecedor_id'], 'fornecedors', ['id'], 'set null', null);
    }
