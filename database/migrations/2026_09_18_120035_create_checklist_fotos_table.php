...
{
    private const REFERENCE_COLUMNS = ['checklist_movimentacao_id' => ['checklists_movimentacoes', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120035_create_checklist_fotos_table';
    private const TABLE_NAME = 'checklist_fotos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('checklist_fotos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklist_fotos', 'checklist_movimentacao_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklist_fotos', 'tipo_foto', ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'frente, painel, pneu, avaria']);
            $this->preflightColumn('checklist_fotos', 'caminho_arquivo', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('checklist_fotos', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklist_fotos', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklist_fotos', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklist_fotos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('checklist_fotos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('checklist_fotos', 'PRIMARY', ['id'], true);
            $this->preflightIndex('checklist_fotos', 'fk_foto_checklist', ['checklist_movimentacao_id'], false);
            $this->preflightIndex('checklist_fotos', 'idx_checklist_fotos_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('checklist_fotos', 'idx_checklist_fotos_filial_id', ['filial_id'], false);
            $this->preflightIndex('checklist_fotos', 'idx_checklist_fotos_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('checklist_fotos', 'fk_foto_checklist', 'checklist_movimentacao_id', 'checklists_movimentacoes', 'cascade', 'id', 'restrict');
            $this->preflightForeign('checklist_fotos', 'checklist_fotos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('checklist_fotos', 'checklist_fotos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('checklist_fotos', 'checklist_fotos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('checklist_fotos')) {
                if (!$this->beginChange('table', 'checklist_fotos', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('checklist_fotos', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->integer('checklist_movimentacao_id');
                    $table->string('tipo_foto', 50)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('frente, painel, pneu, avaria');
                    $table->string('caminho_arquivo', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('checklist_movimentacao_id', 'fk_foto_checklist');
                    $table->index('empresa_id', 'idx_checklist_fotos_empresa_id');
                    $table->index('filial_id', 'idx_checklist_fotos_filial_id');
                    $table->index('usuario_id', 'idx_checklist_fotos_usuario_id');
                });
                $this->markCreated('table', 'checklist_fotos');
            }

            $this->ensureBaseTenantColumns('checklist_fotos');
            $this->ensureColumn('checklist_fotos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('checklist_fotos', 'checklist_movimentacao_id', function (Blueprint $table) {
                return $table->integer('checklist_movimentacao_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('checklist_fotos', 'tipo_foto', function (Blueprint $table) {
                return $table->string('tipo_foto', 50)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('frente, painel, pneu, avaria');
            }, ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'frente, painel, pneu, avaria']);
            $this->ensureColumn('checklist_fotos', 'caminho_arquivo', function (Blueprint $table) {
                return $table->string('caminho_arquivo', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('checklist_fotos', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('checklist_fotos', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('checklist_fotos', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('checklist_fotos', 'fk_foto_checklist', ['checklist_movimentacao_id'], false);
            $this->addIndexIfMissing('checklist_fotos', 'idx_checklist_fotos_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('checklist_fotos', 'idx_checklist_fotos_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('checklist_fotos', 'idx_checklist_fotos_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('checklist_fotos', 'fk_foto_checklist', 'checklist_movimentacao_id', 'checklists_movimentacoes', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('checklist_fotos', 'checklist_fotos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('checklist_fotos', 'checklist_fotos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('checklist_fotos', 'checklist_fotos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('checklist_fotos', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('checklist_fotos', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('checklist_fotos', 'usuario_id', function (Blueprint $table) {
