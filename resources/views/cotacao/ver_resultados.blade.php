...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		<h5>Cotação Referência: <strong>{{$cotacoes[0]->referencia}}</strong></h5>
				...
				<div class="card-header">
					...
					<div class="card-body">
						...
						<div class="kt-widget__info">
							...
							<h5 class="kt-widget__label text-info">{{$c->fornecedor->razao_social}}</h5>
							@endforeach
		...
		<div class="row">
			<div class="col-sm-12 col-lg-6 col-md-6 col-xl-6">
				<div class="card card-custom gutter-b example example-compact">
					...
					<div class="card-body">
						<h5 class="card-title">Melhor Resultado</h5>
			...
			<div class="col-sm-12 col-lg-6 col-md-6 col-xl-6">
				<div class="card card-custom gutter-b example example-compact">
					...
					<div class="card-body">
						<h5 class="card-title">Imprimir Melhor Resultado Por Fornecedor</h5>
