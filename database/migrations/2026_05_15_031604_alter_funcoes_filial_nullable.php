...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('funcoes')) { return; }
        ...
        if (!$this->isSqlite() && Schema::hasColumn('funcoes', 'filial_id')) {
            DB::statement('ALTER TABLE funcoes CHANGE COLUMN filial_id filial_id INT UNSIGNED DEFAULT NULL');
        }

        $this->ensureBaseTenantColumns('funcoes');
        $this->addIndexIfMissing('funcoes', 'idx_funcoes_filial_id', ['filial_id']);
        $this->addIndexIfMissing('funcoes', 'uq_funcoes_empresa_filial_nome', ['empresa_id', 'filial_id', 'nome']);
        $this->addForeignIfMissing('funcoes', 'funcoes_filial_id_foreign', 'filial_id', 'filials', 'cascade');
    }
