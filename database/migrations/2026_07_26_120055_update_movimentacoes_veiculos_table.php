...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('movimentacoes_veiculos', 'movimentacoes_veiculos_filial_id_foreign', 'filial_id', 'filials', 'id', 'set null', null);

        $this->addForeignIfMissing('movimentacoes_veiculos', 'movimentacoes_veiculos_fornecedor_id_foreign', 'fornecedor_id', 'fornecedors', 'id', 'set null', null);
    }
