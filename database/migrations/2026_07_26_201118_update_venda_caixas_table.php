...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('venda_caixas', 'venda_caixas_natureza_id_foreign', ['natureza_id'], 'natureza_operacaos', ['id'], null, null);
        $this->addForeignIfMissing('venda_caixas', 'venda_caixas_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
    }
