...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120003_create_cliente_veiculos_table';
    private const TABLE_NAME = 'cliente_veiculos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('cliente_veiculos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'cliente_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'placa', ['column_type' => 'varchar(10)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'marca', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'modelo', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'ano', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'cor', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'km_atual', ['column_type' => 'int', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'combustivel', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'chassi', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('cliente_veiculos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('cliente_veiculos', 'PRIMARY', ['id'], true);
            $this->preflightIndex('cliente_veiculos', 'idx_cliente_veiculos_empresa_cliente', ['empresa_id', 'cliente_id'], false);
            $this->preflightIndex('cliente_veiculos', 'idx_cliente_veiculos_placa', ['placa'], false);
            $this->preflightIndex('cliente_veiculos', 'idx_cliente_veiculos_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('cliente_veiculos', 'idx_cliente_veiculos_filial_id', ['filial_id'], false);
            $this->preflightIndex('cliente_veiculos', 'idx_cliente_veiculos_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('cliente_veiculos', 'cliente_veiculos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('cliente_veiculos', 'cliente_veiculos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('cliente_veiculos', 'cliente_veiculos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('cliente_veiculos')) {
                if (!$this->beginChange('table', 'cliente_veiculos', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('cliente_veiculos', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->string('placa', 10)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('marca', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('modelo', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('ano', 10)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cor', 30)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->integer('km_atual')->nullable()->default('0');
                    $table->string('combustivel', 30)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('chassi', 30)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index(['empresa_id', 'cliente_id'], 'idx_cliente_veiculos_empresa_cliente');
                    $table->index('placa', 'idx_cliente_veiculos_placa');
                    $table->index('empresa_id', 'idx_cliente_veiculos_empresa_id');
                    $table->index('filial_id', 'idx_cliente_veiculos_filial_id');
                    $table->index('usuario_id', 'idx_cliente_veiculos_usuario_id');
                });
                $this->markCreated('table', 'cliente_veiculos');
            }

            $this->ensureBaseTenantColumns('cliente_veiculos');
            $this->ensureColumn('cliente_veiculos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('cliente_veiculos', 'cliente_id', function (Blueprint $table) {
                return $table->integer('cliente_id')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('cliente_veiculos', 'placa', function (Blueprint $table) {
                return $table->string('placa', 10)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(10)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('cliente_veiculos', 'marca', function (Blueprint $table) {
                return $table->string('marca', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('cliente_veiculos', 'modelo', function (Blueprint $table) {
                return $table->string('modelo', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('cliente_veiculos', 'ano', function (Blueprint $table) {
                return $table->string('ano', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('cliente_veiculos', 'cor', function (Blueprint $table) {
                return $table->string('cor', 30)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('cliente_veiculos', 'km_atual', function (Blueprint $table) {
                return $table->integer('km_atual')->nullable()->default('0');
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('cliente_veiculos', 'combustivel', function (Blueprint $table) {
                return $table->string('combustivel', 30)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('cliente_veiculos', 'chassi', function (Blueprint $table) {
                return $table->string('chassi', 30)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('cliente_veiculos', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('cliente_veiculos', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('cliente_veiculos', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('cliente_veiculos', 'idx_cliente_veiculos_empresa_cliente', ['empresa_id', 'cliente_id'], false);
            $this->addIndexIfMissing('cliente_veiculos', 'idx_cliente_veiculos_placa', ['placa'], false);
            $this->addIndexIfMissing('cliente_veiculos', 'idx_cliente_veiculos_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('cliente_veiculos', 'idx_cliente_veiculos_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('cliente_veiculos', 'idx_cliente_veiculos_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('cliente_veiculos', 'cliente_veiculos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('cliente_veiculos', 'cliente_veiculos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('cliente_veiculos', 'cliente_veiculos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('cliente_veiculos', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('cliente_veiculos', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('cliente_veiculos', 'usuario_id', function (Blueprint $table) {
