...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureColumn('conta_pagars', 'lote_pagamento_id', static function (Blueprint $table): void {
            $table->string('lote_pagamento_id', 50)->nullable();
        });

        $this->applySafeColumnUpgrade([
            'table' => 'conta_pagars',
            'column' => 'conta_id_origem',
            'type' => 'INT',
            'nullable' => true,
        ...
        $this->addForeignIfMissing('conta_pagars', 'conta_pagars_filial_id_foreign', 'filial_id', 'filials', 'id', 'cascade', null);
    }
