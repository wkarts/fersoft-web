...
{
    private const REFERENCE_COLUMNS = ['receita_otica_id' => ['cliente_oticas', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120011_create_historico_status_otica_table';
    private const TABLE_NAME = 'historico_status_otica';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('historico_status_otica', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('historico_status_otica', 'receita_otica_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('historico_status_otica', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('historico_status_otica', 'status_anterior', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('historico_status_otica', 'status_novo', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('historico_status_otica', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('historico_status_otica', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('historico_status_otica', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('historico_status_otica', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('historico_status_otica', 'PRIMARY', ['id'], true);
            $this->preflightIndex('historico_status_otica', 'fk_historico_receita_otica', ['receita_otica_id'], false);
            $this->preflightIndex('historico_status_otica', 'idx_historico_status_otica_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('historico_status_otica', 'idx_historico_status_otica_filial_id', ['filial_id'], false);
            $this->preflightIndex('historico_status_otica', 'idx_historico_status_otica_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('historico_status_otica', 'fk_historico_receita_otica', 'receita_otica_id', 'cliente_oticas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('historico_status_otica', 'historico_status_otica_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('historico_status_otica', 'historico_status_otica_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('historico_status_otica', 'historico_status_otica_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('historico_status_otica')) {
                if (!$this->beginChange('table', 'historico_status_otica', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('historico_status_otica', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->unsignedInteger('receita_otica_id');
                    $table->string('status_anterior', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('status_novo', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('receita_otica_id', 'fk_historico_receita_otica');
                    $table->index('empresa_id', 'idx_historico_status_otica_empresa_id');
                    $table->index('filial_id', 'idx_historico_status_otica_filial_id');
                    $table->index('usuario_id', 'idx_historico_status_otica_usuario_id');
                });
                $this->markCreated('table', 'historico_status_otica');
            }

            $this->ensureBaseTenantColumns('historico_status_otica');
            $this->ensureColumn('historico_status_otica', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('historico_status_otica', 'receita_otica_id', function (Blueprint $table) {
                return $table->unsignedInteger('receita_otica_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('historico_status_otica', 'status_anterior', function (Blueprint $table) {
                return $table->string('status_anterior', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('historico_status_otica', 'status_novo', function (Blueprint $table) {
                return $table->string('status_novo', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('historico_status_otica', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('historico_status_otica', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('historico_status_otica', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('historico_status_otica', 'fk_historico_receita_otica', ['receita_otica_id'], false);
            $this->addIndexIfMissing('historico_status_otica', 'idx_historico_status_otica_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('historico_status_otica', 'idx_historico_status_otica_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('historico_status_otica', 'idx_historico_status_otica_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('historico_status_otica', 'fk_historico_receita_otica', 'receita_otica_id', 'cliente_oticas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('historico_status_otica', 'historico_status_otica_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('historico_status_otica', 'historico_status_otica_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('historico_status_otica', 'historico_status_otica_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('historico_status_otica', 'empresa_id', function (Blueprint $table) {
            return $table->unsignedInteger('empresa_id')->nullable(false)->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('historico_status_otica', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('historico_status_otica', 'usuario_id', function (Blueprint $table) {
    ...
    private function relaxRequiredColumnForExistingRows(
        ...
        if (
            ...
            // Não faz UPDATE nem inventa valor. Apenas relaxa o schema para que
            // os registros legados continuem válidos e a migration prossiga.
    ...
    private function ensureColumn(string $tableName, string $columnName, \Closure $definition, array $expected, bool $allowRecordedChange = false): void
    {
        ...
        Schema::table($tableName, function (Blueprint $table) use ($definition, $current, $expected) {
            ...
            // A definição efetiva segue o plano já relaxado. Isso permite que
            // colunas obrigatórias ausentes em tabelas populadas sejam criadas
            // como nullable sem inventar/backfillar valores de negócio.
