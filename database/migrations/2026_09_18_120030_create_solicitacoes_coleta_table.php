...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120030_create_solicitacoes_coleta_table';
    private const TABLE_NAME = 'solicitacoes_coleta';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('solicitacoes_coleta', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'pessoa_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'material', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'dias_disponiveis', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'fotos', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'observacao', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'status', ['column_type' => 'enum(\'pendente\',\'agendado\',\'recusado\')', 'nullable' => false, 'column_default' => 'pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'data_agendada', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'tipo_transporte', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'frota', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('solicitacoes_coleta', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('solicitacoes_coleta', 'PRIMARY', ['id'], true);
            $this->preflightIndex('solicitacoes_coleta', 'idx_pessoa_id', ['pessoa_id'], false);
            $this->preflightIndex('solicitacoes_coleta', 'idx_status', ['status'], false);
            $this->preflightIndex('solicitacoes_coleta', 'idx_solicitacoes_coleta_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('solicitacoes_coleta', 'idx_solicitacoes_coleta_filial_id', ['filial_id'], false);
            $this->preflightIndex('solicitacoes_coleta', 'idx_solicitacoes_coleta_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('solicitacoes_coleta', 'solicitacoes_coleta_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('solicitacoes_coleta', 'solicitacoes_coleta_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('solicitacoes_coleta', 'solicitacoes_coleta_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('solicitacoes_coleta')) {
                if (!$this->beginChange('table', 'solicitacoes_coleta', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('solicitacoes_coleta', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->string('material', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('dias_disponiveis', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('fotos')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('observacao')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('status', ['pendente', 'agendado', 'recusado'])->default('pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->date('data_agendada')->nullable();
                    $table->string('tipo_transporte', 20)->nullable()->default('frota')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('pessoa_id', 'idx_pessoa_id');
                    $table->index('status', 'idx_status');
                    $table->index('empresa_id', 'idx_solicitacoes_coleta_empresa_id');
                    $table->index('filial_id', 'idx_solicitacoes_coleta_filial_id');
                    $table->index('usuario_id', 'idx_solicitacoes_coleta_usuario_id');
                });
                $this->markCreated('table', 'solicitacoes_coleta');
            }

            $this->ensureBaseTenantColumns('solicitacoes_coleta');
            $this->ensureColumn('solicitacoes_coleta', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('solicitacoes_coleta', 'pessoa_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('pessoa_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('solicitacoes_coleta', 'material', function (Blueprint $table) {
                return $table->string('material', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('solicitacoes_coleta', 'dias_disponiveis', function (Blueprint $table) {
                return $table->string('dias_disponiveis', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('solicitacoes_coleta', 'fotos', function (Blueprint $table) {
                return $table->text('fotos')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('solicitacoes_coleta', 'observacao', function (Blueprint $table) {
                return $table->text('observacao')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('solicitacoes_coleta', 'status', function (Blueprint $table) {
                return $table->enum('status', ['pendente', 'agendado', 'recusado'])->nullable(false)->default('pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'pendente\',\'agendado\',\'recusado\')', 'nullable' => false, 'column_default' => 'pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('solicitacoes_coleta', 'data_agendada', function (Blueprint $table) {
                return $table->date('data_agendada')->nullable()->default(null);
            }, ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('solicitacoes_coleta', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('solicitacoes_coleta', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('solicitacoes_coleta', 'tipo_transporte', function (Blueprint $table) {
                return $table->string('tipo_transporte', 20)->nullable()->default('frota')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'frota', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->addIndexIfMissing('solicitacoes_coleta', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('solicitacoes_coleta', 'idx_pessoa_id', ['pessoa_id'], false);
            $this->addIndexIfMissing('solicitacoes_coleta', 'idx_status', ['status'], false);
            $this->addIndexIfMissing('solicitacoes_coleta', 'idx_solicitacoes_coleta_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('solicitacoes_coleta', 'idx_solicitacoes_coleta_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('solicitacoes_coleta', 'idx_solicitacoes_coleta_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('solicitacoes_coleta', 'solicitacoes_coleta_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('solicitacoes_coleta', 'solicitacoes_coleta_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('solicitacoes_coleta', 'solicitacoes_coleta_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('solicitacoes_coleta', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('solicitacoes_coleta', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('solicitacoes_coleta', 'usuario_id', function (Blueprint $table) {
