...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120008_create_folha_holerites_table';
    private const TABLE_NAME = 'folha_holerites';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('folha_holerites', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'funcionario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'cpf', ['column_type' => 'varchar(14)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'matricula', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'competencia', ['column_type' => 'varchar(20)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'salario_base', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'total_vencimentos', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'total_descontos', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'valor_liquido', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'assinado', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'data_assinatura', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'tipo_assinatura', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'assinatura_imagem', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'token_assinatura', ['column_type' => 'varchar(64)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'ip_assinatura', ['column_type' => 'varchar(45)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'base_inss', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'base_irrf', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'base_fgts', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'valor_fgts', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'divisao_rh', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'cbo', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'funcao', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'dados_json', ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('folha_holerites', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('folha_holerites', 'PRIMARY', ['id'], true);
            $this->preflightIndex('folha_holerites', 'cpf', ['cpf'], false);
            $this->preflightIndex('folha_holerites', 'competencia', ['competencia'], false);
            $this->preflightIndex('folha_holerites', 'idx_folha_holerites_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('folha_holerites', 'idx_folha_holerites_filial_id', ['filial_id'], false);
            $this->preflightIndex('folha_holerites', 'idx_folha_holerites_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('folha_holerites', 'folha_holerites_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('folha_holerites', 'folha_holerites_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('folha_holerites', 'folha_holerites_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('folha_holerites')) {
                if (!$this->beginChange('table', 'folha_holerites', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('folha_holerites', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->string('cpf', 14)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('matricula', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('competencia', 20)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->decimal('salario_base', 10, 2)->default('0.00');
                    $table->decimal('total_vencimentos', 10, 2)->default('0.00');
                    $table->decimal('total_descontos', 10, 2)->default('0.00');
                    $table->decimal('valor_liquido', 10, 2)->default('0.00');
                    $table->tinyInteger('assinado')->default('0');
                    $table->dateTime('data_assinatura')->nullable();
                    $table->string('tipo_assinatura', 30)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->longText('assinatura_imagem')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('token_assinatura', 64)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('ip_assinatura', 45)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->decimal('base_inss', 10, 2)->default('0.00');
                    $table->decimal('base_irrf', 10, 2)->default('0.00');
                    $table->decimal('base_fgts', 10, 2)->default('0.00');
                    $table->decimal('valor_fgts', 10, 2)->default('0.00');
                    $table->string('divisao_rh', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('cbo', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('funcao', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->json('dados_json')->nullable();
                    $table->timestamps();

                    $table->index('cpf', 'cpf');
                    $table->index('competencia', 'competencia');
                    $table->index('empresa_id', 'idx_folha_holerites_empresa_id');
                    $table->index('filial_id', 'idx_folha_holerites_filial_id');
                    $table->index('usuario_id', 'idx_folha_holerites_usuario_id');
                });
                $this->markCreated('table', 'folha_holerites');
            }

            $this->ensureBaseTenantColumns('folha_holerites');
            $this->ensureColumn('folha_holerites', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('folha_holerites', 'funcionario_id', function (Blueprint $table) {
                return $table->unsignedInteger('funcionario_id')->nullable()->default(null);
            ...
            $this->ensureColumn('folha_holerites', 'cpf', function (Blueprint $table) {
                return $table->string('cpf', 14)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(14)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'matricula', function (Blueprint $table) {
                return $table->string('matricula', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerites', 'competencia', function (Blueprint $table) {
                return $table->string('competencia', 20)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerites', 'salario_base', function (Blueprint $table) {
                return $table->decimal('salario_base', 10, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'total_vencimentos', function (Blueprint $table) {
                return $table->decimal('total_vencimentos', 10, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'total_descontos', function (Blueprint $table) {
                return $table->decimal('total_descontos', 10, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'valor_liquido', function (Blueprint $table) {
                return $table->decimal('valor_liquido', 10, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'assinado', function (Blueprint $table) {
                return $table->tinyInteger('assinado')->nullable(false)->default('0');
            ...
            $this->ensureColumn('folha_holerites', 'data_assinatura', function (Blueprint $table) {
                return $table->dateTime('data_assinatura')->nullable()->default(null);
            }, ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'tipo_assinatura', function (Blueprint $table) {
                return $table->string('tipo_assinatura', 30)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerites', 'assinatura_imagem', function (Blueprint $table) {
                return $table->longText('assinatura_imagem')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerites', 'token_assinatura', function (Blueprint $table) {
                return $table->string('token_assinatura', 64)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(64)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'ip_assinatura', function (Blueprint $table) {
                return $table->string('ip_assinatura', 45)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(45)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'base_inss', function (Blueprint $table) {
                return $table->decimal('base_inss', 10, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'base_irrf', function (Blueprint $table) {
                return $table->decimal('base_irrf', 10, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'base_fgts', function (Blueprint $table) {
                return $table->decimal('base_fgts', 10, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'valor_fgts', function (Blueprint $table) {
                return $table->decimal('valor_fgts', 10, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'divisao_rh', function (Blueprint $table) {
                return $table->string('divisao_rh', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerites', 'cbo', function (Blueprint $table) {
                return $table->string('cbo', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'funcao', function (Blueprint $table) {
                return $table->string('funcao', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('folha_holerites', 'dados_json', function (Blueprint $table) {
                return $table->json('dados_json')->nullable()->default(null);
            }, ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('folha_holerites', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('folha_holerites', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('folha_holerites', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('folha_holerites', 'cpf', ['cpf'], false);
            $this->addIndexIfMissing('folha_holerites', 'competencia', ['competencia'], false);
            $this->addIndexIfMissing('folha_holerites', 'idx_folha_holerites_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('folha_holerites', 'idx_folha_holerites_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('folha_holerites', 'idx_folha_holerites_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('folha_holerites', 'folha_holerites_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('folha_holerites', 'folha_holerites_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('folha_holerites', 'folha_holerites_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('folha_holerites', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('folha_holerites', 'filial_id', function (Blueprint $table) {
            return $table->unsignedInteger('filial_id')->nullable()->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('folha_holerites', 'usuario_id', function (Blueprint $table) {
