...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120032_create_veiculo_planos_preventivos_table';
    private const TABLE_NAME = 'veiculo_planos_preventivos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('veiculo_planos_preventivos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'veiculo_id', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'servico_nome', ['column_type' => 'varchar(191)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'intervalo_km', ['column_type' => 'int', 'nullable' => false, 'column_default' => '10000', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'intervalo_dias', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'ultimo_km_executado', ['column_type' => 'int', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'ultima_data_execucao', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'ativo', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('veiculo_planos_preventivos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('veiculo_planos_preventivos', 'PRIMARY', ['id'], true);
            $this->preflightIndex('veiculo_planos_preventivos', 'idx_preventiva_veiculo', ['empresa_id', 'veiculo_id'], false);
            $this->preflightIndex('veiculo_planos_preventivos', 'idx_veiculo_planos_preventivos_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('veiculo_planos_preventivos', 'idx_veiculo_planos_preventivos_filial_id', ['filial_id'], false);
            $this->preflightIndex('veiculo_planos_preventivos', 'idx_veiculo_planos_preventivos_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('veiculo_planos_preventivos', 'veiculo_planos_preventivos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('veiculo_planos_preventivos', 'veiculo_planos_preventivos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('veiculo_planos_preventivos', 'veiculo_planos_preventivos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('veiculo_planos_preventivos')) {
                if (!$this->beginChange('table', 'veiculo_planos_preventivos', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('veiculo_planos_preventivos', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->string('servico_nome', 191)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->integer('intervalo_km')->default('10000');
                    $table->integer('intervalo_dias')->nullable();
                    $table->integer('ultimo_km_executado')->default('0');
                    $table->date('ultima_data_execucao')->nullable();
                    $table->tinyInteger('ativo')->default('1');
                    $table->timestamps();

                    $table->index(['empresa_id', 'veiculo_id'], 'idx_preventiva_veiculo');
                    $table->index('empresa_id', 'idx_veiculo_planos_preventivos_empresa_id');
                    $table->index('filial_id', 'idx_veiculo_planos_preventivos_filial_id');
                    $table->index('usuario_id', 'idx_veiculo_planos_preventivos_usuario_id');
                });
                $this->markCreated('table', 'veiculo_planos_preventivos');
            }

            $this->ensureBaseTenantColumns('veiculo_planos_preventivos');
            $this->ensureColumn('veiculo_planos_preventivos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('veiculo_planos_preventivos', 'veiculo_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('veiculo_planos_preventivos', 'servico_nome', function (Blueprint $table) {
                return $table->string('servico_nome', 191)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('veiculo_planos_preventivos', 'intervalo_km', function (Blueprint $table) {
                return $table->integer('intervalo_km')->nullable(false)->default('10000');
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => '10000', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_planos_preventivos', 'intervalo_dias', function (Blueprint $table) {
                return $table->integer('intervalo_dias')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_planos_preventivos', 'ultimo_km_executado', function (Blueprint $table) {
                return $table->integer('ultimo_km_executado')->nullable(false)->default('0');
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_planos_preventivos', 'ultima_data_execucao', function (Blueprint $table) {
                return $table->date('ultima_data_execucao')->nullable()->default(null);
            }, ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('veiculo_planos_preventivos', 'ativo', function (Blueprint $table) {
            ...
            $this->ensureColumn('veiculo_planos_preventivos', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('veiculo_planos_preventivos', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('veiculo_planos_preventivos', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('veiculo_planos_preventivos', 'idx_preventiva_veiculo', ['empresa_id', 'veiculo_id'], false);
            $this->addIndexIfMissing('veiculo_planos_preventivos', 'idx_veiculo_planos_preventivos_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('veiculo_planos_preventivos', 'idx_veiculo_planos_preventivos_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('veiculo_planos_preventivos', 'idx_veiculo_planos_preventivos_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('veiculo_planos_preventivos', 'veiculo_planos_preventivos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('veiculo_planos_preventivos', 'veiculo_planos_preventivos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('veiculo_planos_preventivos', 'veiculo_planos_preventivos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('veiculo_planos_preventivos', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('veiculo_planos_preventivos', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('veiculo_planos_preventivos', 'usuario_id', function (Blueprint $table) {
