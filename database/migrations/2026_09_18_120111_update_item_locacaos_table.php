...
{
    private const REFERENCE_COLUMNS = ['locacao_id' => ['locacaos', 'id', 'cascade', 'restrict'], 'produto_id' => ['produtos', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120111_update_item_locacaos_table';
    private const TABLE_NAME = 'item_locacaos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('item_locacaos');
            $this->preflightColumn('item_locacaos', 'codigo_patrimonio', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('item_locacaos', 'horimetro_inicial', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_locacaos', 'horimetro_final', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('item_locacaos', 'codigo_patrimonio', function (Blueprint $table) {
                return $table->string('codigo_patrimonio', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('item_locacaos', 'horimetro_inicial', function (Blueprint $table) {
                return $table->integer('horimetro_inicial')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_locacaos', 'horimetro_final', function (Blueprint $table) {
                return $table->integer('horimetro_final')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        });
    }
