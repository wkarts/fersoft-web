...
<div class="d-flex flex-column flex-root">
    <div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30">
        ...
        <p class="font-size-h3 text-muted font-weight-normal">OOPS! Erro Interno do Servidor</p>
        <p class="font-size-h6 text-muted font-weight-normal">Algo deu errado. Tente novamente mais tarde.</p>
