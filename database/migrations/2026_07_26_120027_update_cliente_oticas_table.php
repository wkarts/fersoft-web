...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applySafeColumnUpgrade([
            'table' => 'cliente_oticas',
            'column' => 'adicao_od_perto',
            'type' => 'DECIMAL(6, 2)',
            'nullable' => false,
