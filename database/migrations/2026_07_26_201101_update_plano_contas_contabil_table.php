...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('plano_contas_contabil', 'codigo_acesso', 'VARCHAR(10) NOT NULL');
        $this->applyColumnDefinition('plano_contas_contabil', 'classificador', 'VARCHAR(20) NOT NULL');
        $this->applyColumnDefinition('plano_contas_contabil', 'nome', 'VARCHAR(100) NOT NULL');
    }
