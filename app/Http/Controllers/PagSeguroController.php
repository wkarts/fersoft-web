...
use App\Models\PedidoPagSeguro;
...
class PagSeguroController extends Controller
{
	...
	public function efetuaPagamento(Request $request){
		$json = $request->data;
		$rua = env("RUA_PADRAO");
		$numero = env("NUMERO_PADRAO");
		$bairro = env("BAIRRO_PADRAO");
		...
		$data = [
			...
			'shippingAddressPostalCode' => env("CEP_PADRAO"),
			'shippingAddressCity' => env("CIDADE_PADRAO"),
			'shippingAddressState' => env("UF_PADRAO"),
			...
			'billingAddressPostalCode' => env("CEP_PADRAO"),
			'billingAddressCity' => env("CIDADE_PADRAO"),
			'billingAddressState' => env("UF_PADRAO"),
