...
<head>
    ...
    <style type="text/css">
        ...
        /* Image */
       .flex-root .page #kt_aside #kt_brand .brand-logo img{
            width:100% !important;
        }
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    ...
    <a href="/graficos">
        <!-- <img width="100" alt="Logo" src="{{ asset('imgs/slym.png') }}" /> -->
    ...
    jQuery(document).ready(function() {
        ...
        var KTBootstrapDatepicker = function() {
            ...
            var demos = function() {
                ...
                /*
                // Seleciona todos os elementos cujo ID começa com "data_"
                $('[id^="data_"]').datepicker({
                    rtl: KTUtil.isRTL(),
                    todayBtn: 'linked',
                    clearBtn: false,
                ...
                */
                ...
                // Seleciona todos os elementos cujo ID termina com "_date_pick_dynamic"
                $('[id$="_dynamic"]').datepicker({
                    rtl: KTUtil.isRTL(),
                    todayBtn: 'linked',
                    clearBtn: false,
                    format: 'dd/mm/yyyy',
