								...
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-6 col-lg-2">
											<label class="col-form-label">Tipo pizza</label>
											<div class="">
												<select class="form-control" name="tipo_pizza">
													<option @isset($categoria) @if($categoria->tipo_pizza == 0) selected @endif @endif value="0">Não</option>
													<option @isset($categoria) @if($categoria->tipo_pizza == 1) selected @endif @endif value="1">Sim</option>
												</select>
											</div>
										</div>

										<div class="form-group validated col-sm-12 col-lg-7">
											<label class="col-form-label">Descrição</label>
											<div class="">

												<textarea class="form-control @if($errors->has('descricao')) is-invalid @endif" name="descricao" placeholder="Descrição" rows="4">{{{ isset($categoria->descricao) ? $categoria->descricao : old('descricao') }}}</textarea>
