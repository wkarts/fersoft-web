...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120053_update_busca_documento_logs_table';
    private const TABLE_NAME = 'busca_documento_logs';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('busca_documento_logs');
            $this->preflightColumn('busca_documento_logs', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('busca_documento_logs', 'filial_id', function (Blueprint $table) {
