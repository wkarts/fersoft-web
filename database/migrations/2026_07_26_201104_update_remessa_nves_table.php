...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('remessa_nves')) {
            return;
        }

        $this->addForeignIfMissing('remessa_nves', 'remessa_nves_natureza_id_foreign', ['natureza_id'], 'natureza_operacaos', ['id'], null, null);
        $this->addForeignIfMissing('remessa_nves', 'remessa_nves_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
    }
