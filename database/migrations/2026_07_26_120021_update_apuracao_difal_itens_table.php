...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applySafeColumnUpgrade([
            'table' => 'apuracao_difal_itens',
            'column' => 'aliquota_destino',
            'type' => 'DECIMAL(5, 2)',
            'nullable' => false,
        ...
        $this->addIndexIfMissing('apuracao_difal_itens', 'fk_itens_apuracao', ['apuracao_difal_id'], false);

        $this->addForeignIfMissing('apuracao_difal_itens', 'fk_itens_apuracao', 'apuracao_difal_id', 'apuracoes_difal', 'id', 'cascade', null);
    }
