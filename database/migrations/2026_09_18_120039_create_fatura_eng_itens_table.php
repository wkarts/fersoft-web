...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120039_create_fatura_eng_itens_table';
    private const TABLE_NAME = 'fatura_eng_itens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('fatura_eng_itens', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'fatura_eng_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'tipo_item', ['column_type' => 'enum(\'Servico\',\'Locacao\')', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'servico_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'produto_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'quantidade', ['column_type' => 'decimal(10,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'valor_unitario', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'valor_total', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('fatura_eng_itens', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('fatura_eng_itens', 'PRIMARY', ['id'], true);
            $this->preflightIndex('fatura_eng_itens', 'fatura_eng_itens_fatura_eng_id_foreign', ['fatura_eng_id'], false);
            $this->preflightIndex('fatura_eng_itens', 'idx_fatura_eng_itens_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('fatura_eng_itens', 'idx_fatura_eng_itens_filial_id', ['filial_id'], false);
            $this->preflightIndex('fatura_eng_itens', 'idx_fatura_eng_itens_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('fatura_eng_itens', 'fatura_eng_itens_fatura_eng_id_foreign', 'fatura_eng_id', 'faturas_engenharia', 'cascade', 'id', 'restrict');
            $this->preflightForeign('fatura_eng_itens', 'fatura_eng_itens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('fatura_eng_itens', 'fatura_eng_itens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('fatura_eng_itens', 'fatura_eng_itens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('fatura_eng_itens')) {
                if (!$this->beginChange('table', 'fatura_eng_itens', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('fatura_eng_itens', function (Blueprint $table) {
                    ...
                    $table->index('fatura_eng_id', 'fatura_eng_itens_fatura_eng_id_foreign');
                    $table->index('empresa_id', 'idx_fatura_eng_itens_empresa_id');
                    $table->index('filial_id', 'idx_fatura_eng_itens_filial_id');
                    $table->index('usuario_id', 'idx_fatura_eng_itens_usuario_id');
                });
                $this->markCreated('table', 'fatura_eng_itens');
            }

            $this->ensureBaseTenantColumns('fatura_eng_itens');
            $this->ensureColumn('fatura_eng_itens', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('fatura_eng_itens', 'fatura_eng_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('fatura_eng_itens', 'tipo_item', function (Blueprint $table) {
            ...
            $this->ensureColumn('fatura_eng_itens', 'servico_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('fatura_eng_itens', 'produto_id', function (Blueprint $table) {
                return $table->integer('produto_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('fatura_eng_itens', 'quantidade', function (Blueprint $table) {
                return $table->decimal('quantidade', 10, 2)->nullable(false)->default(null);
            ...
            $this->ensureColumn('fatura_eng_itens', 'valor_unitario', function (Blueprint $table) {
            ...
            $this->ensureColumn('fatura_eng_itens', 'valor_total', function (Blueprint $table) {
                return $table->decimal('valor_total', 15, 2)->nullable(false)->default(null);
            }, ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('fatura_eng_itens', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('fatura_eng_itens', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('fatura_eng_itens', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('fatura_eng_itens', 'fatura_eng_itens_fatura_eng_id_foreign', ['fatura_eng_id'], false);
            $this->addIndexIfMissing('fatura_eng_itens', 'idx_fatura_eng_itens_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('fatura_eng_itens', 'idx_fatura_eng_itens_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('fatura_eng_itens', 'idx_fatura_eng_itens_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('fatura_eng_itens', 'fatura_eng_itens_fatura_eng_id_foreign', 'fatura_eng_id', 'faturas_engenharia', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('fatura_eng_itens', 'fatura_eng_itens_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('fatura_eng_itens', 'fatura_eng_itens_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('fatura_eng_itens', 'fatura_eng_itens_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('fatura_eng_itens', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('fatura_eng_itens', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('fatura_eng_itens', 'usuario_id', function (Blueprint $table) {
