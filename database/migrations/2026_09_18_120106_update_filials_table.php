...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120106_update_filials_table';
    private const TABLE_NAME = 'filials';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('filials');
            $this->preflightColumn('filials', 'latitude', ['column_type' => 'decimal(10,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('filials', 'longitude', ['column_type' => 'decimal(11,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('filials', 'latitude', function (Blueprint $table) {
            ...
            $this->ensureColumn('filials', 'longitude', function (Blueprint $table) {
