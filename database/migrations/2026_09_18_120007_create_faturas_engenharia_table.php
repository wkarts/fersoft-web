...
{
    private const REFERENCE_COLUMNS = ['municipio_prestacao_id' => ['cidades', 'id', 'set null', 'cascade'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'set null', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120007_create_faturas_engenharia_table';
    private const TABLE_NAME = 'faturas_engenharia';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('faturas_engenharia', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'contrato_eng_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'cliente_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'vendedor_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'condicao_pagamento_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'categoria_conta_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'valor_total', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'valor_retencao', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'valor_liquido', ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'data_faturamento', ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'observacao', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'status', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => 'Pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'numero_nfse', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'serie_nfse', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'chave_nfse', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'protocolo_nfse', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'xml_nfse', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'status_financeiro', ['column_type' => 'varchar(30)', 'nullable' => false, 'column_default' => 'Pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'observacoes_fatura', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'codigo_obra', ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Número da Obra, ART ou CIB']);
            $this->preflightColumn('faturas_engenharia', 'municipio_prestacao_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('faturas_engenharia', 'servico_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'FK para a tabela servicos']);
            $this->preflightIndex('faturas_engenharia', 'PRIMARY', ['id'], true);
            $this->preflightIndex('faturas_engenharia', 'fk_faturas_cidade_prestacao', ['municipio_prestacao_id'], false);
            $this->preflightIndex('faturas_engenharia', 'idx_faturas_engenharia_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('faturas_engenharia', 'idx_faturas_engenharia_filial_id', ['filial_id'], false);
            $this->preflightIndex('faturas_engenharia', 'idx_faturas_engenharia_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('faturas_engenharia', 'fk_faturas_cidade_prestacao', 'municipio_prestacao_id', 'cidades', 'set null', 'id', 'cascade');
            $this->preflightForeign('faturas_engenharia', 'faturas_engenharia_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('faturas_engenharia', 'faturas_engenharia_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('faturas_engenharia', 'faturas_engenharia_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('faturas_engenharia')) {
                if (!$this->beginChange('table', 'faturas_engenharia', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('faturas_engenharia', function (Blueprint $table) {
                    ...
                    $table->integer('contrato_eng_id')->nullable();
                    $table->integer('cliente_id')->nullable();
                    $table->integer('vendedor_id')->nullable();
                    $table->integer('condicao_pagamento_id')->nullable();
                    $table->integer('categoria_conta_id')->nullable();
                    $table->decimal('valor_total', 15, 2);
                    $table->decimal('valor_retencao', 15, 2)->default('0.00');
                    $table->decimal('valor_liquido', 15, 2);
                    $table->date('data_faturamento');
                    $table->text('observacao')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('status', 50)->nullable()->default('Pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('numero_nfse', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('serie_nfse', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('chave_nfse', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('protocolo_nfse', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->longText('xml_nfse')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('status_financeiro', 30)->default('Pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('observacoes_fatura')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('codigo_obra', 30)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Número da Obra, ART ou CIB');
                    $table->unsignedInteger('municipio_prestacao_id')->nullable();
                    $table->unsignedBigInteger('servico_id')->nullable()->comment('FK para a tabela servicos');
                    $table->timestamps();

                    $table->index('municipio_prestacao_id', 'fk_faturas_cidade_prestacao');
                    $table->index('empresa_id', 'idx_faturas_engenharia_empresa_id');
                    $table->index('filial_id', 'idx_faturas_engenharia_filial_id');
                    $table->index('usuario_id', 'idx_faturas_engenharia_usuario_id');
                });
                $this->markCreated('table', 'faturas_engenharia');
            }

            $this->ensureBaseTenantColumns('faturas_engenharia');
            $this->ensureColumn('faturas_engenharia', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('faturas_engenharia', 'contrato_eng_id', function (Blueprint $table) {
                return $table->integer('contrato_eng_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'cliente_id', function (Blueprint $table) {
                return $table->integer('cliente_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'vendedor_id', function (Blueprint $table) {
                return $table->integer('vendedor_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'condicao_pagamento_id', function (Blueprint $table) {
                return $table->integer('condicao_pagamento_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'categoria_conta_id', function (Blueprint $table) {
                return $table->integer('categoria_conta_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'valor_total', function (Blueprint $table) {
                return $table->decimal('valor_total', 15, 2)->nullable(false)->default(null);
            }, ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'valor_retencao', function (Blueprint $table) {
                return $table->decimal('valor_retencao', 15, 2)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'valor_liquido', function (Blueprint $table) {
                return $table->decimal('valor_liquido', 15, 2)->nullable(false)->default(null);
            }, ['column_type' => 'decimal(15,2)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'data_faturamento', function (Blueprint $table) {
                return $table->date('data_faturamento')->nullable(false)->default(null);
            }, ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'observacao', function (Blueprint $table) {
            ...
            $this->ensureColumn('faturas_engenharia', 'status', function (Blueprint $table) {
                return $table->string('status', 50)->nullable()->default('Pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => 'Pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'numero_nfse', function (Blueprint $table) {
                return $table->string('numero_nfse', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('faturas_engenharia', 'serie_nfse', function (Blueprint $table) {
                return $table->string('serie_nfse', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('faturas_engenharia', 'chave_nfse', function (Blueprint $table) {
                return $table->string('chave_nfse', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'protocolo_nfse', function (Blueprint $table) {
                return $table->string('protocolo_nfse', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'xml_nfse', function (Blueprint $table) {
                return $table->longText('xml_nfse')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('faturas_engenharia', 'status_financeiro', function (Blueprint $table) {
                return $table->string('status_financeiro', 30)->nullable(false)->default('Pendente')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(30)', 'nullable' => false, 'column_default' => 'Pendente', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'observacoes_fatura', function (Blueprint $table) {
                return $table->text('observacoes_fatura')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('faturas_engenharia', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('faturas_engenharia', 'codigo_obra', function (Blueprint $table) {
                return $table->string('codigo_obra', 30)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Número da Obra, ART ou CIB');
            }, ['column_type' => 'varchar(30)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Número da Obra, ART ou CIB']);
            $this->ensureColumn('faturas_engenharia', 'municipio_prestacao_id', function (Blueprint $table) {
                return $table->unsignedInteger('municipio_prestacao_id')->nullable()->default(null);
            ...
            $this->ensureColumn('faturas_engenharia', 'servico_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('servico_id')->nullable()->default(null)->comment('FK para a tabela servicos');
            }, ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'FK para a tabela servicos']);
            $this->addIndexIfMissing('faturas_engenharia', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('faturas_engenharia', 'fk_faturas_cidade_prestacao', ['municipio_prestacao_id'], false);
            $this->addIndexIfMissing('faturas_engenharia', 'idx_faturas_engenharia_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('faturas_engenharia', 'idx_faturas_engenharia_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('faturas_engenharia', 'idx_faturas_engenharia_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('faturas_engenharia', 'fk_faturas_cidade_prestacao', 'municipio_prestacao_id', 'cidades', 'set null', 'id', 'cascade');
            $this->addForeignIfMissing('faturas_engenharia', 'faturas_engenharia_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('faturas_engenharia', 'faturas_engenharia_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('faturas_engenharia', 'faturas_engenharia_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('faturas_engenharia', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('faturas_engenharia', 'filial_id', function (Blueprint $table) {
            return $table->unsignedInteger('filial_id')->nullable()->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('faturas_engenharia', 'usuario_id', function (Blueprint $table) {
