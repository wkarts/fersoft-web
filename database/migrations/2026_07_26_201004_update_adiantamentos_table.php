...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('adiantamentos', 'adiantamentos_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
        $this->addForeignIfMissing('adiantamentos', 'adiantamentos_fornecedor_id_foreign', ['fornecedor_id'], 'fornecedors', ['id'], 'set null', null);
    }
