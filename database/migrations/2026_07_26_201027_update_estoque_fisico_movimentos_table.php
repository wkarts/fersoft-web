...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('estoque_fisico_movimentos', 'filial_id', 'INT UNSIGNED DEFAULT NULL COMMENT \'NULL representa a Matriz\'');
        $this->applyColumnDefinition('estoque_fisico_movimentos', 'usuario_id', 'INT UNSIGNED DEFAULT NULL');
