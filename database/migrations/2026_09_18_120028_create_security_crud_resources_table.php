...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120028_create_security_crud_resources_table';
    private const TABLE_NAME = 'security_crud_resources';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('security_crud_resources', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'module', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => 'Geral', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'technical_name', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'display_name', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'plural_display_name', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'description', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'model_class', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'controller_class', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'route_prefix', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'table_name', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'icon', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'sensitive', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'tenant_visible', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'super_admin_only', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'base_model_detected', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'base_controller_detected', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'source', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => 'auto', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'actions', ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_resources', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('security_crud_resources', 'PRIMARY', ['id'], true);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_model_class_unique', ['model_class'], true);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_module_index', ['module'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_technical_name_index', ['technical_name'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_display_name_index', ['display_name'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_controller_class_index', ['controller_class'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_route_prefix_index', ['route_prefix'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_table_name_index', ['table_name'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_sensitive_index', ['sensitive'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_tenant_visible_index', ['tenant_visible'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_super_admin_only_index', ['super_admin_only'], false);
            $this->preflightIndex('security_crud_resources', 'security_crud_resources_enabled_index', ['enabled'], false);
            $this->preflightIndex('security_crud_resources', 'idx_security_crud_resources_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('security_crud_resources', 'idx_security_crud_resources_filial_id', ['filial_id'], false);
            $this->preflightIndex('security_crud_resources', 'idx_security_crud_resources_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('security_crud_resources', 'security_crud_resources_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('security_crud_resources', 'security_crud_resources_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('security_crud_resources', 'security_crud_resources_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('security_crud_resources')) {
                if (!$this->beginChange('table', 'security_crud_resources', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('security_crud_resources', function (Blueprint $table) {
                    ...
                    $table->string('module', 255)->default('Geral')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('technical_name', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('display_name', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('plural_display_name', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('description')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('model_class', 255)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('controller_class', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('route_prefix', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('table_name', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('icon', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->tinyInteger('sensitive')->default('0');
                    $table->tinyInteger('tenant_visible')->default('1');
                    $table->tinyInteger('super_admin_only')->default('0');
                    $table->tinyInteger('base_model_detected')->default('0');
                    $table->tinyInteger('base_controller_detected')->default('0');
                    $table->string('source', 255)->default('auto')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->json('actions')->nullable();
                    $table->tinyInteger('enabled')->default('1');
                    $table->timestamp('deleted_at')->nullable();
                    $table->timestamps();

                    $table->unique('model_class', 'security_crud_resources_model_class_unique');
                    $table->index('module', 'security_crud_resources_module_index');
                    $table->index('technical_name', 'security_crud_resources_technical_name_index');
                    $table->index('display_name', 'security_crud_resources_display_name_index');
                    $table->index('controller_class', 'security_crud_resources_controller_class_index');
                    $table->index('route_prefix', 'security_crud_resources_route_prefix_index');
                    $table->index('table_name', 'security_crud_resources_table_name_index');
                    $table->index('sensitive', 'security_crud_resources_sensitive_index');
                    $table->index('tenant_visible', 'security_crud_resources_tenant_visible_index');
                    $table->index('super_admin_only', 'security_crud_resources_super_admin_only_index');
                    $table->index('enabled', 'security_crud_resources_enabled_index');
                    $table->index('empresa_id', 'idx_security_crud_resources_empresa_id');
                    $table->index('filial_id', 'idx_security_crud_resources_filial_id');
                    $table->index('usuario_id', 'idx_security_crud_resources_usuario_id');
                });
                $this->markCreated('table', 'security_crud_resources');
            }

            $this->ensureBaseTenantColumns('security_crud_resources');
            $this->ensureColumn('security_crud_resources', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_crud_resources', 'module', function (Blueprint $table) {
                return $table->string('module', 255)->nullable(false)->default('Geral')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => 'Geral', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'technical_name', function (Blueprint $table) {
                return $table->string('technical_name', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('security_crud_resources', 'display_name', function (Blueprint $table) {
                return $table->string('display_name', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'plural_display_name', function (Blueprint $table) {
                return $table->string('plural_display_name', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('security_crud_resources', 'description', function (Blueprint $table) {
                return $table->text('description')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('security_crud_resources', 'model_class', function (Blueprint $table) {
                return $table->string('model_class', 255)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'controller_class', function (Blueprint $table) {
                return $table->string('controller_class', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'route_prefix', function (Blueprint $table) {
                return $table->string('route_prefix', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'table_name', function (Blueprint $table) {
                return $table->string('table_name', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'icon', function (Blueprint $table) {
                return $table->string('icon', 255)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'sensitive', function (Blueprint $table) {
                return $table->tinyInteger('sensitive')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'tenant_visible', function (Blueprint $table) {
                return $table->tinyInteger('tenant_visible')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'super_admin_only', function (Blueprint $table) {
                return $table->tinyInteger('super_admin_only')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'base_model_detected', function (Blueprint $table) {
                return $table->tinyInteger('base_model_detected')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'base_controller_detected', function (Blueprint $table) {
                return $table->tinyInteger('base_controller_detected')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'source', function (Blueprint $table) {
                return $table->string('source', 255)->nullable(false)->default('auto')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => 'auto', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'actions', function (Blueprint $table) {
                return $table->json('actions')->nullable()->default(null);
            }, ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'enabled', function (Blueprint $table) {
                return $table->tinyInteger('enabled')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_crud_resources', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_resources', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('security_crud_resources', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_model_class_unique', ['model_class'], true);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_module_index', ['module'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_technical_name_index', ['technical_name'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_display_name_index', ['display_name'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_controller_class_index', ['controller_class'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_route_prefix_index', ['route_prefix'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_table_name_index', ['table_name'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_sensitive_index', ['sensitive'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_tenant_visible_index', ['tenant_visible'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_super_admin_only_index', ['super_admin_only'], false);
            $this->addIndexIfMissing('security_crud_resources', 'security_crud_resources_enabled_index', ['enabled'], false);
            $this->addIndexIfMissing('security_crud_resources', 'idx_security_crud_resources_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('security_crud_resources', 'idx_security_crud_resources_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('security_crud_resources', 'idx_security_crud_resources_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('security_crud_resources', 'security_crud_resources_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('security_crud_resources', 'security_crud_resources_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('security_crud_resources', 'security_crud_resources_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('security_crud_resources', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_crud_resources', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_crud_resources', 'usuario_id', function (Blueprint $table) {
