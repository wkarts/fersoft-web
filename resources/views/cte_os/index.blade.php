...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/cteos/filtro">
						...
						<div class="">
							<div class="input-group date">
								<select class="custom-select form-control" id="estado" name="estado">
									<option @if(isset($estado) && $estado == 'DISPONIVEL') selected @endif value="NOVO">DISPONIVEIS</option>
			...
			<br>
			<h4 class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">Lista de CTe OS</h4>

			<label class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">Registros: <strong class="text-success">{{sizeof($ctes)}}</strong></label>
			<div class="row @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
				<div class="form-group col-lg-3 col-md-4 col-sm-6">
					<a href="/cteos/nova" class="btn btn-success">
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
										<div class="row">
													...
													<table class="datatable-table" style="max-width: 100%; overflow: scroll">
														<thead class="datatable-head">
															<tr class="datatable-row" style="left: 0px;">
																...
																<th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 150px;">Emitente</span></th>
														...
														<tbody id="body" class="datatable-body">
															...
															<tr class="datatable-row">
																...
																<td style="display: none" id="numero_emissao">{{$c->numero_emissao}}</td>

																<td style="display: none" id="estado_{{$c->id}}">{{$c->estado}}</td>
																
																<td class="datatable-cell">
																	<span class="codigo" style="width: 150px;">
																		{{$c->emitente->razao_social}}
																	</span>
																</td>
																<td class="datatable-cell">
																	<span class="codigo" style="width: 150px;">
																		{{$c->tomador_cli->razao_social}}
																	</span>
																</td>
																<td class="datatable-cell">
																...
																<td class="datatable-cell">
																	<span class="codigo" style="width: 100px;">
																		{{$c->numero_emissao > 0 ? $c->numero_emissao : '-' }}
																	</span>
																</td>
																...
																<td>
																	<div class="row">
																		<span style="width: 280px;">
																			...
																			<a class="btn btn-danger btn-sm" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/cteos/delete/{{ $c->id }}" }else{return false} })' href="#!">
																				<i class="la la-trash"></i>				
																			</a>

																			<a class="btn btn-warning btn-sm" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/cteos/edit/{{ $c->id }}" }else{return false} })' href="#!">
																				<i class="la la-edit"></i>	
																			</a>
																			@endif

																			<a class="btn btn-info btn-sm" href="/cteos/detalhar/{{ $c->id }}">
																				<i class="la la-file"></i>
																			</a>

																			@if($c->estado == 'APROVADO')
																			<a class="btn btn-light btn-sm" href="/cteos/download/{{ $c->id }}">
											...
											@if($certificado != null)
											<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12 mt-3">
												<div class="row">
												...
												<div class="row" style="margin-top: 5px;">
													...
													<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
														<a onclick="dacteTemp()" style="width: 100%" class="btn btn-primary" href="#!">Dacte temporário</a>
													</div>
												</div>
											</div>
											@else
													...
													<div class="card-header">
														<div class="card-title">
															<h3 style="width: 230px; font-size: 15px; height: 10px;" class="card-title">
																...
																{{$c->emitente->razao_social}}/{{$c->tomador_cli->razao_social}}
															...
															<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Ações">
																...
																<div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
																	...
																	<ul class="navi navi-hover">
																		...
																		<li class="navi-item">
																			<a onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/cteos/delete/{{ $c->id }}" }else{return false} })' href="#!" class="navi-link">
																		...
																		<li class="navi-item">
																			<a onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/cteos/edit/{{ $c->id }}" }else{return false} })' href="#!" class="navi-link">
																				<span class="navi-text">
																		...
																		<li class="navi-item">
																			<a href="/cteos/detalhar/{{ $c->id }}" class="navi-link">
																				<span class="navi-text">
													...
													<div class="card-body">
														...
														<div class="row">
															...
															<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
																<a style="width: 100%; margin-top: 5px;" target="_blank" href="/cteos/imprimir/{{$c->id}}" class="btn btn-success">
															...
															<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
																<a style="width: 100%; margin-top: 5px;" target="_blank" href="/cteos/imprimirCCe/{{$c->id}}" class="btn btn-warning">
																	<i class="la la-print"></i>
																	Imprimir CC-e
																</a>
															</div>
															...
															<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
																<a id="btn_consulta_grid_{{$c->id}}" style="width: 100%; margin-top: 5px;" href="#!" onclick="cancelarCTe('{{$c->id}}', '{{$c->numero_emissao}}')" class="btn btn-danger spinner-white spinner-right">
																	<i class="la la-check"></i>
																	Cancelar CTe
																</a>
															</div>
															...
															<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
																<a style="width: 100%; margin-top: 5px;" href="#!" onclick="corrigirCTe('{{$c->id}}', '{{$c->numero_emissao}}')" class="btn btn-warning spinner-white spinner-right">
																	<i class="la la-check"></i>
																	Corrigir CTe
																</a>
															</div>
															...
															<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
																<a style="width: 100%; margin-top: 5px;" target="_blank" href="/cteos/baixarXml/{{$c->id}}" class="btn btn-danger">
																	<i class="la la-download"></i>
																	Baixar XML
																</a>
															</div>
															...
															<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
																<a style="width: 100%; margin-top: 5px;" target="_blank" href="/cteos/imprimirCancela/{{$c->id}}" class="btn btn-danger">
																	<i class="la la-print"></i>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">CANCELAR CTe OS <strong class="text-danger" id="numero_cancelamento"></strong></h5>
...
<div class="modal fade" id="modal5" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">ENVIAR XML DA CTe OS<strong class="text-danger" id="numero_email"></strong></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					x
				</button>
			</div>
...
@endsection	
@section('javascript')
<script type="text/javascript" src="/js/cte_os_envio.js"></script>	
@endsection	