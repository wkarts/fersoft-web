...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120025_create_security_authorizers_table';
    private const TABLE_NAME = 'security_authorizers';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('security_authorizers', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'can_authorize_all_resources', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'can_authorize_view', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'can_authorize_create', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'can_authorize_edit', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'can_authorize_delete', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'can_authorize_restore', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'can_authorize_export', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'can_authorize_print', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'operation_otp_secret', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'operation_otp_enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'operation_otp_confirmed_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'operation_otp_last_used_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_authorizers', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('security_authorizers', 'PRIMARY', ['id'], true);
            $this->preflightIndex('security_authorizers', 'sec_authorizers_emp_user_unique', ['empresa_id', 'usuario_id'], true);
            $this->preflightIndex('security_authorizers', 'security_authorizers_enabled_index', ['enabled'], false);
            $this->preflightIndex('security_authorizers', 'idx_security_authorizers_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('security_authorizers', 'idx_security_authorizers_filial_id', ['filial_id'], false);
            $this->preflightIndex('security_authorizers', 'idx_security_authorizers_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('security_authorizers', 'security_authorizers_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('security_authorizers', 'security_authorizers_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('security_authorizers', 'security_authorizers_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('security_authorizers')) {
                if (!$this->beginChange('table', 'security_authorizers', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('security_authorizers', function (Blueprint $table) {
                    ...
                    $table->tinyInteger('can_authorize_all_resources')->default('0');
                    $table->tinyInteger('can_authorize_view')->default('0');
                    $table->tinyInteger('can_authorize_create')->default('0');
                    $table->tinyInteger('can_authorize_edit')->default('0');
                    $table->tinyInteger('can_authorize_delete')->default('0');
                    $table->tinyInteger('can_authorize_restore')->default('0');
                    $table->tinyInteger('can_authorize_export')->default('0');
                    $table->tinyInteger('can_authorize_print')->default('0');
                    $table->text('operation_otp_secret')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->tinyInteger('operation_otp_enabled')->default('0');
                    $table->timestamp('operation_otp_confirmed_at')->nullable();
                    $table->timestamp('operation_otp_last_used_at')->nullable();
                    $table->timestamp('deleted_at')->nullable();
                    $table->timestamps();

                    $table->unique(['empresa_id', 'usuario_id'], 'sec_authorizers_emp_user_unique');
                    $table->index('enabled', 'security_authorizers_enabled_index');
                    $table->index('empresa_id', 'idx_security_authorizers_empresa_id');
                    $table->index('filial_id', 'idx_security_authorizers_filial_id');
                    $table->index('usuario_id', 'idx_security_authorizers_usuario_id');
                });
                $this->markCreated('table', 'security_authorizers');
            }

            $this->ensureBaseTenantColumns('security_authorizers');
            $this->ensureColumn('security_authorizers', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_authorizers', 'enabled', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_authorizers', 'can_authorize_all_resources', function (Blueprint $table) {
                return $table->tinyInteger('can_authorize_all_resources')->nullable(false)->default('0');
            ...
            $this->ensureColumn('security_authorizers', 'can_authorize_view', function (Blueprint $table) {
                return $table->tinyInteger('can_authorize_view')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'can_authorize_create', function (Blueprint $table) {
                return $table->tinyInteger('can_authorize_create')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'can_authorize_edit', function (Blueprint $table) {
                return $table->tinyInteger('can_authorize_edit')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'can_authorize_delete', function (Blueprint $table) {
                return $table->tinyInteger('can_authorize_delete')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'can_authorize_restore', function (Blueprint $table) {
                return $table->tinyInteger('can_authorize_restore')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'can_authorize_export', function (Blueprint $table) {
                return $table->tinyInteger('can_authorize_export')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'can_authorize_print', function (Blueprint $table) {
                return $table->tinyInteger('can_authorize_print')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'operation_otp_secret', function (Blueprint $table) {
                return $table->text('operation_otp_secret')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('security_authorizers', 'operation_otp_enabled', function (Blueprint $table) {
                return $table->tinyInteger('operation_otp_enabled')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'operation_otp_confirmed_at', function (Blueprint $table) {
                return $table->timestamp('operation_otp_confirmed_at')->nullable()->default(null);
            ...
            $this->ensureColumn('security_authorizers', 'operation_otp_last_used_at', function (Blueprint $table) {
                return $table->timestamp('operation_otp_last_used_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'created_at', function (Blueprint $table) {
                return $table->timestamp('created_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_authorizers', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('security_authorizers', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('security_authorizers', 'sec_authorizers_emp_user_unique', ['empresa_id', 'usuario_id'], true);
            $this->addIndexIfMissing('security_authorizers', 'security_authorizers_enabled_index', ['enabled'], false);
            $this->addIndexIfMissing('security_authorizers', 'idx_security_authorizers_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('security_authorizers', 'idx_security_authorizers_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('security_authorizers', 'idx_security_authorizers_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('security_authorizers', 'security_authorizers_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('security_authorizers', 'security_authorizers_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('security_authorizers', 'security_authorizers_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('security_authorizers', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_authorizers', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_authorizers', 'usuario_id', function (Blueprint $table) {
