                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control select2 @if($errors->has('cliente_id')) is-invalid @endif" id="kt_select2_3" name="cliente_id">
                                                            ...
                                                            @foreach($clientes as $c)
                                                                <option
                                                                    @if(isset($conta) && $conta->cliente_id != null && $conta->cliente_id == $c->id)
                                                                        selected
                                                                    @endif
                                            ...
                                            <div class="form-group validated col-lg-3 col-md-4 col-sm-6">
                                                ...
                                                <select class="custom-select form-control @if($errors->has('categoria_id')) is-invalid @endif" id="categoria_id" name="categoria_id">
                                                    @foreach($categorias as $cat)
                                                        <option value="{{$cat->id}}" @isset($conta) @if($cat->id == $conta->categoria_id) selected @endif @endisset>{{$cat->nome}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group validated col-lg-2 col-md-4 col-sm-6">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" name="data_emissao" class="form-control date-input"
                                                           value="{{{ isset($conta) ? ($conta->nf_data_emissao ? \Carbon\Carbon::parse($conta->nf_data_emissao)->format('d/m/Y') : date('d/m/Y')) : old('data_emissao', date('d/m/Y')) }}}"
                                                           id="kt_datepicker_emissao" />
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i class="la la-calendar"></i></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group validated col-lg-2 col-md-4 col-sm-6">
                                                ...
                                                <input type="text" id="valor" class="form-control @if($errors->has('valor')) is-invalid @endif money" name="valor" value="{{{ isset($conta) ? number_format($conta->valor_integral, $casasDecimais ?? 2, ',', '.') : old('valor') }}}">
                                                @if($errors->has('valor'))
                                                    <div class="invalid-feedback">
                                                        {{ $errors->first('valor') }}
                                                    </div>
                                            ...
                                            {{-- CAMPO NÚMERO DA NOTA FISCAL (GRAVA EM NUMERO_NOTA_FISCAL E NF_NUMERO) --}}
                                            <div class="form-group validated col-lg-2 col-md-4 col-sm-6">
                                                <label class="col-form-label">Nº nota fiscal</label>
                                                <input id="numero_nota_fiscal" type="text" class="form-control @if($errors->has('numero_nota_fiscal')) is-invalid @endif" name="numero_nota_fiscal" value="{{{ isset($conta) ? ($conta->numero_nota_fiscal > 0 ? $conta->numero_nota_fiscal : $conta->nf_numero) : old('numero_nota_fiscal') }}}">
                                            ...
                                            @if(!isset($conta))
                                                <div class="form-group col-lg-2 col-md-9 col-sm-12">
                                                    ...
                                                    <div class="col-lg-12 col-xl-12">
                                                        <span class="switch switch-outline switch-success">
                                                            <label>
                                                                <input @if(isset($conta) && $conta->status) checked @endif type="checkbox" id="recebido" name="status">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group col-lg-2 col-md-4 col-sm-6 div-recebido" style="display: none">
                                                    <label class="col-form-label">Data de Recebimento</label>
                                                    <div class="input-group date">
                                                        <input type="text" name="data_recebimento" class="form-control date-input" value="{{ date('d/m/Y') }}" id="kt_datepicker_recebimento" />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i class="la la-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group validated col-lg-2 col-md-4 col-sm-6 div-recebido" style="display: none">
                                                    ...
                                                    <input id="valor_recebido" type="text" class="form-control @if($errors->has('valor_recebido')) is-invalid @endif money" name="valor_recebido" value="{{{ isset($conta) ? number_format($conta->valor_integral, $casasDecimais ?? 2, ',', '.') : old('valor_recebido') }}}">
                                        ...
                                        @if(!isset($conta))
                                            <div class="row">
                                                <div class="form-group validated col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    @endif
                                                    <p style="color: red; margin-top: 5px;"> *Este campo deve ser preenchido se houver recorrência para este registro</p>
                                                </div>
                                            </div>
                                        @endif
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                                    ...
                                    <div class="form-group validated col-lg-4 col-md-6 col-sm-10">
                                        ...
                                        <select style="width: 100%" class="form-control select2" id="kt_select2_4">
                                            @foreach(App\Models\Cidade::all() as $c)
                                                <option @if($cidade && $cidade->id == $c->id) selected @endif value="{{$c->id}}">
                                                    {{$c->nome}} ({{$c->uf}})
                                                </option>
                                            @endforeach
                                        </select>
                    ...
                    <div class="modal-footer">
                        <button type="button" id="btn-frete" class="btn btn-danger font-weight-bold" data-dismiss="modal">Fechar</button>
                        <button type="button" onclick="salvarCliente()" class="btn btn-success font-weight-bold">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function montaHtml(meses, vencimento, ultimoDia, dia){
            ...
            for(let i=0; i<=meses; i++){
                ...
                if(i > 0){
                    ...
                    html += '<tr>'
                    html += '<td><input value="'+data+'" type="date" class="form-control dt"></td>'
                    html += '<td><input value="'+valor+'" type="text" class="form-control valor"></td>'
                    html += '</tr>'
        ...
        function salvarCliente(){
            ...
            if(js.razao_social == ''){
                ...
                swal({
                    title: "Cuidado",
                    text: "Ao salvar o cliente com os dados incompletos não será possível emitir NFe até que edite o seu cadastro?",
                    icon: "warning",
                    ...
                    if (v) {
                        ...
                        $.post(path + 'clientes/quickSave', { _token: token, data: js })
                            .done((res) =>{
                                CLIENTE = res;
                                limparCamposCliente()
                                $('#kt_select2_3').append('<option value="'+res.id+'">'+res.razao_social+'</option>').change();
                                $('#kt_select2_3').val(res.id).change();
                                swal("Sucesso", "Cliente adicionado!!", 'success').then(() => {
