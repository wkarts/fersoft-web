...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120010_create_grupo_categorias_table';
    private const TABLE_NAME = 'grupo_categorias';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('grupo_categorias', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('grupo_categorias', 'nome', ['column_type' => 'varchar(100)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('grupo_categorias', 'descricao', ['column_type' => 'varchar(255)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('grupo_categorias', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('grupo_categorias', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('grupo_categorias', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('grupo_categorias', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('grupo_categorias', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('grupo_categorias', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('grupo_categorias', 'PRIMARY', ['id'], true);
            $this->preflightIndex('grupo_categorias', 'idx_grupo_categorias_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('grupo_categorias', 'idx_grupo_categorias_filial_id', ['filial_id'], false);
            $this->preflightIndex('grupo_categorias', 'idx_grupo_categorias_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('grupo_categorias', 'grupo_categorias_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('grupo_categorias', 'grupo_categorias_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('grupo_categorias', 'grupo_categorias_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('grupo_categorias')) {
                if (!$this->beginChange('table', 'grupo_categorias', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('grupo_categorias', function (Blueprint $table) {
                    ...
                    $table->index('empresa_id', 'idx_grupo_categorias_empresa_id');
                    $table->index('filial_id', 'idx_grupo_categorias_filial_id');
                    $table->index('usuario_id', 'idx_grupo_categorias_usuario_id');
                });
                $this->markCreated('table', 'grupo_categorias');
            }

            $this->ensureBaseTenantColumns('grupo_categorias');
            $this->ensureColumn('grupo_categorias', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('grupo_categorias', 'nome', function (Blueprint $table) {
            ...
            $this->ensureColumn('grupo_categorias', 'descricao', function (Blueprint $table) {
            ...
            $this->ensureColumn('grupo_categorias', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('grupo_categorias', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('grupo_categorias', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('grupo_categorias', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('grupo_categorias', 'idx_grupo_categorias_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('grupo_categorias', 'idx_grupo_categorias_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('grupo_categorias', 'idx_grupo_categorias_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('grupo_categorias', 'grupo_categorias_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('grupo_categorias', 'grupo_categorias_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('grupo_categorias', 'grupo_categorias_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('grupo_categorias', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('grupo_categorias', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('grupo_categorias', 'usuario_id', function (Blueprint $table) {
