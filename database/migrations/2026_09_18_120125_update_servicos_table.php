...
{
    private const REFERENCE_COLUMNS = ['categoria_id' => ['categoria_servicos', 'id', 'restrict', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120125_update_servicos_table';
    private const TABLE_NAME = 'servicos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('servicos');
            $this->preflightColumn('servicos', 'codigo_tributacao_nacional', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Código do Serviço na LC 116 ou NBS']);
            $this->preflightColumn('servicos', 'codigo_nbs', ['column_type' => 'varchar(15)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Código NBS - Nomenclatura Brasileira de Serviços']);
            $this->preflightColumn('servicos', 'codigo_tributacao_municipio', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Código do Serviço na Prefeitura']);
            $this->preflightColumn('servicos', 'cst_ibscbs', ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'CST do IBS/CBS (Reforma Tributária)']);
            $this->preflightColumn('servicos', 'aliquota_ibs', ['column_type' => 'decimal(5,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'Alíquota do IBS (%)']);
            $this->preflightColumn('servicos', 'aliquota_cbs', ['column_type' => 'decimal(5,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'Alíquota da CBS (%)']);
            $this->preflightColumn('servicos', 'codigo_class_trib', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Código de Classificação Tributária IBS/CBS']);
            $this->preflightColumn('servicos', 'exige_obra', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'Indica se o serviço exige Código de Obra/ART (1=Sim, 0=Não)']);

            $this->ensureColumn('servicos', 'codigo_tributacao_nacional', function (Blueprint $table) {
                return $table->string('codigo_tributacao_nacional', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Código do Serviço na LC 116 ou NBS');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Código do Serviço na LC 116 ou NBS']);
            $this->ensureColumn('servicos', 'codigo_nbs', function (Blueprint $table) {
                return $table->string('codigo_nbs', 15)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Código NBS - Nomenclatura Brasileira de Serviços');
            }, ['column_type' => 'varchar(15)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Código NBS - Nomenclatura Brasileira de Serviços']);
            $this->ensureColumn('servicos', 'codigo_tributacao_municipio', function (Blueprint $table) {
                return $table->string('codigo_tributacao_municipio', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Código do Serviço na Prefeitura');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Código do Serviço na Prefeitura']);
            $this->ensureColumn('servicos', 'cst_ibscbs', function (Blueprint $table) {
                return $table->string('cst_ibscbs', 5)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('CST do IBS/CBS (Reforma Tributária)');
            }, ['column_type' => 'varchar(5)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'CST do IBS/CBS (Reforma Tributária)']);
            $this->ensureColumn('servicos', 'aliquota_ibs', function (Blueprint $table) {
                return $table->decimal('aliquota_ibs', 5, 2)->nullable()->default('0.00')->comment('Alíquota do IBS (%)');
            }, ['column_type' => 'decimal(5,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'Alíquota do IBS (%)']);
            $this->ensureColumn('servicos', 'aliquota_cbs', function (Blueprint $table) {
                return $table->decimal('aliquota_cbs', 5, 2)->nullable()->default('0.00')->comment('Alíquota da CBS (%)');
            }, ['column_type' => 'decimal(5,2)', 'nullable' => true, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'Alíquota da CBS (%)']);
            $this->ensureColumn('servicos', 'codigo_class_trib', function (Blueprint $table) {
                return $table->string('codigo_class_trib', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Código de Classificação Tributária IBS/CBS');
            }, ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Código de Classificação Tributária IBS/CBS']);
            $this->ensureColumn('servicos', 'exige_obra', function (Blueprint $table) {
                return $table->tinyInteger('exige_obra')->nullable(false)->default('0')->comment('Indica se o serviço exige Código de Obra/ART (1=Sim, 0=Não)');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => 'Indica se o serviço exige Código de Obra/ART (1=Sim, 0=Não)']);
        });
    }
