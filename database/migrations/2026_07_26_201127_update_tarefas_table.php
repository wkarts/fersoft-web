...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureNullableAndComment('tarefas', 'filial_id', true, null);
        $this->ensureNullableAndComment('tarefas', 'descricao', true, null);
        $this->ensureNullableAndComment('tarefas', 'prioridade', true, null);
        $this->ensureNullableAndComment('tarefas', 'status', true, 'pendente, em_andamento, concluida');
        $this->ensureNullableAndComment('tarefas', 'justificativa_atraso', true, null);
        $this->ensureNullableAndComment('tarefas', 'frequencia', true, 'diario, semanal, mensal');
    }
