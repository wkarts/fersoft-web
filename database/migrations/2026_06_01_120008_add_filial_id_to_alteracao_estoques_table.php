...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('alteracao_estoques')) { return; }
        ...
        $this->addIndexIfMissing('alteracao_estoques', 'idx_alteracao_estoques_filial_id', ['filial_id']);
    }

    public function down()
    {
        if (!Schema::hasTable('alteracao_estoques')) { return; }
        $this->dropIndexIfExists('alteracao_estoques', 'idx_alteracao_estoques_filial_id');
        $this->dropColumnIfExists('alteracao_estoques', 'filial_id');
    }
