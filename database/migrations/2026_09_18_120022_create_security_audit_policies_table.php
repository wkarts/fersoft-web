...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120022_create_security_audit_policies_table';
    private const TABLE_NAME = 'security_audit_policies';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('security_audit_policies', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'security_crud_resource_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'model_class', ['column_type' => 'varchar(255)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'tenant_can_view', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'tenant_can_view_json', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'tenant_can_export_json', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'tenant_can_restore', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'super_admin_only', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'sanitize_fields', ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_audit_policies', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('security_audit_policies', 'PRIMARY', ['id'], true);
            $this->preflightIndex('security_audit_policies', 'sec_audit_policy_emp_model_unique', ['empresa_id', 'model_class'], true);
            $this->preflightIndex('security_audit_policies', 'security_audit_policies_security_crud_resource_id_index', ['security_crud_resource_id'], false);
            $this->preflightIndex('security_audit_policies', 'security_audit_policies_model_class_index', ['model_class'], false);
            $this->preflightIndex('security_audit_policies', 'security_audit_policies_super_admin_only_index', ['super_admin_only'], false);
            $this->preflightIndex('security_audit_policies', 'security_audit_policies_enabled_index', ['enabled'], false);
            $this->preflightIndex('security_audit_policies', 'idx_security_audit_policies_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('security_audit_policies', 'idx_security_audit_policies_filial_id', ['filial_id'], false);
            $this->preflightIndex('security_audit_policies', 'idx_security_audit_policies_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('security_audit_policies', 'security_audit_policies_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('security_audit_policies', 'security_audit_policies_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('security_audit_policies', 'security_audit_policies_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('security_audit_policies')) {
                if (!$this->beginChange('table', 'security_audit_policies', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('security_audit_policies', function (Blueprint $table) {
                    ...
                    $table->tinyInteger('tenant_can_view')->default('1');
                    $table->tinyInteger('tenant_can_view_json')->default('0');
                    $table->tinyInteger('tenant_can_export_json')->default('0');
                    $table->tinyInteger('tenant_can_restore')->default('0');
                    ...
                    $table->index('security_crud_resource_id', 'security_audit_policies_security_crud_resource_id_index');
                    $table->index('model_class', 'security_audit_policies_model_class_index');
                    $table->index('super_admin_only', 'security_audit_policies_super_admin_only_index');
                    $table->index('enabled', 'security_audit_policies_enabled_index');
                    $table->index('empresa_id', 'idx_security_audit_policies_empresa_id');
                    $table->index('filial_id', 'idx_security_audit_policies_filial_id');
                    $table->index('usuario_id', 'idx_security_audit_policies_usuario_id');
                });
                $this->markCreated('table', 'security_audit_policies');
            }

            $this->ensureBaseTenantColumns('security_audit_policies');
            $this->ensureColumn('security_audit_policies', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_audit_policies', 'security_crud_resource_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_audit_policies', 'model_class', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_audit_policies', 'tenant_can_view', function (Blueprint $table) {
                return $table->tinyInteger('tenant_can_view')->nullable(false)->default('1');
            ...
            $this->ensureColumn('security_audit_policies', 'tenant_can_view_json', function (Blueprint $table) {
                return $table->tinyInteger('tenant_can_view_json')->nullable(false)->default('0');
            ...
            $this->ensureColumn('security_audit_policies', 'tenant_can_export_json', function (Blueprint $table) {
                return $table->tinyInteger('tenant_can_export_json')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_audit_policies', 'tenant_can_restore', function (Blueprint $table) {
                return $table->tinyInteger('tenant_can_restore')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_audit_policies', 'super_admin_only', function (Blueprint $table) {
                return $table->tinyInteger('super_admin_only')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_audit_policies', 'sanitize_fields', function (Blueprint $table) {
                return $table->json('sanitize_fields')->nullable()->default(null);
            }, ['column_type' => 'json', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_audit_policies', 'enabled', function (Blueprint $table) {
                return $table->tinyInteger('enabled')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_audit_policies', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_audit_policies', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_audit_policies', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('security_audit_policies', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('security_audit_policies', 'sec_audit_policy_emp_model_unique', ['empresa_id', 'model_class'], true);
            $this->addIndexIfMissing('security_audit_policies', 'security_audit_policies_security_crud_resource_id_index', ['security_crud_resource_id'], false);
            $this->addIndexIfMissing('security_audit_policies', 'security_audit_policies_model_class_index', ['model_class'], false);
            $this->addIndexIfMissing('security_audit_policies', 'security_audit_policies_super_admin_only_index', ['super_admin_only'], false);
            $this->addIndexIfMissing('security_audit_policies', 'security_audit_policies_enabled_index', ['enabled'], false);
            $this->addIndexIfMissing('security_audit_policies', 'idx_security_audit_policies_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('security_audit_policies', 'idx_security_audit_policies_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('security_audit_policies', 'idx_security_audit_policies_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('security_audit_policies', 'security_audit_policies_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('security_audit_policies', 'security_audit_policies_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('security_audit_policies', 'security_audit_policies_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('security_audit_policies', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_audit_policies', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_audit_policies', 'usuario_id', function (Blueprint $table) {
