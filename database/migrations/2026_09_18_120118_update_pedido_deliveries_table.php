...
{
    private const REFERENCE_COLUMNS = ['cliente_id' => ['cliente_deliveries', 'id', 'cascade', 'restrict'], 'cupom_id' => ['codigo_descontos', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'endereco_id' => ['endereco_deliveries', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'cascade', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120118_update_pedido_deliveries_table';
    private const TABLE_NAME = 'pedido_deliveries';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('pedido_deliveries');
            $this->preflightColumn('pedido_deliveries', 'entregue', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('pedido_deliveries', 'entregue', function (Blueprint $table) {
                return $table->tinyInteger('entregue')->nullable()->default('0');
