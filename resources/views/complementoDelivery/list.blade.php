		...
		<div class="">
			...
			<div class="col-sm-12 col-lg-4 col-md-6 col-xl-4">
				...
				<a href="/deliveryComplemento/new" class="btn btn-lg btn-success">
					<i class="fa fa-plus"></i>Novo Adicional
				</a>
			</div>
		</div>
		<br>
					...
					<div class="card card-custom gutter-b card-stretch" style="height: 200px;">
						...
						<div class="card-body pt-4">
							...
							<p class="text-muted font-weight-bold">Valor: 
								<strong class="text-danger">R$ {{ number_format($c->valor, 2, ',', '.') }}</strong>
							</p>

							<p class="text-muted font-weight-bold">Tipo:
								@if($c->tipo == 'borda')
								<strong class="text-info">Borda de Pizza</strong>
								@else
							...
							<p class="text-muted font-weight-bold">Categoria(s):
								<strong class="text-info">{{$c->_categorias()}}</strong>
							</p>
