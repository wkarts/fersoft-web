...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('compras', function (Blueprint $table) {
            ...
            $table->foreign(['fornecedor_id'])->references(['id'])->on('fornecedors')->onUpdate('no action')->onDelete('cascade');
    ...
    {
        Schema::table('compras', function (Blueprint $table) {
            $table->dropForeign('compras_empresa_id_foreign');
            $table->dropForeign('compras_filial_id_foreign');
            $table->dropForeign('compras_fornecedor_id_foreign');
            $table->dropForeign('compras_transportadora_id_foreign');
