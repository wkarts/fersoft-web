...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120009_create_funcionario_ferias_table';
    private const TABLE_NAME = 'funcionario_ferias';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('funcionario_ferias', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'funcionario_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'periodo_aquisitivo_inicio', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'periodo_aquisitivo_fim', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'data_inicio', ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'data_fim', ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'dias', ['column_type' => 'int', 'nullable' => false, 'column_default' => '30', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'status', ['column_type' => 'enum(\'agendada\',\'em_gozo\',\'concluida\',\'cancelada\')', 'nullable' => false, 'column_default' => 'agendada', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'observacoes', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionario_ferias', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('funcionario_ferias', 'PRIMARY', ['id'], true);
            $this->preflightIndex('funcionario_ferias', 'funcionario_ferias_funcionario_id_index', ['funcionario_id'], false);
            $this->preflightIndex('funcionario_ferias', 'funcionario_ferias_datas_index', ['data_inicio', 'data_fim'], false);
            $this->preflightIndex('funcionario_ferias', 'idx_funcionario_ferias_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('funcionario_ferias', 'idx_funcionario_ferias_filial_id', ['filial_id'], false);
            $this->preflightIndex('funcionario_ferias', 'idx_funcionario_ferias_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('funcionario_ferias', 'funcionario_ferias_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('funcionario_ferias', 'funcionario_ferias_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('funcionario_ferias', 'funcionario_ferias_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('funcionario_ferias')) {
                if (!$this->beginChange('table', 'funcionario_ferias', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('funcionario_ferias', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->enum('status', ['agendada', 'em_gozo', 'concluida', 'cancelada'])->default('agendada')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('observacoes')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('funcionario_id', 'funcionario_ferias_funcionario_id_index');
                    $table->index(['data_inicio', 'data_fim'], 'funcionario_ferias_datas_index');
                    $table->index('empresa_id', 'idx_funcionario_ferias_empresa_id');
                    $table->index('filial_id', 'idx_funcionario_ferias_filial_id');
                    $table->index('usuario_id', 'idx_funcionario_ferias_usuario_id');
                });
                $this->markCreated('table', 'funcionario_ferias');
            }

            $this->ensureBaseTenantColumns('funcionario_ferias');
            $this->ensureColumn('funcionario_ferias', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('funcionario_ferias', 'funcionario_id', function (Blueprint $table) {
                return $table->unsignedInteger('funcionario_id')->nullable(false)->default(null);
            ...
            $this->ensureColumn('funcionario_ferias', 'periodo_aquisitivo_inicio', function (Blueprint $table) {
                return $table->date('periodo_aquisitivo_inicio')->nullable()->default(null);
            }, ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('funcionario_ferias', 'periodo_aquisitivo_fim', function (Blueprint $table) {
                return $table->date('periodo_aquisitivo_fim')->nullable()->default(null);
            }, ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('funcionario_ferias', 'data_inicio', function (Blueprint $table) {
            ...
            $this->ensureColumn('funcionario_ferias', 'data_fim', function (Blueprint $table) {
                return $table->date('data_fim')->nullable(false)->default(null);
            }, ['column_type' => 'date', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('funcionario_ferias', 'dias', function (Blueprint $table) {
                return $table->integer('dias')->nullable(false)->default('30');
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => '30', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('funcionario_ferias', 'status', function (Blueprint $table) {
                return $table->enum('status', ['agendada', 'em_gozo', 'concluida', 'cancelada'])->nullable(false)->default('agendada')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'agendada\',\'em_gozo\',\'concluida\',\'cancelada\')', 'nullable' => false, 'column_default' => 'agendada', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('funcionario_ferias', 'observacoes', function (Blueprint $table) {
            ...
            $this->ensureColumn('funcionario_ferias', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('funcionario_ferias', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('funcionario_ferias', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('funcionario_ferias', 'funcionario_ferias_funcionario_id_index', ['funcionario_id'], false);
            $this->addIndexIfMissing('funcionario_ferias', 'funcionario_ferias_datas_index', ['data_inicio', 'data_fim'], false);
            $this->addIndexIfMissing('funcionario_ferias', 'idx_funcionario_ferias_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('funcionario_ferias', 'idx_funcionario_ferias_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('funcionario_ferias', 'idx_funcionario_ferias_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('funcionario_ferias', 'funcionario_ferias_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('funcionario_ferias', 'funcionario_ferias_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('funcionario_ferias', 'funcionario_ferias_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('funcionario_ferias', 'empresa_id', function (Blueprint $table) {
            return $table->unsignedInteger('empresa_id')->nullable(false)->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('funcionario_ferias', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('funcionario_ferias', 'usuario_id', function (Blueprint $table) {
