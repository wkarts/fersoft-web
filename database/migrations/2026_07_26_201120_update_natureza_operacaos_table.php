...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureNullableAndComment('natureza_operacaos', 'categoria_conta_id', true, null);
        $this->ensureNullableAndComment('natureza_operacaos', 'created_at', true, null);
        $this->ensureNullableAndComment('natureza_operacaos', 'updated_at', true, null);
    }
