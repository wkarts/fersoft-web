                                                            ...
                                                            <div class="form-group">
                                                                <div class="checkbox-inline">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <span></span>
                                                                        Bloquear pesagem manual e obrigar leitura da balança
                                                                    </label>
                                                                </div>
                                                                <small class="text-muted">Quando ativo, o peso manual é bloqueado e o operador deve usar somente a balança </small>
                                                            </div>
