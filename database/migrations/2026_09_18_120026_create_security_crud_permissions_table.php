...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120026_create_security_crud_permissions_table';
    private const TABLE_NAME = 'security_crud_permissions';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('security_crud_permissions', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'security_crud_resource_id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'perfil_acesso_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'can_view', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'can_create', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'can_edit', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'can_delete', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'can_restore', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'can_export', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'can_print', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'source', ['column_type' => 'varchar(30)', 'nullable' => false, 'column_default' => 'manual', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'created_by', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'updated_by', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('security_crud_permissions', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('security_crud_permissions', 'PRIMARY', ['id'], true);
            $this->preflightIndex('security_crud_permissions', 'sec_crud_perm_emp_res_idx', ['empresa_id', 'security_crud_resource_id'], false);
            $this->preflightIndex('security_crud_permissions', 'security_crud_permissions_security_crud_resource_id_index', ['security_crud_resource_id'], false);
            $this->preflightIndex('security_crud_permissions', 'security_crud_permissions_perfil_acesso_id_index', ['perfil_acesso_id'], false);
            $this->preflightIndex('security_crud_permissions', 'security_crud_permissions_enabled_index', ['enabled'], false);
            $this->preflightIndex('security_crud_permissions', 'security_crud_permissions_source_index', ['source'], false);
            $this->preflightIndex('security_crud_permissions', 'security_crud_permissions_created_by_index', ['created_by'], false);
            $this->preflightIndex('security_crud_permissions', 'security_crud_permissions_updated_by_index', ['updated_by'], false);
            $this->preflightIndex('security_crud_permissions', 'idx_security_crud_permissions_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('security_crud_permissions', 'idx_security_crud_permissions_filial_id', ['filial_id'], false);
            $this->preflightIndex('security_crud_permissions', 'idx_security_crud_permissions_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('security_crud_permissions', 'security_crud_permissions_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('security_crud_permissions', 'security_crud_permissions_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('security_crud_permissions', 'security_crud_permissions_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('security_crud_permissions')) {
                if (!$this->beginChange('table', 'security_crud_permissions', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('security_crud_permissions', function (Blueprint $table) {
                    ...
                    $table->unsignedBigInteger('perfil_acesso_id')->nullable();
                    ...
                    $table->tinyInteger('can_restore')->default('0');
                    $table->tinyInteger('can_export')->default('1');
                    $table->tinyInteger('can_print')->default('1');
                    ...
                    $table->index('security_crud_resource_id', 'security_crud_permissions_security_crud_resource_id_index');
                    $table->index('perfil_acesso_id', 'security_crud_permissions_perfil_acesso_id_index');
                    $table->index('enabled', 'security_crud_permissions_enabled_index');
                    $table->index('source', 'security_crud_permissions_source_index');
                    $table->index('created_by', 'security_crud_permissions_created_by_index');
                    $table->index('updated_by', 'security_crud_permissions_updated_by_index');
                    $table->index('empresa_id', 'idx_security_crud_permissions_empresa_id');
                    $table->index('filial_id', 'idx_security_crud_permissions_filial_id');
                    $table->index('usuario_id', 'idx_security_crud_permissions_usuario_id');
                });
                $this->markCreated('table', 'security_crud_permissions');
            }

            $this->ensureBaseTenantColumns('security_crud_permissions');
            $this->ensureColumn('security_crud_permissions', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_crud_permissions', 'security_crud_resource_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_crud_permissions', 'perfil_acesso_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('perfil_acesso_id')->nullable()->default(null);
            ...
            $this->ensureColumn('security_crud_permissions', 'can_view', function (Blueprint $table) {
                return $table->tinyInteger('can_view')->nullable(false)->default('1');
            ...
            $this->ensureColumn('security_crud_permissions', 'can_create', function (Blueprint $table) {
                return $table->tinyInteger('can_create')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'can_edit', function (Blueprint $table) {
                return $table->tinyInteger('can_edit')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'can_delete', function (Blueprint $table) {
                return $table->tinyInteger('can_delete')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'can_restore', function (Blueprint $table) {
                return $table->tinyInteger('can_restore')->nullable(false)->default('0');
            ...
            $this->ensureColumn('security_crud_permissions', 'can_export', function (Blueprint $table) {
                return $table->tinyInteger('can_export')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'can_print', function (Blueprint $table) {
                return $table->tinyInteger('can_print')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'enabled', function (Blueprint $table) {
                return $table->tinyInteger('enabled')->nullable(false)->default('1');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'source', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_crud_permissions', 'created_by', function (Blueprint $table) {
                return $table->unsignedBigInteger('created_by')->nullable()->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'updated_by', function (Blueprint $table) {
                return $table->unsignedBigInteger('updated_by')->nullable()->default(null);
            }, ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('security_crud_permissions', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('security_crud_permissions', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('security_crud_permissions', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('security_crud_permissions', 'sec_crud_perm_emp_res_idx', ['empresa_id', 'security_crud_resource_id'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'security_crud_permissions_security_crud_resource_id_index', ['security_crud_resource_id'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'security_crud_permissions_perfil_acesso_id_index', ['perfil_acesso_id'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'security_crud_permissions_enabled_index', ['enabled'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'security_crud_permissions_source_index', ['source'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'security_crud_permissions_created_by_index', ['created_by'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'security_crud_permissions_updated_by_index', ['updated_by'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'idx_security_crud_permissions_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'idx_security_crud_permissions_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('security_crud_permissions', 'idx_security_crud_permissions_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('security_crud_permissions', 'security_crud_permissions_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('security_crud_permissions', 'security_crud_permissions_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('security_crud_permissions', 'security_crud_permissions_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('security_crud_permissions', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_crud_permissions', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('security_crud_permissions', 'usuario_id', function (Blueprint $table) {
