	...
	<section class="section section-md section-last bg-default text-md-left">
		...
		<div class="container">
			...
			<div class="container"><br>
				<a data-toggle="modal" data-target="#modal-mapa" href="#gal2" id="novo-endereco" class="button button-{{env('COLOR_BUTTON')}} button-pipaluk">Novo Endereço</a>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div id="info-mapa">
						...
						<button style="color: #fff" id="btn-end-map" class="button button-{{env('COLOR_BUTTON')}} button-pipaluk">Pronto</button>
					</div>

					<div id="form-endereco" style="display: none">

						<button style="color: #fff" id="abrir-mapa" class="button button-{{env('COLOR_BUTTON')}} button-pipaluk">Abrir Mapa</button>
