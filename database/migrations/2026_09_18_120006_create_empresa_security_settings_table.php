...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120006_create_empresa_security_settings_table';
    private const TABLE_NAME = 'empresa_security_settings';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('empresa_security_settings', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'platform_enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'tenant_enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'enforcement_enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'legacy_password_disabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'google_auth_required', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'audit_sensitive_export_enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'restore_from_audit_enabled', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'setup_completed_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'enabled_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'enabled_by', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('empresa_security_settings', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('empresa_security_settings', 'PRIMARY', ['id'], true);
            $this->preflightIndex('empresa_security_settings', 'empresa_security_settings_empresa_id_unique', ['empresa_id'], true);
            $this->preflightIndex('empresa_security_settings', 'empresa_security_settings_enabled_by_index', ['enabled_by'], false);
            $this->preflightIndex('empresa_security_settings', 'idx_empresa_security_settings_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('empresa_security_settings', 'idx_empresa_security_settings_filial_id', ['filial_id'], false);
            $this->preflightIndex('empresa_security_settings', 'idx_empresa_security_settings_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('empresa_security_settings', 'empresa_security_settings_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('empresa_security_settings', 'empresa_security_settings_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('empresa_security_settings', 'empresa_security_settings_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('empresa_security_settings')) {
                if (!$this->beginChange('table', 'empresa_security_settings', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('empresa_security_settings', function (Blueprint $table) {
                    ...
                    $table->tinyInteger('platform_enabled')->default('1');
                    $table->tinyInteger('tenant_enabled')->default('0');
                    $table->tinyInteger('enforcement_enabled')->default('0');
                    $table->tinyInteger('legacy_password_disabled')->default('0');
                    $table->tinyInteger('google_auth_required')->default('0');
                    $table->tinyInteger('audit_sensitive_export_enabled')->default('0');
                    $table->tinyInteger('restore_from_audit_enabled')->default('0');
                    ...
                    $table->index('enabled_by', 'empresa_security_settings_enabled_by_index');
                    $table->index('empresa_id', 'idx_empresa_security_settings_empresa_id');
                    $table->index('filial_id', 'idx_empresa_security_settings_filial_id');
                    $table->index('usuario_id', 'idx_empresa_security_settings_usuario_id');
                });
                $this->markCreated('table', 'empresa_security_settings');
            }

            $this->ensureBaseTenantColumns('empresa_security_settings');
            $this->ensureColumn('empresa_security_settings', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('empresa_security_settings', 'platform_enabled', function (Blueprint $table) {
                return $table->tinyInteger('platform_enabled')->nullable(false)->default('1');
            ...
            $this->ensureColumn('empresa_security_settings', 'tenant_enabled', function (Blueprint $table) {
                return $table->tinyInteger('tenant_enabled')->nullable(false)->default('0');
            ...
            $this->ensureColumn('empresa_security_settings', 'enforcement_enabled', function (Blueprint $table) {
                return $table->tinyInteger('enforcement_enabled')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('empresa_security_settings', 'legacy_password_disabled', function (Blueprint $table) {
                return $table->tinyInteger('legacy_password_disabled')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('empresa_security_settings', 'google_auth_required', function (Blueprint $table) {
                return $table->tinyInteger('google_auth_required')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('empresa_security_settings', 'audit_sensitive_export_enabled', function (Blueprint $table) {
                return $table->tinyInteger('audit_sensitive_export_enabled')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('empresa_security_settings', 'restore_from_audit_enabled', function (Blueprint $table) {
                return $table->tinyInteger('restore_from_audit_enabled')->nullable(false)->default('0');
            }, ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('empresa_security_settings', 'setup_completed_at', function (Blueprint $table) {
                return $table->timestamp('setup_completed_at')->nullable()->default(null);
            ...
            $this->ensureColumn('empresa_security_settings', 'enabled_at', function (Blueprint $table) {
                return $table->timestamp('enabled_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('empresa_security_settings', 'enabled_by', function (Blueprint $table) {
                return $table->unsignedBigInteger('enabled_by')->nullable()->default(null);
            ...
            $this->ensureColumn('empresa_security_settings', 'created_at', function (Blueprint $table) {
                return $table->timestamp('created_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('empresa_security_settings', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('empresa_security_settings', 'deleted_at', function (Blueprint $table) {
                return $table->timestamp('deleted_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('empresa_security_settings', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('empresa_security_settings', 'empresa_security_settings_empresa_id_unique', ['empresa_id'], true);
            $this->addIndexIfMissing('empresa_security_settings', 'empresa_security_settings_enabled_by_index', ['enabled_by'], false);
            $this->addIndexIfMissing('empresa_security_settings', 'idx_empresa_security_settings_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('empresa_security_settings', 'idx_empresa_security_settings_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('empresa_security_settings', 'idx_empresa_security_settings_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('empresa_security_settings', 'empresa_security_settings_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('empresa_security_settings', 'empresa_security_settings_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('empresa_security_settings', 'empresa_security_settings_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('empresa_security_settings', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('empresa_security_settings', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('empresa_security_settings', 'usuario_id', function (Blueprint $table) {
