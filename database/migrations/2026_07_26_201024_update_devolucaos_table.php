...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('devolucaos', 'devolucaos_natureza_id_foreign', ['natureza_id'], 'natureza_operacaos', ['id'], null, null);
        $this->addForeignIfMissing('devolucaos', 'devolucaos_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
        $this->addForeignIfMissing('devolucaos', 'devolucaos_fornecedor_id_foreign', ['fornecedor_id'], 'fornecedors', ['id'], null, null);
    }
