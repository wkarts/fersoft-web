                                                ...
                                                @foreach($orders as $o)
                                                    <tr class="datatable-row">
                                                        ...
                                                        <span class="codigo" style="width: 250px;" id="id">
                                                            <!-- Excluir -->
                                                            <a class="btn btn-danger btn-sm" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/ordemServico/delete/{{ $o->id }}" }else{return false} })' href="#!" title="Remover OS">
                                                                <i class="la la-trash"></i>
                                                            </a>

                                                            <!-- Visualizar OS -->
                                                            <a title="Ver Detalhes da OS" class="btn btn-dark btn-sm" href="/ordemServico/servicosordem/{{$o->id}}">
                                                                <i class="la la-eye"></i>
                                                            </a>

                                                            <!-- Atalho: Gerar NFS-e (Serviços) -->
                                                            <a title="Gerar NFS-e (Serviços)" class="btn btn-info btn-sm" href="/ordemServico/gerarNfse/{{ $o->id }}">
                                                                <i class="la la-file-invoice"></i>
                                                            </a>

                                                            <!-- Atalho: Gerar NF-e (Produtos) -->
                                                            <a title="Gerar NF-e (Produtos)" class="btn btn-success btn-sm" href="/ordemServico/gerarVenda/{{ $o->id }}">
                                                                <i class="la la-shopping-cart"></i>
                                                            </a>

                                                            <!-- Atalho: Finalizar no PDV (NFC-e) -->
                                                            <a title="Finalizar no PDV (NFC-e)" class="btn btn-warning btn-sm" href="/ordemServico/gerarVendaCompleta/{{ $o->id }}">
                                                        ...
                                                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Ações">
                                                            ...
                                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
																...
																<span class="navi-text">
                                                                    ...
                                                                    <li class="navi-item">
                                                                        <a href="/ordemServico/gerarNfse/{{$o->id}}" class="navi-link">
                                                              <span class="navi-text">
                                                                  <span class="label label-xl label-inline label-light-info">Gerar NFS-e (Serviços)</span>
                                                              </span>
                                                                        </a>
                                                                    </li>

                                                                    <li class="navi-item">
                                                                        <a href="/ordemServico/gerarVenda/{{$o->id}}" class="navi-link">
                                                              <span class="navi-text">
                                                                  <span class="label label-xl label-inline label-light-success">Gerar NF-e (Produtos)</span>
                                                              </span>
                                                                        </a>
                                                                    </li>
