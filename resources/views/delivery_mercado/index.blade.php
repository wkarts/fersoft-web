        ...
        <div class="product-banner">
          ...
          <div class="product-banner-content">
            <div class="product-banner-inner" style="background-image: url(images/bg-brush.png)">
              ...
              <a class="button button-{{env('COLOR_BUTTON')}} button-ujarak" href="/delivery/produto/{{$BannerMaisVendido->produto_delivery_id}}" data-caption-animate="slideInLeft" data-caption-delay="400">Ver Produto</a>
              @endif
            </div>
          </div>
        </div>
              ...
              <article class="product product-2 box-ordered-item wow slideInRight" data-wow-delay="0s">
                <div class="unit flex-row flex-lg-column">
                  ...
                  <div class="unit-body">
                    ...
                    </div><a class="button button-sm button-{{env('COLOR_BUTTON')}} button-ujarak" href="/delivery/produto/{{$i->produto->id}}">Ver</a>
                  </div>
                </div>
              </article>
            </div>
              ...
              <article class="product product-2 box-ordered-item wow slideInRight" data-wow-delay="0s">
                <div class="unit flex-row flex-lg-column">
                  ...
                  <div class="unit-body">
                    ...
                    </div><a class="button button-sm button-{{env('COLOR_BUTTON')}} button-ujarak" href="/delivery/produto/{{$p->id}}">Adicionar ao carrinho</a>
                  </div>
                </div>
              </article>
            </div>
