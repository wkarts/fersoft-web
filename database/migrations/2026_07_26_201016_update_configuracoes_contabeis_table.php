...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureTableCollation('configuracoes_contabeis', 'utf8mb4_general_ci');
        $this->applyColumnDefinition('configuracoes_contabeis', 'id', 'INT UNSIGNED NOT NULL');
        $this->applyColumnDefinition('configuracoes_contabeis', 'codigo_prosoft', 'VARCHAR(4) DEFAULT NULL', 'updated_at', false);
        $this->applyColumnDefinition('configuracoes_contabeis', 'conta_estoque', 'INT UNSIGNED DEFAULT NULL', 'codigo_prosoft', false);
        $this->addPrimaryKeyIfMissing('configuracoes_contabeis', ['id']);
        $this->ensureAutoIncrement('configuracoes_contabeis', 'id');
        $this->addForeignIfMissing('configuracoes_contabeis', 'fk_config_empresa', ['empresa_id'], 'empresas', ['id'], 'cascade', 'cascade');
    }
