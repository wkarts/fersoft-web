...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('sped_nfce_consolidados')) {
            return;
        }

        $this->addForeignIfMissing('sped_nfce_consolidados', 'sped_nfce_consolidados_filial_id_foreign', ['filial_id'], 'filials', ['id'], null, null);
    }
