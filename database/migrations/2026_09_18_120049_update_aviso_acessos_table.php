...
{
    private const REFERENCE_COLUMNS = ['aviso_id' => ['avisos', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120049_update_aviso_acessos_table';
    private const TABLE_NAME = 'aviso_acessos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('aviso_acessos');
            $this->preflightColumn('aviso_acessos', 'usuario_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('aviso_acessos', 'idx_aviso_usuario', ['aviso_id', 'usuario_id'], false);

            $this->ensureColumn('aviso_acessos', 'usuario_id', function (Blueprint $table) {
                return $table->integer('usuario_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('aviso_acessos', 'idx_aviso_usuario', ['aviso_id', 'usuario_id'], false);
        });
    }
