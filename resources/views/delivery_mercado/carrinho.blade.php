		...
		<div class="row row-50">
			...
			<div class="col-lg-12">
				...
				<form method="post" action="/delivery/finalizar" class="wow slideInRight" data-wow-delay="0.3s">
					...
					<button style="width: 100%;" class="button button-{{env('COLOR_BUTTON')}} button-pipaluk"  type="submit">Finalziar <strong id="soma">R$ {{number_format($pedido->somaItens(), 2)}}</strong></button>
				</form>
