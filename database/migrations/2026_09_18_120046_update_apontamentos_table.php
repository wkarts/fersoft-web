...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120046_update_apontamentos_table';
    private const TABLE_NAME = 'apontamentos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('apontamentos');
            $this->preflightColumn('apontamentos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('apontamentos', 'filial_id', function (Blueprint $table) {
