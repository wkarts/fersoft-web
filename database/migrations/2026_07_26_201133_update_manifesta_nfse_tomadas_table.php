...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureNullableAndComment('manifesta_nfse_tomadas', 'filial_id', true, null);
        $this->ensureNullableAndComment('manifesta_nfse_tomadas', 'chave', true, null);
        $this->ensureNullableAndComment('manifesta_nfse_tomadas', 'nsu', true, null);
        $this->ensureNullableAndComment('manifesta_nfse_tomadas', 'situacao', true, null);
    }
