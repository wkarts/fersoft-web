...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('compras', 'compras_fornecedor_id_foreign', ['fornecedor_id'], 'fornecedors', ['id'], 'cascade', null);
        $this->addForeignIfMissing('compras', 'compras_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
    }
