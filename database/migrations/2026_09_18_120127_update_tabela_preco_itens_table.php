...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120127_update_tabela_preco_itens_table';
    private const TABLE_NAME = 'tabela_preco_itens';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('tabela_preco_itens');
            $this->preflightColumn('tabela_preco_itens', 'valor_kg', ['column_type' => 'decimal(17,4)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('tabela_preco_itens', 'valor_kg', function (Blueprint $table) {
                return $table->decimal('valor_kg', 17, 4)->nullable(false)->default('0.00');
            }, ['column_type' => 'decimal(17,4)', 'nullable' => false, 'column_default' => '0.00', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        });
    }
