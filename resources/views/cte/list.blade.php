...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/cte/filtro">
				<div class="row align-items-center">
							...
							<div class="col-md-12 my-2 my-md-0">
								...
								<div class="input-group">
									<select name="tipo_pesquisa" class="custom-select">
										...
										<option @isset($tipo_pesquisa) @if($tipo_pesquisa == $key) selected @endif @endif value="{{$key}}">{{$t}}</option>
										@endforeach
									</select>
								</div>
							</div>
					...
					<div class="form-group col-lg-5 col-md-4 col-sm-6">
						...
						<div class="row">
							<div class="col-md-12 my-2 my-md-0">
								<div class="input-group">
									<input type="text" name="pesquisa" class="form-control" placeholder="Pesquisa tomador" id="kt_datatable_search_query" value="{{{ isset($pesquisa) ? $pesquisa : ''}}}">
			...
			<div class="row @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
				<div class="form-group col-lg-3 col-md-4 col-sm-6">
					...
					<a href="/cte/faturas" class="btn btn-danger">
			...
			@isset($paraImprimir)
			<form method="get" action="/cte/imprimir">

				<input type="hidden" name="pesquisa" value="{{{ isset($pesquisa) ? $pesquisa : '' }}}">
				<input type="hidden" name="telefone" value="{{{ isset($telefone) ? $telefone : '' }}}">
				...
				<button href="/contasPagar/new" class="btn btn-info">
										...
										<div class="row">
													...
													<table class="datatable-table" style="max-width: 100%; overflow: scroll">
														<thead class="datatable-head">
															<tr class="datatable-row" style="left: 0px;">
																...
																<th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Status de Pagamento</span></th>
																...
																<td>
																	<div class="row">
																		<span style="width: 280px;">
																			...
																			<a class="btn btn-danger btn-sm" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/cte/delete/{{ $c->id }}" }else{return false} })' href="#!">
																				<i class="la la-trash"></i>				
																			</a>

																			<a class="btn btn-warning btn-sm" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/cte/edit/{{ $c->id }}" }else{return false} })' href="#!">
																				<i class="la la-edit"></i>	
																			</a>
																			@endif

																			<a title="Detalhes" class="btn btn-info btn-sm" href="/cte/detalhar/{{ $c->id }}">
																				<i class="la la-file"></i>
																			</a>

																			<a title="Custos" class="btn btn-primary btn-sm" href="/cte/custos/{{ $c->id }}">
																				<i class="la la-money"></i>
																			</a>

																			@if($c->estado == 'APROVADO')
																			<a title="Download XML" class="btn btn-dark btn-sm" href="/cte/download-xml/{{ $c->id }}">
																				<i class="la la-download"></i>
																			</a>
																			@endif

																			@if(!$c->status_pagamento)
																			<a title="Confirmar Pagamento" class="btn btn-success btn-sm" href="#!" onclick='swal("Atenção!", "Deseja confirmar o pagamento deste registro? não será possível alterar o status posteriormente", "warning").then((sim) => {if(sim){ location.href="/cte/alterarStatus/{{ $c->id }}"}else{return false} })'>
											...
											<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
												...
												<div class="row" style="margin-top: 5px;">
													...
													<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
														<a onclick="gerarFatura()" style="width: 100%" class="btn btn-dark" href="#!">Gerar Fatura</a>
													</div>
												</div>
											</div>
											@else
