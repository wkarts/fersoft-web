								...
								<div class="kt-section__body">
									...
									<div class="row">
										<div class="form-group validated col-sm-8 col-lg-8">
											...
											<div class="">
												<input type="text" class="form-control @if($errors->has('mensagem')) is-invalid @endif" id="path_img" name="path_img" value="{{{ isset($imagem) ? env('PATH_URL').'/imagens_produtos/'.$imagem : old('path_img') }}}">
									...
									<div class="row">
										<div class="form-group validated col-sm-8 col-lg-8">
											<label class="col-form-label">Endereço da Imagem (opcional)</label>
											<div class="">
												<input type="text" class="form-control @if($errors->has('mensagem')) is-invalid @endif" id="path_img" name="path_img" value="{{{ $imagem != '' ? env('PATH_URL').'/imagens_produtos/'.$imagem : old('path_img') }}}">
												@if($errors->has('path_img'))
												<div class="invalid-feedback">
													{{ $errors->first('path_img') }}
												</div>
