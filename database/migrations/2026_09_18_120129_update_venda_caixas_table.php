...
{
    private const REFERENCE_COLUMNS = ['cliente_id' => ['clientes', 'id', 'restrict', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'cascade', 'restrict'], 'natureza_id' => ['natureza_operacaos', 'id', 'restrict', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'restrict', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120129_update_venda_caixas_table';
    private const TABLE_NAME = 'venda_caixas';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('venda_caixas');
            $this->preflightColumn('venda_caixas', 'plataforma_origem', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => 'BALCAO', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('venda_caixas', 'id_pedido_plataforma', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightIndex('venda_caixas', 'idx_plataforma_origem', ['plataforma_origem'], false);

            $this->ensureColumn('venda_caixas', 'plataforma_origem', function (Blueprint $table) {
                return $table->string('plataforma_origem', 50)->nullable()->default('BALCAO')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => 'BALCAO', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('venda_caixas', 'id_pedido_plataforma', function (Blueprint $table) {
                return $table->string('id_pedido_plataforma', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->addIndexIfMissing('venda_caixas', 'idx_plataforma_origem', ['plataforma_origem'], false);
        });
    }
