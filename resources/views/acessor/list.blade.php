	...
	<div class="card-body">
		<div class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
			<div class="col-sm-12 col-lg-4 col-md-6 col-xl-4">
				...
				<a href="/acessores/new" class="btn btn-lg btn-success">
					<i class="fa fa-plus"></i>Novo Assessor
				</a>
			</div>
		</div>
		<br>
		...
		<div class="@if(env('ANIMACAO')) animate__animated @endif animate__backInRight" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<br>
			<h4>Lista de Assessores</h4>
			<label>Total de registros: {{count($acessores)}}</label>
			<div class="row">
									...
									<div id="kt_datatable" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
										...
										<table class="datatable-table" style="max-width: 100%; overflow: scroll">
											...
											<tbody id="body" class="datatable-body">
												@foreach($acessores as $f)
												<tr class="datatable-row">
													<td class="datatable-cell"><span class="codigo" style="width: 250px;" id="id">{{$f->razao_social}}</span>
													</td>
													<td class="datatable-cell"><span class="codigo" style="width: 150px;" id="id">{{$f->cpf_cnpj}}</span>
													</td>
												...
												<td class="datatable-cell"><span class="codigo" style="width: 100px;" id="id">{{$f->bairro}}</span>
													<td class="datatable-cell"><span class="codigo" style="width: 100px;" id="id">{{$f->cidade->nome}}</span>
													</td>
													...
													<td class="datatable-cell">
														<span class="codigo" style="width: 200px;" id="id">
															<a class="btn btn-warning btn-sm" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/acessores/edit/{{ $f->id }}" }else{return false} })' href="#!">
																<i class="la la-edit"></i>	
															</a>
															<a class="btn btn-danger btn-sm" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/acessores/delete/{{ $f->id }}" }else{return false} })' href="#!">
																<i class="la la-trash"></i>	
															</a>

															<a class="btn btn-info btn-sm" href="/acessores/comissao/{{$f->id}}">
												...
												<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Ações">
													...
													<div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
														...
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="/acessores/edit/{{$c->id}}" class="navi-link">
															...
															<li class="navi-item">
																<a onclick = "if (! confirm('Deseja excluir este registro?')) { return false; }" href="/acessores/delete/{{$c->id}}" class="navi-link">
																	<span class="navi-text">
															...
															<li class="navi-item">
																<a href="/acessores/comissao/{{$c->id}}" class="navi-link">
																	<span class="navi-text">
																		<span class="label label-xl label-inline label-light-info">Comissão</span>
																	</span>
																</a>
															</li>
