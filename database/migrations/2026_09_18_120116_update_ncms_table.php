...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120116_update_ncms_table';
    private const TABLE_NAME = 'ncms';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('ncms');
            $this->preflightColumn('ncms', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ncms', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ncms', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ncms', 'secao', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ncms', 'capitulo', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ncms', 'ativo', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ncms', 'deleted_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ncms', 'codigo', ['column_type' => 'varchar(11)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightIndex('ncms', 'ncms_codigo_unique', ['codigo'], true);

            $this->ensureColumn('ncms', 'empresa_id', function (Blueprint $table) {
                return $table->unsignedInteger('empresa_id')->nullable()->default(null);
            ...
            $this->ensureColumn('ncms', 'usuario_id', function (Blueprint $table) {
                return $table->unsignedInteger('usuario_id')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('ncms', 'filial_id', function (Blueprint $table) {
                return $table->unsignedInteger('filial_id')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('ncms', 'secao', function (Blueprint $table) {
                return $table->string('secao', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('ncms', 'capitulo', function (Blueprint $table) {
                return $table->unsignedInteger('capitulo')->nullable()->default(null);
            }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('ncms', 'ativo', function (Blueprint $table) {
            ...
            $this->ensureColumn('ncms', 'deleted_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('ncms', 'codigo', function (Blueprint $table) {
                return $table->string('codigo', 11)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(11)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->addIndexIfMissing('ncms', 'ncms_codigo_unique', ['codigo'], true);
        });
    }
