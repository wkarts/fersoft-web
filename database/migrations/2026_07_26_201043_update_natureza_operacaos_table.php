...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('natureza_operacaos', 'perc_red_ibs', 'DECIMAL(10, 4) NULL DEFAULT 0.0000');
        $this->applyColumnDefinition('natureza_operacaos', 'perc_red_cbs', 'DECIMAL(10, 4) NULL DEFAULT 0.0000');
    }
