					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<div class="card-title">
								<h3 style="width: 230px; font-size: 12px; height: 10px;" class="card-title">{{substr($m->nome, 0, 30)}}
								</h3>
							</div>
								...
								<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Ações">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
										...
										<ul class="navi navi-hover">
											...
											@if($m->token == '')
											<li class="navi-item">
												<a href="/mesas/gerarToken/{{$m->id}}" class="navi-link">
													<span class="navi-text">
														<span class="label label-xl label-inline label-light-dark">Gerar token</span>
													</span>
												</a>
											</li>
											@endif
						...
						<div class="card-body">
							<h5>token mesa: <strong>{{ $m->token != "" ? $m->token : '--' }}</strong></h5>
						</div>
