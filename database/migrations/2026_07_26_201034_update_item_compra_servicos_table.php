...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applyColumnDefinition('item_compra_servicos', 'compra_id', 'INT UNSIGNED NOT NULL');
        $this->applyColumnDefinition('item_compra_servicos', 'codigo_servico_lc116', 'VARCHAR(10) NOT NULL');
        $this->applyColumnDefinition('item_compra_servicos', 'discriminacao', 'TEXT NOT NULL');
        $this->applyColumnDefinition('item_compra_servicos', 'valor_servico', 'DECIMAL(15, 2) NOT NULL');
    }
