						...
						<div class="col-xl-12">
							...
							<div class="row">
								<div class="col-xl-12">
									...
									<div class="row">
										<h5 class="mt-3 ml-3">Total de Itens: <strong class="blue-text" id="total_itens">0</strong></h5>
									</div>
								</div>
					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-body">
							<div class="row">
								...
								<div class="form-group validated col-sm-4 col-12">
								...
								<div class="form-group validated col-sm-8 col-12">
