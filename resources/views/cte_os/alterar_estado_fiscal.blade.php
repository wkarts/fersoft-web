	...
	<div class="card-body">
		<div class="content d-flex flex-column flex-column-fluid" id="kt_content" >
			...
			<div class="col-lg-12" id="content">
				...
				<h3 class="card-title">CTeOs código: <strong>{{$cte->id}}</strong></h3>

				<form method="post" action="/cteos/estadoFiscal" enctype="multipart/form-data">
					<input type="hidden" value="{{$cte->id}}" name="cte_id">
					<div class="row">
						<div class="col-xl-12">
											...
											<div class="">
												<div class="input-group date">
													<select class="custom-select form-control" id="estado" name="estado">
														<option @if($cte->estado == 'NOVO') selected @endif value="NOVO">NOVO</option>
														<option @if($cte->estado == 'APROVADO') selected @endif value="APROVADO">APROVADO</option>
														<option @if($cte->estado == 'REJEITADO') selected @endif value="REJEITADO">REJEITADO</option>
														<option @if($cte->estado == 'CANCELADO') selected @endif value="CANCELADO">CANCELADO</option>
													</select>
												</div>
											</div>
											<br>
