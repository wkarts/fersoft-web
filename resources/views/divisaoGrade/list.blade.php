					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<a href="/divisaoGrade/edit/{{$c->id}}" class="btn btn-icon btn-circle btn-sm btn-warning mr-1"><i class="la la-pencil"></i></a>
								<a onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/divisaoGrade/delete/{{$c->id}}" }else{return false} })' href="#!" class="btn btn-icon btn-circle btn-sm btn-danger mr-1"><i class="la la-trash"></i></a>
