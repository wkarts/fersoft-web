	...
	<div class="card-body @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
		<div class="content d-flex flex-column flex-column-fluid" id="kt_content" >
			...
			<div class="col-lg-12" id="content">
				...
				<input type="hidden" value='@json($pagamento)' id="pagamento_hidden">
				@endif
				<!--  -->
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="form-group col-lg-2 col-md-3 col-sm-6 col-12">
										...
										<select class="custom-select form-control" id="tipo_doc_pagador">
									...
									<div class="form-group col-lg-3 col-md-6 col-sm-6 col-12">
										...
										<input type="text" class="form-control" id="cpf_cnpj_pagador">
									</div>
									<div class="form-group col-lg-3 col-md-6 col-sm-6 col-12">
										<label>Nome do pagador</label>
										<input type="text" class="form-control" id="nome_pagador">
									</div>
									<div class="form-group col-lg-2 col-md-3 col-sm-6 col-12">
										<label>Vlr contrato</label>
										<input type="text" class="form-control" id="valor_contrato">
									</div>
									<div class="form-group col-lg-2 col-md-3 col-sm-6 col-12">
										<label>Vlr pagamento</label>
								...
								<div class="row">
									<div class="form-group col-lg-3">
										...
										<select id="comp_tipo" class="custom-select form-control"><option value="01">01 - Frete</option><option value="02">02 - Pedágio</option><option value="99">99 - Outros</option></select>
									</div>
