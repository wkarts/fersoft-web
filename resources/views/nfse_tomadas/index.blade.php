        ...
        <div class="row mb-6 align-items-center">
            ...
            <div class="col-lg-6 col-md-12 text-lg-right">
                <a href="#" class="btn btn-info font-weight-bold mr-2" data-toggle="modal" data-target="#modalComoFuncionaTomadas">
              	...
              	<form action="{{ route('nfse.sincronizar-manuais') }}" method="POST" style="display:inline;">
                  @csrf
                  <button type="submit" class="btn btn-warning">
                      <i class="fa fa-search"></i> Vincular Lançamentos Manuais
                  </button>
              </form>
            ...
            <form action="/nfse-tomadas" method="GET">
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="nome_prestador" class="form-control" value="{{ request('nome_prestador') }}" placeholder="NOME">
                    </div>
                    <div class="col-lg-3">
                        <label>CNPJ/CPF:</label>
                        <input type="text" name="cnpj_prestador" class="form-control" value="{{ request('cnpj_prestador') }}" placeholder="Ex: 00.000.000/0000-00">
                    </div>
                ...
                <tbody>
                    @forelse($docs as $d)
                        ...
                        <tr>
                            ...
                            <td>
                                @if(($d->situacao ?? '') == 'CANCELADA')
                                    <span class="label label-inline label-light-danger font-weight-bold">CANCELADA ❌</span>
                                @elseif(($d->tipo ?? 0) == 4 || ($d->estado ?? '') == 'REJEITADA')
