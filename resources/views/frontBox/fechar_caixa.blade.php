			...
			<div class="col-lg-12" id="content">
				...
				<div class="row align-items-center">
					<div class="col-lg-12">
						<div style="display: flex;align-items: center;height: 100%;">
							<h4 class="mb-0">
								Local: <strong class="text-danger">{{$abertura->filial != null ? $abertura->filial->descricao : 'Matriz'}}</strong>
							</h4>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<form id="form-caixa" method="post" action="/frenteCaixa/fechar">
						...
						<button @if(sizeof($vendas) == 0) disabled @endif class="btn btn-lg btn-danger" type="button" id="btn-fechar-caixa">
