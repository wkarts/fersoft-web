	...
	public function save(Request $request){
		...
		if($request->id == 0){
			...
			$result = ConfigEcommerce::create([
				...
				'modelo_orcamento' => $request->modelo_orcamento ? true : false,
			...
			$config->formas_pagamento = $request->formas_pagamento;
			...
			$config->modelo_orcamento = $request->modelo_orcamento ? true : false;
