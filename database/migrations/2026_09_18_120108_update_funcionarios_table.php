...
{
    private const REFERENCE_COLUMNS = ['empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120108_update_funcionarios_table';
    ...
    public function up()
    {
        $this->runWithSchemaLock(function () {
            ...
            $this->ensureTableExists('funcionarios');
            $this->preflightColumn('funcionarios', 'ponto_escala_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionarios', 'traccar_id', ['column_type' => 'varchar(60)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('funcionarios', 'whatsapp_id', ['column_type' => 'varchar(80)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('funcionarios', 'pin_ponto', ['column_type' => 'varchar(4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Senha de 4 digitos para o ponto no celular do motorista']);
            $this->preflightColumn('funcionarios', 'tipo_partida', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'empresa', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('funcionarios', 'latitude_residencia', ['column_type' => 'decimal(10,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionarios', 'longitude_residencia', ['column_type' => 'decimal(11,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('funcionarios', 'tipo_ponto', ['column_type' => 'enum(\'local\',\'whatsapp\',\'ambos\')', 'nullable' => false, 'column_default' => 'ambos', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('funcionarios', 'recebe_alerta_coleta', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '0', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('funcionarios', 'idx_funcionarios_whatsapp_id', ['whatsapp_id'], false);
            $this->preflightIndex('funcionarios', 'funcionarios_ponto_escala_id_index', ['ponto_escala_id'], false);

            $this->ensureColumn('funcionarios', 'ponto_escala_id', function (Blueprint $table) {
                return $table->unsignedInteger('ponto_escala_id')->nullable()->default(null);
            ...
            $this->ensureColumn('funcionarios', 'traccar_id', function (Blueprint $table) {
                return $table->string('traccar_id', 60)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('funcionarios', 'whatsapp_id', function (Blueprint $table) {
                return $table->string('whatsapp_id', 80)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(80)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('funcionarios', 'pin_ponto', function (Blueprint $table) {
                return $table->string('pin_ponto', 4)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('Senha de 4 digitos para o ponto no celular do motorista');
            }, ['column_type' => 'varchar(4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => 'Senha de 4 digitos para o ponto no celular do motorista']);
            $this->ensureColumn('funcionarios', 'tipo_partida', function (Blueprint $table) {
            ...
            $this->ensureColumn('funcionarios', 'latitude_residencia', function (Blueprint $table) {
                return $table->decimal('latitude_residencia', 10, 8)->nullable()->default(null);
            ...
            $this->ensureColumn('funcionarios', 'longitude_residencia', function (Blueprint $table) {
                return $table->decimal('longitude_residencia', 11, 8)->nullable()->default(null);
            ...
            $this->ensureColumn('funcionarios', 'tipo_ponto', function (Blueprint $table) {
                return $table->enum('tipo_ponto', ['local', 'whatsapp', 'ambos'])->nullable(false)->default('ambos')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'local\',\'whatsapp\',\'ambos\')', 'nullable' => false, 'column_default' => 'ambos', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('funcionarios', 'recebe_alerta_coleta', function (Blueprint $table) {
                return $table->tinyInteger('recebe_alerta_coleta')->nullable(false)->default('0');
            ...
            $this->addIndexIfMissing('funcionarios', 'idx_funcionarios_whatsapp_id', ['whatsapp_id'], false);
            $this->addIndexIfMissing('funcionarios', 'funcionarios_ponto_escala_id_index', ['ponto_escala_id'], false);
        });
    }
