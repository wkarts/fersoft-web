								...
								<div class="">
									<div class="input-group date">
										<select required class="custom-select form-control" id="forma_pagamento" name="forma_pagamento">
											...
											<option @if($key == $config->forma_pagamento_padrao) selected @endif value="{{$key}}">{{$f}}</option>
											@endforeach
										</select>
									</div>
								</div>
								...
								<div class="">
									<div class="input-group date">
										<select required class="custom-select form-control" id="natureza" name="natureza">
											...
											<option @if($n->id == $config->natureza_padrao) selected @endif value="{{$n->id}}">{{$n->natureza}}</option>
											@endforeach
										</select>
									</div>
								</div>
