...
return new class extends Migration
{
    ...
    {
        Schema::table('venda_caixas', function (Blueprint $table) {
            $table->dropForeign('venda_caixas_cliente_id_foreign');
            $table->dropForeign('venda_caixas_empresa_id_foreign');
            $table->dropForeign('venda_caixas_filial_id_foreign');
            $table->dropForeign('venda_caixas_natureza_id_foreign');
            $table->dropForeign('venda_caixas_usuario_id_foreign');
        });
    }
};
