...
return new class extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('venda_caixa_pre_vendas')) {
            return;
        }

        $this->addForeignIfMissing('venda_caixa_pre_vendas', 'venda_caixa_pre_vendas_natureza_id_foreign', ['natureza_id'], 'natureza_operacaos', ['id'], null, null);
    }
