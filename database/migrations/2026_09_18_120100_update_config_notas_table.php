...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120100_update_config_notas_table';
    private const TABLE_NAME = 'config_notas';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('config_notas');
            $this->preflightColumn('config_notas', 'latitude', ['column_type' => 'decimal(10,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('config_notas', 'longitude', ['column_type' => 'decimal(11,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('config_notas', 'latitude', function (Blueprint $table) {
            ...
            $this->ensureColumn('config_notas', 'longitude', function (Blueprint $table) {
