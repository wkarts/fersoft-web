...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->applySafeColumnUpgrade([
            'table' => 'estoque_mensal_fechamentos',
            'column' => 'filial_id',
            'type' => 'INT UNSIGNED',
            'nullable' => true,
        ...
        $this->addIndexIfMissing('estoque_mensal_fechamentos', 'uq_estoque_mensal_periodo', ['empresa_id', 'filial_id', 'produto_id', 'mes', 'ano'], true);

        $this->addIndexIfMissing('estoque_mensal_fechamentos', 'idx_estoque_mensal_filial_id', ['filial_id'], false);

        $this->addForeignIfMissing('estoque_mensal_fechamentos', 'estoque_mensal_filial_id_foreign', 'filial_id', 'filials', 'id', 'cascade', null);
    }
