...
{
    private const REFERENCE_COLUMNS = ['ajudante_id' => ['funcionarios', 'id', 'set null', 'restrict'], 'arla_id' => ['produtos', 'id', 'set null', 'restrict'], 'cliente_id' => ['clientes', 'id', 'set null', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'set null', 'restrict'], 'fornecedor_id' => ['fornecedors', 'id', 'set null', 'restrict'], 'motorista_id' => ['funcionarios', 'id', 'set null', 'restrict'], 'produto_id' => ['produtos', 'id', 'set null', 'restrict'], 'tipo_movimentacao_id' => ['tipos_movimentacoes', 'id', 'cascade', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'cascade', 'restrict'], 'veiculo_id' => ['veiculos', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120115_update_movimentacoes_veiculos_table';
    private const TABLE_NAME = 'movimentacoes_veiculos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('movimentacoes_veiculos');
            $this->preflightColumn('movimentacoes_veiculos', 'checklist_obrigatorio', ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => '1 = Obrigatório, 0 = Opcional']);
            $this->preflightColumn('movimentacoes_veiculos', 'tipo_partida', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'empresa', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'bater_ponto_whatsapp', ['column_type' => 'tinyint(1)', 'nullable' => false, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'data_hora_chegada_cliente', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'data_hora_saida_cliente', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'motivo_cancelamento', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'data_cancelamento', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'data_hora_saida_real', ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'latitude_destino', ['column_type' => 'decimal(10,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'longitude_destino', ['column_type' => 'decimal(11,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'data_movimentacao', ['column_type' => 'date', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('movimentacoes_veiculos', 'status', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'em andamento', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            // Corrige primeiro o ENUM legado: o MySQL revalida sua definição até em ADD COLUMN.
            // Esta conversão já fazia parte do plano; somente sua ordem foi antecipada.
            // Não unifica rótulos, não remove FKs e não desativa o modo estrito.
            $this->ensureColumn('movimentacoes_veiculos', 'status', function (Blueprint $table) {
                return $table->string('status', 20)->nullable()->default('em andamento')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'em andamento', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('movimentacoes_veiculos', 'checklist_obrigatorio', function (Blueprint $table) {
                return $table->tinyInteger('checklist_obrigatorio')->nullable()->default('1')->comment('1 = Obrigatório, 0 = Opcional');
            }, ['column_type' => 'tinyint(1)', 'nullable' => true, 'column_default' => '1', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => '1 = Obrigatório, 0 = Opcional']);
            $this->ensureColumn('movimentacoes_veiculos', 'tipo_partida', function (Blueprint $table) {
                return $table->string('tipo_partida', 20)->nullable()->default('empresa')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => 'empresa', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('movimentacoes_veiculos', 'bater_ponto_whatsapp', function (Blueprint $table) {
                return $table->tinyInteger('bater_ponto_whatsapp')->nullable(false)->default('1');
            ...
            $this->ensureColumn('movimentacoes_veiculos', 'data_hora_chegada_cliente', function (Blueprint $table) {
                return $table->dateTime('data_hora_chegada_cliente')->nullable()->default(null);
            ...
            $this->ensureColumn('movimentacoes_veiculos', 'data_hora_saida_cliente', function (Blueprint $table) {
                return $table->dateTime('data_hora_saida_cliente')->nullable()->default(null);
            }, ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('movimentacoes_veiculos', 'motivo_cancelamento', function (Blueprint $table) {
                return $table->text('motivo_cancelamento')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('movimentacoes_veiculos', 'data_cancelamento', function (Blueprint $table) {
                return $table->dateTime('data_cancelamento')->nullable()->default(null);
            }, ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('movimentacoes_veiculos', 'data_hora_saida_real', function (Blueprint $table) {
                return $table->dateTime('data_hora_saida_real')->nullable()->default(null);
            }, ['column_type' => 'datetime', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('movimentacoes_veiculos', 'latitude_destino', function (Blueprint $table) {
                return $table->decimal('latitude_destino', 10, 8)->nullable()->default(null);
            }, ['column_type' => 'decimal(10,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('movimentacoes_veiculos', 'longitude_destino', function (Blueprint $table) {
                return $table->decimal('longitude_destino', 11, 8)->nullable()->default(null);
            }, ['column_type' => 'decimal(11,8)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('movimentacoes_veiculos', 'data_movimentacao', function (Blueprint $table) {
                return $table->date('data_movimentacao')->nullable()->default(null);
    ...
    private function assertColumnDataFits(string $tableName, string $columnName, array $current, array $expected): void
    {
        ...
        if (preg_match('/^(tinyint|smallint|mediumint|int|bigint)( unsigned)?$/D', $type, $m)) {
            ...
            $values = $this->enumValuesForRollback($type);
    ...
    private function enumValuesForRollback(string $type): array
    {
        // Parser local de literais MySQL. Não normaliza acentos, maiúsculas nem a ordem.
        if (!preg_match('/^enum\s*\(/i', trim($type), $header)) {
            throw new \RuntimeException('Definição anterior de ENUM inválida.');
        }
        $type = trim($type);
        $i = strlen($header[0]);
        $size = strlen($type);
        $values = [];
        while ($i < $size) {
            while ($i < $size && ctype_space($type[$i])) { $i++; }
            if ($i >= $size || $type[$i++] !== "'") {
                throw new \RuntimeException('Literal de ENUM não reconhecido; rollback bloqueado.');
            }
            $value = '';
            $closed = false;
            while ($i < $size) {
                $char = $type[$i++];
                if ($char === "'") {
                    if ($i < $size && $type[$i] === "'") { $value .= "'"; $i++; continue; }
                    $closed = true;
                    break;
                }
                if ($char === '\\') {
                    if ($i >= $size) { throw new \RuntimeException('Escape incompleto no ENUM.'); }
                    $escape = $type[$i++];
                    $value .= match ($escape) {
                        '0' => "\0", 'b' => "\x08", 'n' => "\n", 'r' => "\r", 't' => "\t", 'Z' => "\x1a",
                        '\\' => '\\', "'" => "'", '"' => '"', '%' => '\\%', '_' => '\\_',
                        default => throw new \RuntimeException('Escape de ENUM não reconhecido; rollback bloqueado.'),
                    };
                } else { $value .= $char; }
            }
            if (!$closed) { throw new \RuntimeException('Literal não terminado no ENUM.'); }
            $values[] = rtrim($value, ' '); // MySQL remove espaços finais dos membros de ENUM.
            while ($i < $size && ctype_space($type[$i])) { $i++; }
            if ($i < $size && $type[$i] === ',') { $i++; continue; }
            if ($i < $size && $type[$i] === ')' && trim(substr($type, $i + 1)) === '') { return $values; }
            throw new \RuntimeException('Separador de ENUM não reconhecido; rollback bloqueado.');
        }
        throw new \RuntimeException('ENUM incompleto; rollback bloqueado.');
    }

    private function assertStatusRollbackCanRestore(): void
    {
        $key = self::TABLE_NAME . '.status';
        $record = $this->auditRow('column', $key);
        if ($record === null) { return; } // Coluna preexistente, apenas preservada pelo up.
        $actual = $this->columnInfo(self::TABLE_NAME, 'status');
        if ($record['state'] === 'reverting' && $this->sameSnapshot($actual, $record['before'])) { return; }
        if (!in_array($record['state'], ['applied', 'reverting'], true)
            || !$this->sameSnapshot($actual, $record['after'])) {
            throw new \RuntimeException('Auditoria interrompida ou alteração externa de status; rollback bloqueado antes das remoções.');
        }
        if ($record['before'] === null) { return; } // Remoção da coluna própria é tratada pelo rollback existente.
        $before = $record['before'];
        if (str_starts_with($this->normalizeType($before['column_type']), 'enum(')) {
            $values = $this->enumValuesForRollback($before['column_type']);
            if (count($values) > 512) {
                throw new \RuntimeException('ENUM de status com mais de 512 membros exige revisão antes do rollback.');
            }
            $charset = $before['character_set_name'] ?? '';
            $collation = $before['collation_name'] ?? '';
            if (!preg_match('/^[a-zA-Z0-9_]+$/D', $charset) || !preg_match('/^[a-zA-Z0-9_]+$/D', $collation)) {
                throw new \RuntimeException('Charset/collation anterior de status não disponível para validar rollback.');
            }
            // A comparação usa a collation REAL do MySQL, não um remove-acento em PHP.
            $parts = array_fill(0, count($values), 'SELECT CONVERT(? USING ' . $charset . ') COLLATE ' . $collation . ' AS enum_value');
            $duplicate = DB::selectOne('SELECT 1 AS duplicated FROM (' . implode(' UNION ALL ', $parts)
                . ') AS enum_members GROUP BY enum_value HAVING COUNT(*) > 1 LIMIT 1', $values);
            if ($duplicate !== null) {
                throw new \RuntimeException('Rollback bloqueado antes das remoções: o ENUM anterior de movimentacoes_veiculos.status'
                    . ' contém membros duplicados/equivalentes sob ' . $collation . ' e é inválido em modo estrito.'
                    . ' A definição original continua em migration_merge_audit; não será recriada nem deduplicada por suposição.'
                    . ' A restauração desse estado legado exige um procedimento revisado e o backup.');
            }
        }
        $this->assertNoForeignDependency(self::TABLE_NAME, 'status');
        $this->assertColumnDataFits(self::TABLE_NAME, 'status', $actual, $before);
    }

    private function rollbackRecordedChanges(): void
    {
        // Valida a restauração de status ANTES de qualquer remoção do rollback.
        $this->assertStatusRollbackCanRestore();
        // A tentativa anterior pode ter auditado checklist antes de status. Não confiar só no id.
        // status volta à definição anterior por último, depois dos demais DDLs desta tabela.
        $rows = DB::table('migration_merge_audit')->where('migration_name', $this->migrationName())
            ->orderByRaw("CASE WHEN object_type = 'column' AND object_name = 'movimentacoes_veiculos.status' THEN 4 WHEN object_type = 'foreign' THEN 0 WHEN object_type = 'index' THEN 1 WHEN object_type = 'column' THEN 2 ELSE 3 END")
            ->orderByDesc('id')->get();
