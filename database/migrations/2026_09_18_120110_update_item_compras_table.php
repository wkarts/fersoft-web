...
{
    private const REFERENCE_COLUMNS = ['compra_id' => ['compras', 'id', 'restrict', 'restrict'], 'produto_id' => ['produtos', 'id', 'restrict', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120110_update_item_compras_table';
    private const TABLE_NAME = 'item_compras';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('item_compras');
            $this->preflightColumn('item_compras', 'vbc_icms', ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'p_icms', ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'v_icms', ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'vbc_ipi', ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'p_ipi', ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'v_ipi', ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'vbc_pis', ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'p_pis', ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'v_pis', ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'vbc_cofins', ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'p_cofins', ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('item_compras', 'v_cofins', ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);

            $this->ensureColumn('item_compras', 'vbc_icms', function (Blueprint $table) {
                return $table->decimal('vbc_icms', 17, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'p_icms', function (Blueprint $table) {
                return $table->decimal('p_icms', 15, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'v_icms', function (Blueprint $table) {
                return $table->decimal('v_icms', 17, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'vbc_ipi', function (Blueprint $table) {
                return $table->decimal('vbc_ipi', 17, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'p_ipi', function (Blueprint $table) {
                return $table->decimal('p_ipi', 15, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'v_ipi', function (Blueprint $table) {
                return $table->decimal('v_ipi', 17, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'vbc_pis', function (Blueprint $table) {
                return $table->decimal('vbc_pis', 17, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'p_pis', function (Blueprint $table) {
                return $table->decimal('p_pis', 15, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'v_pis', function (Blueprint $table) {
                return $table->decimal('v_pis', 17, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'vbc_cofins', function (Blueprint $table) {
                return $table->decimal('vbc_cofins', 17, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'p_cofins', function (Blueprint $table) {
                return $table->decimal('p_cofins', 15, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(15,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('item_compras', 'v_cofins', function (Blueprint $table) {
                return $table->decimal('v_cofins', 17, 4)->nullable()->default(null);
            }, ['column_type' => 'decimal(17,4)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        });
    }
