...
function montaTabela(){
	...
	ITENS.map((v) => {
		...
		t += parseFloat(v.valor).toFixed(casas_decimais).replace('.', ',')
		...
		t += "<a href='#prod tbody' class='btn btn-sm btn-danger' onclick='deleteItem("+v.id+")'><i class='la la-trash'></i></a>"
		t += "<a href='#prod tbody' class='btn btn-sm btn-warning ml-1' onclick='editItem("+v.id+")'><i class='la la-edit'></i></a>"
		t += "</span></td>";
		t+= "</tr>";
