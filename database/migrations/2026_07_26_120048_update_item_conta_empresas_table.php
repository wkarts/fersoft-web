...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureColumn('item_conta_empresas', 'lote_pagamento_id', static function (Blueprint $table): void {
            $table->string('lote_pagamento_id', 50)->nullable();
        });

        $this->addForeignIfMissing('item_conta_empresas', 'item_conta_empresas_conta_id_foreign', 'conta_id', 'conta_empresas', 'id', 'cascade', null);
    }
