		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1">
				<div class="cart_container">
					...
					<br>
					<div class="row pays">
						@if(sizeof($formas_pagamento) > 1)
						<div class="col-lg-2"></div>
                        @if(in_array('cartao', $formas_pagamento))
						<div class="@if(sizeof($formas_pagamento) >  2) col-lg-3 @else col-lg-4 @endif col-4 div-cartao @if($forma_inicial == 'cartao') active @endif">
							<center id="click-cartao">Cartão de Crédito</center>
						</div>
						@endif

                        @if(in_array('pix', $formas_pagamento))
						<div class="@if(sizeof($formas_pagamento) >  2) col-lg-3 @else col-lg-4 @endif col-4 div-pix @if($forma_inicial == 'pix') active @endif">
							<center id="click-pix">PIX</center>
						</div>
						@endif

                        @if(in_array('boleto', $formas_pagamento))
						<div class="@if(sizeof($formas_pagamento) >  2) col-lg-3 @else col-lg-4 @endif col-4 div-boleto @if($forma_inicial == 'boleto') active @endif">
