...
{
    private const REFERENCE_COLUMNS = ['cliente_id' => ['clientes', 'id', 'cascade', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'filial_id' => ['filials', 'id', 'cascade', 'restrict'], 'usuario_id' => ['usuarios', 'id', 'cascade', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120117_update_ordem_servicos_table';
    private const TABLE_NAME = 'ordem_servicos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('ordem_servicos');
            $this->preflightColumn('ordem_servicos', 'cliente_veiculo_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'km_veiculo', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'tipo_manutencao', ['column_type' => 'enum(\'preventiva\',\'corretiva\',\'revisao\',\'garantia\')', 'nullable' => true, 'column_default' => 'corretiva', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'status_aprovacao', ['column_type' => 'enum(\'orcamento\',\'aprovado\',\'reprovado\',\'em_andamento\',\'concluido\')', 'nullable' => true, 'column_default' => 'orcamento', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'defeito_relatado', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'diagnostico_tecnico', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'checklist_entrada', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'vendedor_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'tecnico_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'garantia_dias', ['column_type' => 'int', 'nullable' => true, 'column_default' => '90', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('ordem_servicos', 'parecer_tecnico', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('ordem_servicos', 'cliente_veiculo_id', function (Blueprint $table) {
                return $table->integer('cliente_veiculo_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'km_veiculo', function (Blueprint $table) {
                return $table->integer('km_veiculo')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'tipo_manutencao', function (Blueprint $table) {
                return $table->enum('tipo_manutencao', ['preventiva', 'corretiva', 'revisao', 'garantia'])->nullable()->default('corretiva')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'preventiva\',\'corretiva\',\'revisao\',\'garantia\')', 'nullable' => true, 'column_default' => 'corretiva', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'status_aprovacao', function (Blueprint $table) {
                return $table->enum('status_aprovacao', ['orcamento', 'aprovado', 'reprovado', 'em_andamento', 'concluido'])->nullable()->default('orcamento')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'orcamento\',\'aprovado\',\'reprovado\',\'em_andamento\',\'concluido\')', 'nullable' => true, 'column_default' => 'orcamento', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'defeito_relatado', function (Blueprint $table) {
                return $table->text('defeito_relatado')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('ordem_servicos', 'diagnostico_tecnico', function (Blueprint $table) {
                return $table->text('diagnostico_tecnico')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'checklist_entrada', function (Blueprint $table) {
                return $table->text('checklist_entrada')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'vendedor_id', function (Blueprint $table) {
                return $table->integer('vendedor_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'tecnico_id', function (Blueprint $table) {
                return $table->integer('tecnico_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'garantia_dias', function (Blueprint $table) {
                return $table->integer('garantia_dias')->nullable()->default('90');
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => '90', 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('ordem_servicos', 'parecer_tecnico', function (Blueprint $table) {
                return $table->text('parecer_tecnico')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
        });
    }
