...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120016_create_mtr_residuos_table';
    private const TABLE_NAME = 'mtr_residuos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('mtr_residuos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'res_codigo', ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'res_codigo_ibama', ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'res_descricao', ['column_type' => 'text', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'grr_descricao', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'grr_representacao', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_residuos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('mtr_residuos', 'PRIMARY', ['id'], true);
            $this->preflightIndex('mtr_residuos', 'mtr_residuos_res_codigo_unique', ['res_codigo'], true);
            $this->preflightIndex('mtr_residuos', 'idx_mtr_residuos_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('mtr_residuos', 'idx_mtr_residuos_filial_id', ['filial_id'], false);
            $this->preflightIndex('mtr_residuos', 'idx_mtr_residuos_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('mtr_residuos', 'mtr_residuos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('mtr_residuos', 'mtr_residuos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('mtr_residuos', 'mtr_residuos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('mtr_residuos')) {
                if (!$this->beginChange('table', 'mtr_residuos', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('mtr_residuos', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->integer('res_codigo');
                    $table->string('res_codigo_ibama', 50)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('res_descricao')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('grr_descricao')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('grr_representacao', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->unique('res_codigo', 'mtr_residuos_res_codigo_unique');
                    $table->index('empresa_id', 'idx_mtr_residuos_empresa_id');
                    $table->index('filial_id', 'idx_mtr_residuos_filial_id');
                    $table->index('usuario_id', 'idx_mtr_residuos_usuario_id');
                });
                $this->markCreated('table', 'mtr_residuos');
            }

            $this->ensureBaseTenantColumns('mtr_residuos');
            $this->ensureColumn('mtr_residuos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_residuos', 'res_codigo', function (Blueprint $table) {
                return $table->integer('res_codigo')->nullable(false)->default(null);
            }, ['column_type' => 'int', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_residuos', 'res_codigo_ibama', function (Blueprint $table) {
                return $table->string('res_codigo_ibama', 50)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_residuos', 'res_descricao', function (Blueprint $table) {
                return $table->text('res_descricao')->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_residuos', 'grr_descricao', function (Blueprint $table) {
                return $table->text('grr_descricao')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_residuos', 'grr_representacao', function (Blueprint $table) {
                return $table->string('grr_representacao', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_residuos', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_residuos', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('mtr_residuos', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('mtr_residuos', 'mtr_residuos_res_codigo_unique', ['res_codigo'], true);
            $this->addIndexIfMissing('mtr_residuos', 'idx_mtr_residuos_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('mtr_residuos', 'idx_mtr_residuos_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('mtr_residuos', 'idx_mtr_residuos_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('mtr_residuos', 'mtr_residuos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_residuos', 'mtr_residuos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_residuos', 'mtr_residuos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('mtr_residuos', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('mtr_residuos', 'filial_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('mtr_residuos', 'usuario_id', function (Blueprint $table) {
