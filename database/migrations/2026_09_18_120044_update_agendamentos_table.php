...
{
    private const REFERENCE_COLUMNS = ['cliente_id' => ['clientes', 'id', 'restrict', 'restrict'], 'empresa_id' => ['empresas', 'id', 'cascade', 'restrict'], 'funcionario_id' => ['funcionarios', 'id', 'restrict', 'restrict']];
    private const MIGRATION_NAME = '2026_09_18_120044_update_agendamentos_table';
    private const TABLE_NAME = 'agendamentos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->ensureTableExists('agendamentos');
            $this->preflightColumn('agendamentos', 'cliente_veiculo_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('agendamentos', 'motivo_cancelamento', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);

            $this->ensureColumn('agendamentos', 'cliente_veiculo_id', function (Blueprint $table) {
            ...
            $this->ensureColumn('agendamentos', 'motivo_cancelamento', function (Blueprint $table) {
