                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="row">
                                            ...
                                            @if(!isset($conta))
                                                ...
                                                {{-- NOVO CAMPO: DATA DE RECEBIMENTO --}}
                                                <div class="form-group col-lg-2 col-md-4 col-sm-6 div-recebido" style="display: none">
                                                    ...
                                                    <div class="input-group date">
                                                        <input type="text" name="data_recebimento" class="form-control date-input"
                                                               value="{{ date('d/m/Y') }}" id="kt_datepicker_recebimento" />
                                                        <div class="input-group-append">
                                                  <span class="input-group-text">
                                                      <i class="la la-calendar"></i>
                                                  </span>
