...
return new class extends Migration
{
    ...
    private const MIGRATION_NAME = '2026_09_18_120015_create_mtr_manifestos_table';
    private const TABLE_NAME = 'mtr_manifestos';

    public function up()
    {
        $this->runWithSchemaLock(function () {
            // Valida o plano desta tabela antes do primeiro DDL; não preenche dados por suposição.
            $this->preflightColumn('mtr_manifestos', 'id', ['column_type' => 'bigint unsigned', 'nullable' => false, 'column_default' => null, 'extra' => 'auto_increment', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'empresa_id', ['column_type' => 'int unsigned', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'filial_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'usuario_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'orgao', ['column_type' => 'enum(\'SINIR\',\'IEMA\',\'SIGOR\',\'FEAM\',\'IMA\',\'FEPAM\')', 'nullable' => false, 'column_default' => 'SINIR', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'tipo_origem', ['column_type' => 'enum(\'nfe\',\'ticket_pesagem\',\'avulso\')', 'nullable' => false, 'column_default' => 'avulso', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'origem_id', ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'venda_id', ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'ticket_pesagem_id', ['column_type' => 'bigint unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'seu_codigo', ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'numero_mtr', ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'data_expedicao', ['column_type' => 'datetime', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'gerador_cnpj', ['column_type' => 'varchar(19)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'gerador_nome', ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'transportador_cnpj', ['column_type' => 'varchar(19)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'transportador_nome', ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'destinador_cnpj', ['column_type' => 'varchar(19)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'destinador_nome', ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'armazenador_cnpj', ['column_type' => 'varchar(20)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'veiculo_placa', ['column_type' => 'varchar(10)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'motorista_nome', ['column_type' => 'varchar(100)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'chave_nfe', ['column_type' => 'varchar(44)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'observacao', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'status', ['column_type' => 'enum(\'rascunho\',\'transmitido\',\'cancelado\',\'erro\')', 'nullable' => false, 'column_default' => 'rascunho', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'pdf_base64', ['column_type' => 'longtext', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'mensagem_retorno', ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'created_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightColumn('mtr_manifestos', 'updated_at', ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->preflightIndex('mtr_manifestos', 'PRIMARY', ['id'], true);
            $this->preflightIndex('mtr_manifestos', 'idx_mtr_venda', ['venda_id'], false);
            $this->preflightIndex('mtr_manifestos', 'idx_mtr_ticket', ['ticket_pesagem_id'], false);
            $this->preflightIndex('mtr_manifestos', 'idx_mtr_manifestos_empresa_id', ['empresa_id'], false);
            $this->preflightIndex('mtr_manifestos', 'idx_mtr_manifestos_filial_id', ['filial_id'], false);
            $this->preflightIndex('mtr_manifestos', 'idx_mtr_manifestos_usuario_id', ['usuario_id'], false);
            $this->preflightForeign('mtr_manifestos', 'mtr_manifestos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->preflightForeign('mtr_manifestos', 'mtr_manifestos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->preflightForeign('mtr_manifestos', 'mtr_manifestos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');

            if (!Schema::hasTable('mtr_manifestos')) {
                if (!$this->beginChange('table', 'mtr_manifestos', null, ['source' => 'fersofterp_conciliado_17092026.sql', 'tenant_pattern' => true])) { return; }
                Schema::create('mtr_manifestos', function (Blueprint $table) {
                    $table->engine = 'InnoDB';
                    ...
                    $table->enum('orgao', ['SINIR', 'IEMA', 'SIGOR', 'FEAM', 'IMA', 'FEPAM'])->default('SINIR')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('tipo_origem', ['nfe', 'ticket_pesagem', 'avulso'])->default('avulso')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->integer('origem_id')->nullable();
                    $table->unsignedInteger('venda_id')->nullable();
                    $table->unsignedBigInteger('ticket_pesagem_id')->nullable();
                    $table->string('seu_codigo', 50)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('numero_mtr', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->dateTime('data_expedicao');
                    $table->string('gerador_cnpj', 19)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('gerador_nome', 150)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('transportador_cnpj', 19)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('transportador_nome', 150)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('destinador_cnpj', 19)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('destinador_nome', 150)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('armazenador_cnpj', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('veiculo_placa', 10)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('motorista_nome', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->string('chave_nfe', 44)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('observacao')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->enum('status', ['rascunho', 'transmitido', 'cancelado', 'erro'])->default('rascunho')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->longText('pdf_base64')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->text('mensagem_retorno')->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
                    $table->timestamps();

                    $table->index('venda_id', 'idx_mtr_venda');
                    $table->index('ticket_pesagem_id', 'idx_mtr_ticket');
                    $table->index('empresa_id', 'idx_mtr_manifestos_empresa_id');
                    $table->index('filial_id', 'idx_mtr_manifestos_filial_id');
                    $table->index('usuario_id', 'idx_mtr_manifestos_usuario_id');
                });
                $this->markCreated('table', 'mtr_manifestos');
            }

            $this->ensureBaseTenantColumns('mtr_manifestos');
            $this->ensureColumn('mtr_manifestos', 'id', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifestos', 'orgao', function (Blueprint $table) {
                return $table->enum('orgao', ['SINIR', 'IEMA', 'SIGOR', 'FEAM', 'IMA', 'FEPAM'])->nullable(false)->default('SINIR')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'SINIR\',\'IEMA\',\'SIGOR\',\'FEAM\',\'IMA\',\'FEPAM\')', 'nullable' => false, 'column_default' => 'SINIR', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'tipo_origem', function (Blueprint $table) {
                return $table->enum('tipo_origem', ['nfe', 'ticket_pesagem', 'avulso'])->nullable(false)->default('avulso')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'nfe\',\'ticket_pesagem\',\'avulso\')', 'nullable' => false, 'column_default' => 'avulso', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'origem_id', function (Blueprint $table) {
                return $table->integer('origem_id')->nullable()->default(null);
            }, ['column_type' => 'int', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'venda_id', function (Blueprint $table) {
                return $table->unsignedInteger('venda_id')->nullable()->default(null);
            ...
            $this->ensureColumn('mtr_manifestos', 'ticket_pesagem_id', function (Blueprint $table) {
                return $table->unsignedBigInteger('ticket_pesagem_id')->nullable()->default(null);
            ...
            $this->ensureColumn('mtr_manifestos', 'seu_codigo', function (Blueprint $table) {
                return $table->string('seu_codigo', 50)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'numero_mtr', function (Blueprint $table) {
                return $table->string('numero_mtr', 50)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(50)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'data_expedicao', function (Blueprint $table) {
                return $table->dateTime('data_expedicao')->nullable(false)->default(null);
            }, ['column_type' => 'datetime', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'gerador_cnpj', function (Blueprint $table) {
                return $table->string('gerador_cnpj', 19)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(19)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'gerador_nome', function (Blueprint $table) {
                return $table->string('gerador_nome', 150)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_manifestos', 'transportador_cnpj', function (Blueprint $table) {
                return $table->string('transportador_cnpj', 19)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(19)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'transportador_nome', function (Blueprint $table) {
                return $table->string('transportador_nome', 150)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'destinador_cnpj', function (Blueprint $table) {
                return $table->string('destinador_cnpj', 19)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(19)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'destinador_nome', function (Blueprint $table) {
                return $table->string('destinador_nome', 150)->nullable(false)->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(150)', 'nullable' => false, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'armazenador_cnpj', function (Blueprint $table) {
                return $table->string('armazenador_cnpj', 20)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_manifestos', 'veiculo_placa', function (Blueprint $table) {
                return $table->string('veiculo_placa', 10)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_manifestos', 'motorista_nome', function (Blueprint $table) {
                return $table->string('motorista_nome', 100)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_manifestos', 'chave_nfe', function (Blueprint $table) {
                return $table->string('chave_nfe', 44)->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'varchar(44)', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'observacao', function (Blueprint $table) {
                return $table->text('observacao')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_manifestos', 'status', function (Blueprint $table) {
                return $table->enum('status', ['rascunho', 'transmitido', 'cancelado', 'erro'])->nullable(false)->default('rascunho')->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'enum(\'rascunho\',\'transmitido\',\'cancelado\',\'erro\')', 'nullable' => false, 'column_default' => 'rascunho', 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'pdf_base64', function (Blueprint $table) {
                return $table->longText('pdf_base64')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            ...
            $this->ensureColumn('mtr_manifestos', 'mensagem_retorno', function (Blueprint $table) {
                return $table->text('mensagem_retorno')->nullable()->default(null)->charset('utf8mb4')->collation('utf8mb4_unicode_ci');
            }, ['column_type' => 'text', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => 'utf8mb4', 'collation_name' => 'utf8mb4_unicode_ci', 'column_comment' => null]);
            $this->ensureColumn('mtr_manifestos', 'created_at', function (Blueprint $table) {
            ...
            $this->ensureColumn('mtr_manifestos', 'updated_at', function (Blueprint $table) {
                return $table->timestamp('updated_at')->nullable()->default(null);
            }, ['column_type' => 'timestamp', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
            $this->addIndexIfMissing('mtr_manifestos', 'PRIMARY', ['id'], true);
            $this->addIndexIfMissing('mtr_manifestos', 'idx_mtr_venda', ['venda_id'], false);
            $this->addIndexIfMissing('mtr_manifestos', 'idx_mtr_ticket', ['ticket_pesagem_id'], false);
            $this->addIndexIfMissing('mtr_manifestos', 'idx_mtr_manifestos_empresa_id', ['empresa_id'], false);
            $this->addIndexIfMissing('mtr_manifestos', 'idx_mtr_manifestos_filial_id', ['filial_id'], false);
            $this->addIndexIfMissing('mtr_manifestos', 'idx_mtr_manifestos_usuario_id', ['usuario_id'], false);
            $this->addForeignIfMissing('mtr_manifestos', 'mtr_manifestos_empresa_id_foreign', 'empresa_id', 'empresas', 'cascade', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_manifestos', 'mtr_manifestos_filial_id_foreign', 'filial_id', 'filials', 'set null', 'id', 'restrict');
            $this->addForeignIfMissing('mtr_manifestos', 'mtr_manifestos_usuario_id_foreign', 'usuario_id', 'usuarios', 'set null', 'id', 'restrict');
        });
    }
    ...
    private function ensureBaseTenantColumns(string $tableName): void
    {
        ...
        $this->ensureColumn('mtr_manifestos', 'empresa_id', function (Blueprint $table) {
        ...
        $this->ensureColumn('mtr_manifestos', 'filial_id', function (Blueprint $table) {
            return $table->unsignedInteger('filial_id')->nullable()->default(null);
        }, ['column_type' => 'int unsigned', 'nullable' => true, 'column_default' => null, 'extra' => '', 'character_set_name' => null, 'collation_name' => null, 'column_comment' => null]);
        $this->ensureColumn('mtr_manifestos', 'usuario_id', function (Blueprint $table) {
