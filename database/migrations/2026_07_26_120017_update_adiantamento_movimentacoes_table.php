...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('adiantamento_movimentacoes', 'adiant_mov_filial_id_foreign', 'filial_id', 'filials', 'id', 'cascade', null);

        $this->addForeignIfMissing('adiantamento_movimentacoes', 'adiant_mov_conta_pagar_fk', 'conta_pagar_id', 'conta_pagars', 'id', 'set null', null);

        $this->addForeignIfMissing('adiantamento_movimentacoes', 'adiant_mov_conta_receber_fk', 'conta_receber_id', 'conta_recebers', 'id', 'set null', null);
    }
