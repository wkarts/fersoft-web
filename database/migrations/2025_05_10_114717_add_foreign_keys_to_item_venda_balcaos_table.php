...
return new class extends Migration
{
    ...
    {
        Schema::table('item_venda_balcaos', function (Blueprint $table) {
    ...
    {
        Schema::table('item_venda_balcaos', function (Blueprint $table) {
            $table->dropForeign('item_venda_balcaos_produto_id_foreign');
            $table->dropForeign('item_venda_balcaos_venda_balcao_id_foreign');
        });
    }
};
