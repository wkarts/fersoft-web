...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/financeiro/filtro">
			...
			<label class="@if(env('ANIMACAO')) animate__animated @endif animate__backInRight">Registros: <strong class="text-success">{{sizeof($payments)}}</strong></label>
			<div class="col-xl-12 @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft mb-4">
				...
				<a id="btn-verifica" href="/financeiro/verificaPagamentos" class="btn btn-info spinner-white spinner-right">
					<i class="la la-refresh"></i>
					verificar pagamentos
				</a>


				<a style="margin-left: 5px;" href="/financeiro/indeterminado" class="btn btn-dark float-right">
					<i class="la la-cash-register"></i>
					Pagamentos indeterminados
				</a>
					...
					<div class="row">
						<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
							<div class="card card-custom gutter-b example example-compact">
								<div class="card-body">
									<h3 class="card-titl">Soma: <strong style="margin-left: 5px;" class="text-info"> R$ {{number_format($payments->sum('valor'), 2, ',', '.') }}</strong></h3>
								</div>
							</div>
						</div>
