					...
					<div class="col-lg-12">
						...
						<div class="card card-custom gutter-b example example-compact">
							<div class="card-header">
								<h3 class="card-title">
									Atribuir pagamento: <strong style="margin-left: 3px;" class="text-danger">{{$plano->empresa->nome}}</strong>
								</h3>
							</div>
								...
								<div class="col-lg-12">
									<div class="row">
										...
										<div class="form-group validated col-lg-3">
											...
											<div class="">
												<input type="text" class="form-control @if($errors->has('valor')) is-invalid @endif money" name="valor" value="{{ moeda($plano->plano->valor) }}">
												@if($errors->has('valor'))
							...
							<div class="card-footer">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-sm-6 col-md-4">
										<a style="width: 100%" class="btn btn-danger" href="/financeiro">
