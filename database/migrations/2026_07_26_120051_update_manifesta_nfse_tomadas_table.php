...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->ensureColumn('manifesta_nfse_tomadas', 'situacao', static function (Blueprint $table): void {
            $table->string('situacao', 20)->default('NORMAL');
        });

        $this->applySafeColumnUpgrade([
            'table' => 'manifesta_nfse_tomadas',
            'column' => 'chave',
            'type' => 'VARCHAR(100)',
            'nullable' => true,
        ...
        $this->addIndexIfMissing('manifesta_nfse_tomadas', 'chave', ['chave'], true);

        $this->addIndexIfMissing('manifesta_nfse_tomadas', 'idx_nsu_empresa', ['empresa_id', 'filial_id', 'nsu'], false);

        $this->addPrimaryKeyIfMissing('manifesta_nfse_tomadas', ['id']);

        $this->ensureAutoIncrement('manifesta_nfse_tomadas', 'id');
    }
