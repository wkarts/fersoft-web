...
return new class extends Migration
{
    public function up()
    {
        ...
        $this->addForeignIfMissing('ctes', 'ctes_natureza_id_foreign', ['natureza_id'], 'natureza_operacaos', ['id'], null, null);
        $this->addForeignIfMissing('ctes', 'ctes_filial_id_foreign', ['filial_id'], 'filials', ['id'], 'cascade', null);
    }
