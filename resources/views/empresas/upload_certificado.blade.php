	...
	<div class="card card-custom gutter-b example example-compact">
		<div class="container @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
			<div class="col-lg-12">
				...
				<form class="container" method="post" action="/empresas/saveCertificado" enctype="multipart/form-data">
					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							...
							<h3 class="card-title">Upload de Certificado <strong style="margin-left: 3px;" class="text-danger">{{$empresa->nome}}</strong></h3>
						</div>
